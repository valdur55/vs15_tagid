...
<h1>CSS <span class="color_h1">font-weight</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_font_font-variant.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_hanging-punctuation.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_font-weight" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_font-weight">Try it</a>
	</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.fontWeight="bold"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_font-weight">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">font-weight</td>
    <td>2.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.3</td>
...
font-weight: normal|bold|bolder|lighter|<i>number</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Defines normal characters. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-weight">Play it &raquo;</a></td>            
  </tr><tr><td>bold</td>
    <td>Defines thick characters</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-weight&amp;preval=bold">Play it &raquo;</a></td>            
  </tr><tr><td>bolder</td>
    <td>Defines thicker characters</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-weight&amp;preval=bolder">Play it &raquo;</a></td>                
  </tr><tr><td>lighter</td>
    <td>Defines lighter characters</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-weight&amp;preval=bolder">Play it &raquo;</a></td>
  </tr><tr><td>100<br>
      200<br>
      300<br>
      ...
      800<br>
      900</td>
    <td>Defines from thin to thick characters. 400 is the same as normal, and 700 is the same as bold</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-weight&amp;preval=900">Play it &raquo;</a></td>            
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-weight&amp;preval=initial">Play it &raquo;</a></td>            
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_fontweight.asp">fontWeight property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_font_font-variant.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_hanging-punctuation.asp">Next &raquo;</a></div>
