<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS vertical-align property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">vertical-align</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_text_unicode-bidi.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_visibility.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_vertical-align" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">baseline</td>
  </tr><tr><th>Inherited:</th>
    <td>no</td>
  </tr><tr><th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_vertical-align">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.verticalAlign="top"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_vertical-align">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">vertical-align</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
vertical-align: baseline|<i>length</i>|sub|super|top|text-top|middle|bottom|text-bottom|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Align the baseline of the element with the baseline of the parent element. 
	This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=baseline">Play it &raquo;</a></td>                		
  </tr><tr><td><i>length</i></td>
    <td>Raises or lower an element by the specified length. 
	Negative values are allowed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=25px">Play it &raquo;</a></td>                	
  </tr><tr><td>%</td>
    <td>Raises or lower an element in a percent of the "line-height"
      property. Negative values are allowed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=50%25">Play it &raquo;</a></td>                	
  </tr><tr><td>sub</td>
    <td>Aligns the element as if it was subscript</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=sub">Play it &raquo;</a></td>                	
  </tr><tr><td>super</td>
    <td>Aligns the element as if it was superscript</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=super">Play it &raquo;</a></td>                	    
  </tr><tr><td>top</td>
    <td>The top of the element is aligned with the top of the 
    tallest element on the line</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=top">Play it &raquo;</a></td>                	    
  </tr><tr><td>text-top</td>
    <td>The top of the element is aligned with the top of
      the parent element's font</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=text-top">Play it &raquo;</a></td>                	      
  </tr><tr><td>middle</td>
    <td>The element is placed in the middle of the parent element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=middle">Play it &raquo;</a></td>                	
  </tr><tr><td>bottom</td>
    <td>The bottom of the element is aligned with the
      lowest element on the line</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=bottom">Play it &raquo;</a></td>                	      
  </tr><tr><td>text-bottom</td>
    <td>The bottom of the element is aligned with the
      bottom of the parent element's font</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=text-bottom">Play it &raquo;</a></td>                	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&amp;preval=initial">Play it &raquo;</a></td>                	
    </tr><tr><td>inherit</td>
...
<p>CSS tutorial: <a href="/css/css_text.asp">CSS Text</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_verticalalign.asp">verticalAlign property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_text_unicode-bidi.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_visibility.asp">Next &raquo;</a></div>
