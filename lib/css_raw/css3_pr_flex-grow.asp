...
<h1>CSS <span class="color_h1">flex-grow</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-flow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-shrink.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Let the second flex-item grow three times wider than the rest:</p>
<div class="w3-code notranslate cssHigh">
	/* Safari 6.1+ */<br>div:nth-of-type(1) {-webkit-flex-grow: 1;}<br>
div:nth-of-type(2) {-webkit-flex-grow: 3;}<br>
div:nth-of-type(3) {-webkit-flex-grow: 1;}<br><br>/* Standard syntax */<br>div:nth-of-type(1) {flex-grow: 1;}<br>
div:nth-of-type(2) {flex-grow: 3;}<br>
div:nth-of-type(3) {flex-grow: 1;}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_flex-grow" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The flex-grow property specifies how much the item will grow relative to the rest of the flexible items inside the same container.</p>

<p><b>Note:</b> If the element is not a flexible item, the flex-grow property has no effect.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_flex-grow">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.flexGrow="5"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_flex-grow">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">flex-grow</td>
...
flex-grow: <i>number</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-grow&amp;preval=1">Play it &raquo;</a></td>              
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-grow&amp;preval=initial">Play it &raquo;</a></td>              
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_flexgrow.asp">flexGrow property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-flow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-shrink.asp">Next &raquo;</a></div>
