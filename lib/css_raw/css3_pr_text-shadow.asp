...
<h1>CSS3 <span class="color_h1">text-shadow</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-overflow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_text-transform.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-shadow">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The text-shadow property adds shadow to text.</p>
<p>This property accepts a comma-separated list of shadows to be applied to the 
text.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%"><i>none</i></td>
  </tr><tr><th>Inherited:</th>
    <td>yes</td>
  </tr><tr><th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_text-shadow">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.textShadow="2px 5px 5px red"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_text-shadow">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">text-shadow</td>
    <td>4.0</td>
    <td>10.0</td>
    <td>3.5</td>
    <td>4.0</td>
...
text-shadow: <i>h-shadow v-shadow blur-radius color</i>|none|initial|inherit;</div></div>
<p><b>Note:</b> To add more than one shadow to the text, add a comma-separated list of shadows.
</p>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <th>Play it</th>                
  </tr><tr><td><i>h-shadow</i></td>
    <td>Required. The position of the horizontal shadow. Negative values are 
	allowed</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-shadow">Play it &raquo;</a></td>
  </tr><tr><td><i>v-shadow</i></td>
    <td>Required. The position of the vertical shadow. Negative values are 
	allowed</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-shadow">Play it &raquo;</a></td>	
  </tr><tr><td><i>blur-radius</i></td>
    <td>Optional. The blur radius. Default value is 0</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-shadow&amp;preval=5px%205px%205px%20red">Play it &raquo;</a></td>    
  </tr><tr><td><i>color</i></td>
    <td>Optional. The color of the shadow. Look at <a href="css_colors_legal.asp">CSS Color Values</a> 
	for a complete list of possible color values</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-shadow&amp;preval=5px%205px%2010px%20blue">Play it &raquo;</a></td>
  </tr><tr><td>none</td>
    <td>Default value. No shadow</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-shadow&amp;preval=none">Play it &raquo;</a></td>
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-shadow&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>This example demonstrates a text-shadow with a blur effect:</p>
<div class="w3-code notranslate cssHigh">
    h1 {<br>&nbsp;&nbsp;&nbsp; text-shadow: 2px 2px 8px #FF0000;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-shadow_blur">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>This example demonstrates text-shadow on a white text:</p>
<div class="w3-code notranslate cssHigh">
    h1 {<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; text-shadow: 
	2px 2px 4px #000000;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-shadow_white">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>This example demonstrates text-shadow with a red neon glow:</p>
<div class="w3-code notranslate cssHigh">
    h1 {<br>&nbsp;&nbsp;&nbsp; text-shadow: 0 0 3px #FF0000;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-shadow_neon">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>This example demonstrates text-shadow with a red and blue neon glow:</p>
<div class="w3-code notranslate cssHigh">
    h1 {<br>&nbsp;&nbsp;&nbsp; text-shadow: 0 0 3px #FF0000, 
	0 0 5px #0000FF;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-shadow_neon2">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="/css/css3_text_effects.asp">CSS3 Text Effects</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_textshadow.asp">textShadow property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-overflow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_text-transform.asp">Next &raquo;</a></div>
