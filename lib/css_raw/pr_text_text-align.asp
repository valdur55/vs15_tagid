...
<h1>CSS <span class="color_h1">text-align</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_tab_table-layout.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-align-last.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the text alignment for &lt;h1&gt;, &lt;h2&gt;, and &lt;h3&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
    h1 {<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>}<br><br>
	h2 {<br>&nbsp;&nbsp;&nbsp; text-align: left;<br>}<br><br>
	h3 {<br>&nbsp;&nbsp;&nbsp; text-align: right;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_text-align" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The text-align property specifies the horizontal alignment of text in an element.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">left if direction is ltr, and right if direction is rtl</td>
    ...
    <td>  <i>object</i>.style.textAlign="right"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_text-align">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">text-align</td>
    <td>1.0</td>
    <td>3.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
text-align: left|right|center|justify|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align">Play it &raquo;</a></td>        
  </tr><tr><td>right</td>
    <td>Aligns the text to the right</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align&amp;preval=right">Play it &raquo;</a></td>            
  </tr><tr><td>center</td>
    <td>Centers the text</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align&amp;preval=center">Play it &raquo;</a></td>                
  </tr><tr><td>justify</td>
    <td>Stretches the lines so that each line has equal width (like 
	in newspapers and magazines)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align&amp;preval=justify">Play it &raquo;</a></td>            	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align&amp;preval=initial">Play it &raquo;</a></td>            	
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>This example demonstrates a more advanced text-align example:</p>
<div class="w3-code notranslate cssHigh">
    h1 {<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>}<br><br>p.date {<br>&nbsp;&nbsp;&nbsp; 
	text-align: right;<br>}<br><br>p.main {<br>&nbsp;&nbsp;&nbsp; text-align: justify;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-align_all">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_text.asp">CSS Text</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_textalign.asp">textAlign property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_tab_table-layout.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-align-last.asp">Next &raquo;</a></div>
