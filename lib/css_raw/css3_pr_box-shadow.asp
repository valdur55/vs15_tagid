...
<h1>CSS3 <span class="color_h1">box-shadow</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_pos_bottom.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_box-sizing.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Add a box-shadow to a &lt;div&gt; element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-shadow">Try it yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_box-shadow">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.boxShadow="10px 20px 30px blue"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_box-shadow">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">box-shadow</td>
...
box-shadow: none|<i>h-shadow v-shadow blur spread color </i>|inset|initial|inherit;</div></div>
<p><b>Note:</b> The box-shadow property attaches one or more shadows to an 
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. No shadow is displayed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&amp;preval=none">Play it &raquo;</a></td>		
  </tr><tr><td><i>h-shadow</i></td>
    <td>Required. The position of the horizontal shadow. Negative values are 
	allowed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow">Play it &raquo;</a></td>		
  </tr><tr><td><i>v-shadow</i></td>
    <td>Required. The position of the vertical shadow. Negative values are 
	allowed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow">Play it &raquo;</a></td>			
  </tr><tr><td><i>blur</i></td>
    <td>Optional. The blur distance</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&amp;preval=50px%2050px%205px%20black">Play it &raquo;</a></td>		    
  </tr><tr><td><i>spread</i></td>
    <td>Optional. The size of shadow. Negative values are allowed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&amp;preval=50px%2050px%2050px%205px%20black">Play it &raquo;</a></td>		        
  </tr><tr><td><i>color</i></td>
    <td>Optional. The color of the shadow. The default value is black. Look at <a href="css_colors_legal.asp">CSS Color Values</a> 
	for a complete list of possible color values.<br><br><strong>Note:</strong> 
	In Safari (on PC) the color parameter is required. If you do not specify the 
	color, the shadow is not displayed at all.</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&amp;preval=50px%2050px%2050px%2020px%20red">Play it &raquo;</a></td>		        	
  </tr><tr><td>inset</td>
    <td>Optional. Changes the shadow from an outer shadow (outset) to an inner 
	shadow</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&amp;preval=10px%2010px%2050px%2020px%20pink%20inset">Play it &raquo;</a></td>		        		
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&amp;preval=initial">Play it &raquo;</a></td>		        		
    </tr><tr><td>inherit</td>
...
<p>CSS3 tutorial: <a href="/css/css3_borders.asp">CSS3 Borders</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_boxshadow.asp">boxShadow property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_pos_bottom.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_box-sizing.asp">Next &raquo;</a></div>
