<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 column-rule-width property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">column-rule-width</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-rule-style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-span.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp; -webkit-column-rule-width: 1px; /* Chrome, Safari, 
	Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-rule-width: 1px; /* Firefox */<br>
	&nbsp;&nbsp;&nbsp;
	column-rule-width: 1px;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_column-rule-width">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The column-rule-width property specifies the width of the rule between columns.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_column-rule-width">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.columnRuleWidth="10px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_column-rule-width">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">column-rule-width</td>
    <td>4.0 -webkit-</td>
    <td>10.0</td>
    <td>2.0 -moz-</td>
    <td>3.1 -webkit-</td>
...
column-rule-width: medium|thin|thick|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. Defines a medium rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-width&amp;preval=medium">Play it &raquo;</a></td>			    	            
  </tr><tr><td> thin</td>
    <td>Defines a thin rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-width&amp;preval=thin">Play it &raquo;</a></td>			    	        
  </tr><tr><td> thick</td>
    <td>Defines a thick rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-width&amp;preval=thick">Play it &raquo;</a></td>			    	                
  </tr><tr><td> <i>length</i></td>
    <td>Specifies the width of the rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-width&amp;preval=1px">Play it &raquo;</a></td>			    	                
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-width&amp;preval=initial">Play it &raquo;</a></td>			    	                
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_columnrulewidth.asp">columnRuleWidth property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-rule-style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-span.asp">Next &raquo;</a></div>
