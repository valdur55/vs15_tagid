...
</script><link rel="stylesheet" type="text/css" href="/browserref.css"><link rel="stylesheet" type="text/css" href="/stdtheme.css"><style type="text/css">
.auto-style1 {
	font-size: 16px;
}
</style></head><body>
...
<h1>CSS3 <span class="color_h1">@keyframes</span> Rule</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_justify-content.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_left.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Make an element move gradually 200px down:</p>
<div class="w3-code notranslate cssHigh">
    /* Chrome, Safari, Opera */ <br>@-webkit-keyframes mymove {<br>
	&nbsp;&nbsp;&nbsp;
	from {top: 0px;}<br>
	&nbsp;&nbsp;&nbsp;
	to {top: 200px;}<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_keyframes">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The @keyframes rule specifies the animation code.</p>
<p>The animation is created by gradually changing from one set of CSS styles to another.</p>
<p>During the animation, you can change the set of CSS styles many times.</p>
<p>Specify when the style change will happen in percent, or with the keywords "from" and 
"to", which is the same as 0% and 100%. 0% is the beginning of the animation, 100% is when the animation is complete.</p>
<p><strong>Tip:</strong> For best browser support, you should always define both the 0% and the 100% selectors.</p>
<p><b>Note:</b> Use the animation properties to control the appearance of the animation, and also to bind the animation to selectors.</p>
...
<table class="browserref notranslate"><tr><th style="width:20%;text-align:left;" class="auto-style1">Rule</th>
    <th style="width:16%;" class="bsChrome" title="Chrome"></th>
    <th style="width:16%;" class="bsIE" title="Internet Explorer"></th>
    <th style="width:16%;" class="bsFirefox" title="Firefox"></th>
    <th style="width:16%;" class="bsSafari" title="Safari"></th>
    <th style="width:16%;" class="bsOpera" title="Opera"></th>                
  </tr><tr><td style="text-align:left; width: 20%;">@keyframes</td>
...
@keyframes <i>animationname </i>{<i>keyframes-selector </i>{<i>css-styles;}</i>}</div></div>
<h2>Property Values</h2>

<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    <th>Description</th>
  </tr><tr><td><i>animationname</i></td>
    <td>Required. Defines the name of the animation.</td>
  </tr><tr><td><i>keyframes-selector</i></td>
    <td>Required. Percentage of the animation duration.<p>Legal values:</p><p>0-100%<br>
	from (same as 0%)<br>
	to (same as 100%)</p><p><b>Note:</b> You can have many keyframes-selectors in one 
	animation.</p></td>
  </tr><tr><td><i>css-styles</i></td>
    <td>Required. One or more legal CSS style properties</td>
  </tr></table></div>
...
<h3>Example</h3>
<p>Add many keyframe selectors in one animation:</p>
<div class="w3-code notranslate cssHigh">
    /* Chrome, Safari, Opera */ <br>@-webkit-keyframes mymove
	{<br>
	&nbsp;&nbsp;&nbsp;
	0%&nbsp;&nbsp; {top: 0px;}<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_keyframes2">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Change many CSS styles in one animation:</p>
<div class="w3-code notranslate cssHigh">
    /* Chrome, Safari, Opera */ <br>@-webkit-keyframes mymove
	{<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_keyframes3">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Many keyframe selectors with many CSS styles:</p>
<div class="w3-code notranslate cssHigh">
    /* Chrome, Safari, Opera */ <br>@-webkit-keyframes mymove
	{<br>
	&nbsp;&nbsp;&nbsp;
	...
	&nbsp;&nbsp;&nbsp;
	50%&nbsp; {top: 100px; left: 100px; background: yellow;}<br>
	&nbsp;&nbsp;&nbsp;
	75%&nbsp; {top: 100px; left: 0px; background: green;}<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_keyframes4">Try it yourself &raquo;</a>
</div>
