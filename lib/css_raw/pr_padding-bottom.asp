...
<h1>CSS <span class="color_h1">padding-bottom</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_padding.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_padding-left.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the bottom padding for a &lt;p&gt; element:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_padding-bottom" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The padding-bottom property sets the bottom padding (space) of an element.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_padding-bottom">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.paddingBottom="50px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_padding-bottom">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">padding-bottom</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
padding-bottom: <i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Specifies a fixed bottom padding in px, pt, cm, etc. Default value is 0</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_padding-bottom">Play it &raquo;</a></td>		                  
  </tr><tr><td><i>%</i></td>
    <td>Specifies a bottom padding in percent of the width of the 
	containing element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_padding-bottom&amp;preval=20%25">Play it &raquo;</a></td>		                  	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_padding-bottom&amp;preval=initial">Play it &raquo;</a></td>		                  	
    </tr><tr><td>inherit</td>
...
<a href="/jsref/prop_style_paddingbottom.asp">paddingBottom property</a></p>
