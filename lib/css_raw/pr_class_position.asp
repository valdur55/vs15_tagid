...
<h1>CSS <span class="color_h1">position</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_perspective-origin.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_quotes.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_position_absolute" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The position property specifies the type of positioning method used for an 
element (static, relative, absolute or fixed).</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">static</td>
    ...
    <td>  <i>object</i>.style.position="absolute"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_position">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">position&nbsp;</td>
    <td>1.0</td>
    <td>7.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
position: static|absolute|fixed|relative|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_position">Play it &raquo;</a></td>		                  	
  </tr><tr><td>absolute</td>
    <td>The element is positioned relative to its first positioned (not static) 
	ancestor element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_position&amp;preval=absolute">Play it &raquo;</a></td>		                  		
  </tr><tr><td>fixed</td>
    <td>The element is positioned relative to the browser window</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_position&amp;preval=fixed">Play it &raquo;</a></td>		                  		
  </tr><tr><td>relative</td>
    <td>The element is positioned relative to its normal position, so "left:20"
      adds 20 pixels to the element's LEFT position</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_position&amp;preval=relative">Play it &raquo;</a></td>		                  		      
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_position&amp;preval=initial">Play it &raquo;</a></td>		                  		      
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>How to position an element relative to its normal position:</p>
<div class="w3-code notranslate cssHigh">
    h2.pos_left {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; 
	left: -20px;<br>}<br><br>h2.pos_right {<br>&nbsp;&nbsp;&nbsp; position: 
	relative;<br>&nbsp;&nbsp;&nbsp; left: 20px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_position_relative">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_positioning.asp">CSS Positioning</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_position.asp">position property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_perspective-origin.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_quotes.asp">Next &raquo;</a></div>
