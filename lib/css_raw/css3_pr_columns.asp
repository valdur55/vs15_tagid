...
<h1>CSS3 <span class="color_h1">columns</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_content.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify the width and number of columns:</p>
<div class="w3-code notranslate cssHigh">
    div
	{<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-columns: 100px 3; /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
	-moz-columns: 100px 3; /* Firefox */<br>&nbsp;&nbsp;&nbsp;
	columns: 100px 3;<br>		
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_columns">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The columns property is a shorthand property for setting column-width and column-count.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">auto auto</td>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_columns">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.columns="100px 3"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_columns">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">columns&nbsp;</td>
    <td>4.0 -webkit-</td>
    <td>10.0</td>
    <td>9.0 -moz-</td>
    <td>3.1 -webkit-</td>
...
columns: auto|<i>column-width column-count</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. Sets both the column-width to "auto" and the column-count to "auto"</td>
    </tr><tr><td><i><a href="css3_pr_column-width.asp">column-width</a></i></td>
    <td>The width of the columns</td>
  </tr><tr><td><i><a href="css3_pr_column-count.asp">column-count</a></i></td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_columns.asp">columns property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_content.asp">Next &raquo;</a></div>
