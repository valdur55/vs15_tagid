<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS text-align-last property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">text-align-last</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_text_text-align.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_text-decoration.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">

<h3>Example</h3>
<p>Align the last line of a &lt;p&gt; element to the right:</p>
<div class="w3-code notranslate cssHigh">
p
{<br>
&nbsp;&nbsp;&nbsp;
text-align: justify;&nbsp; <br>&nbsp;&nbsp;&nbsp; -moz-text-align-last: right; 
	/* Code for Firefox */<br>
&nbsp;&nbsp;&nbsp;
text-align-last: right;<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_text-align-last" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The text-align-last property specifies how to align the last line of a text.</p>
<p><strong>Note:</strong> The text-align-last property will only work for elements with the text-align property set to "justify".</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_text-align-last">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">text-align-last&nbsp;</td>
...
<p><strong>Note:</strong> In Internet Explorer, the "start" and "end" values 
are not supported.</p>
<hr><h2>CSS Syntax</h2>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>Default value. The last line is justified and aligned left</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align-last&amp;preval=auto">Play it &raquo;</a></td>          
    </tr><tr><td>left</td>
    <td>The last line is aligned to the left</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align-last&amp;preval=left">Play it &raquo;</a></td>          
    </tr><tr><td>right</td>
    <td>The last line is aligned to the right</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align-last&amp;preval=right">Play it &raquo;</a></td>          
    </tr><tr><td>center</td>
    <td>The last line is center-aligned</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align-last&amp;preval=center">Play it &raquo;</a></td>          
    </tr><tr><td>justify</td>
    <td>The last line is justified as the rest of the lines</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align-last&amp;preval=justify">Play it &raquo;</a></td>          
    </tr><tr><td>start</td>
    <td>The last line is aligned at the beginning of the line (left if the text-direction is left-to-right, and right is the text-direction is right-to-left)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align-last&amp;preval=start">Play it &raquo;</a></td>          
    </tr><tr><td>end</td>
    <td>The last line is aligned at the end of the line (right if the text-direction is left-to-right, and left is the text-direction is right-to-left)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align-last&amp;preval=end">Play it &raquo;</a></td>          
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-align-last&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_textalignlast.asp">textAlignLast property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_text_text-align.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_text-decoration.asp">Next &raquo;</a></div>
