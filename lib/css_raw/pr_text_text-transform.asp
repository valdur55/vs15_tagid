...
<h1>CSS <span class="color_h1">text-transform</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-shadow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_top.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Transform text in different &lt;p&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
  
    p.uppercase {<br>&nbsp;&nbsp;&nbsp; text-transform: uppercase;<br>}<br><br>
	p.lowercase {<br>&nbsp;&nbsp;&nbsp; text-transform: lowercase;<br>}<br><br>
	p.capitalize {<br>&nbsp;&nbsp;&nbsp; text-transform: capitalize;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_text-transform" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The text-transform property controls the capitalization of text.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.textTransform="uppercase"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_text-transform">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">text-transform</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
text-transform: none|capitalize|uppercase|lowercase|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>No capitalization. The text renders as it is. This is 
	default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-transform">Play it &raquo;</a></td>                	
  </tr><tr><td>capitalize</td>
    <td>Transforms the first character of each word to uppercase</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-transform&amp;preval=capitalize">Play it &raquo;</a></td>                    
  </tr><tr><td>uppercase</td>
    <td>Transforms all characters to uppercase</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-transform&amp;preval=uppercase">Play it &raquo;</a></td>                    
  </tr><tr><td>lowercase</td>
    <td>Transforms all characters to lowercase</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-transform&amp;preval=lowercase">Play it &raquo;</a></td>                    
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-transform&amp;preval=initial">Play it &raquo;</a></td>                    
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_texttransform.asp">textTransform property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-shadow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_top.asp">Next &raquo;</a></div>
