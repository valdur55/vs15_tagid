...
<h1>CSS <span class="color_h1">align-self</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_align-items.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_all.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    #myBlueDiv
	{<br>&nbsp;&nbsp;&nbsp; -webkit-align-self: center; /* Safari 7.0+ */<br>
	&nbsp;&nbsp;&nbsp;
	align-self: center;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_align-self" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p><b>Note:</b> The align-self property overrides the flexible container's align-items property.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td><i>object</i>.style.alignSelf="center"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_align-self">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">align-self</td>
    <td>21.0</td>
    <td>11.0</td>
    <td>20.0</td>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>Default. The element inherits its parent container's align-items property, or "stretch" if it has no parent container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-self&amp;preval=auto">Play it &raquo;</a></td>          
    </tr><tr><td>stretch</td>
    <td>The element is positioned to fit the container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-self&amp;preval=stretch">Play it &raquo;</a></td>          
    </tr><tr><td>center</td>
    <td>The element is positioned at the center of the container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-self&amp;preval=center">Play it &raquo;</a></td>          
    </tr><tr><td>flex-start</td>
    <td>The element is are positioned at the beginning of the container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-self&amp;preval=flex-start">Play it &raquo;</a></td>          
    </tr><tr><td>flex-end</td>
    <td>The element is positioned at the end of the container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-self&amp;preval=flex-end">Play it &raquo;</a></td>          
    </tr><tr><td>baseline</td>
    <td>The element is positioned at the baseline of the container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-self&amp;preval=baseline">Play it &raquo;</a></td>          
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-self&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
...
<p>CSS Reference: <a href="css3_pr_align-content.asp">align-content property</a></p>
<p>CSS Reference: <a href="css3_pr_align-items.asp">align-items property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_alignself.asp">alignSelf property</a></p>
