...
<h1>CSS <span class="color_h1">height</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_hanging-punctuation.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_justify-content.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the height and width of a paragraph:</p>
...
<p>The height property sets the height of an element.</p>
<p><b>Note:</b> The height property does not include padding, borders, or margins; 
it sets the height of the area inside the padding, border, and margin of the 
element!</p>
<p><b>Note:</b> The <a href="pr_dim_min-height.asp">min-height</a> and
<a href="pr_dim_max-height.asp">max-height</a> properties override height.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_height">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.height="500px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_height">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">height</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
height: auto|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>The browser calculates the height. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_height">Play it &raquo;</a></td>		          
  </tr><tr><td><i>length</i></td>
    <td>Defines the height in px, cm, etc.&nbsp;</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_height&amp;preval=200px">Play it &raquo;</a></td>		              
  </tr><tr><td><i>%</i></td>
    <td>Defines the height in percent of the containing block</td>
    <td></td>
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_height&amp;preval=initial">Play it &raquo;</a></td>		              
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>Set the height of an element using a percent value:</p>
<div class="w3-code notranslate cssHigh">
    img
	{<br>&nbsp;&nbsp;&nbsp; height: 50%;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_dim_height_percent">Try it yourself &raquo;</a>
</div>
...
<p>CSS reference: <a href="pr_dim_width.asp">width property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_height.asp">height property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_hanging-punctuation.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_justify-content.asp">Next &raquo;</a></div>
