<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS page-break-before property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">page-break-before</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_print_pageba.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_print_pagebi.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Always insert a page break before each &lt;h1&gt; element (when printing):</p>
...
<p>The page-break-before property sets whether a page break should occur BEFORE a specified element.</p>
<p><b>Note:</b>  You cannot use this property on an empty &lt;div&gt; or on absolutely positioned elements.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.pageBreakBefore="always"</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">page-break-before</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.2</td>
...
<p><b>Note:</b> Internet Explorer and Firefox do not support the property 
values "left" or "right".</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
page-break-before: auto|always|avoid|left|right|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    <th>Description</th>
      ...
      <td>Default. Automatic page breaks</td>
    </tr><tr><td>always</td>
      <td>Always insert a page break before the element</td>
    </tr><tr><td>avoid</td>
      <td>&nbsp;Avoid page break before the element (if possible)</td>
    </tr><tr><td>left</td>
      <td>Insert page breaks before the element so that the next page is 
	  formatted as a left page</td>
    </tr><tr><td>right</td>
      <td>Insert page breaks before the element so that the next page is 
	  formatted as a right page</td>
    </tr><tr><td>initial</td>
...
<a href="/jsref/prop_style_pagebreakbefore.asp">pageBreakBefore property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_print_pageba.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_print_pagebi.asp">Next &raquo;</a></div>
