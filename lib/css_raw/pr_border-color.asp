...
<h1>CSS <span class="color_h1">border-color</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-collapse.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-image.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the color of the four borders:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-color" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-color property sets the color of an element's four borders. This property can 
have from one to four values.</p>
<p>Examples:</p>
<ul><li><b>border-color:red green blue pink; </b>
	<ul><li>top border is red</li>
	<li>right border is green</li>
	<li>bottom border is blue</li>
	<li>left border is pink</li></ul><br></li>
	<li><b>border-color:red green blue;</b>
	<ul><li>top border is red</li>
	<li>right and left borders are green</li>
	<li>bottom border is blue</li></ul><br></li>
	<li><b>border-color:red green;</b>
	<ul><li>top and bottom borders are red</li>
	<li>right and left borders are green</li></ul><br></li>
	<li><b>border-color:red;</b><ul><li>all four borders are red</li></ul></li>
</ul><p><b>Note:</b> Always declare the border-style property before the border-color
property. An element must have borders before you can change the color.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-color">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.borderColor="#FF0000 blue"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-color">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">border-color</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
<p><b>Note:</b> Internet Explorer 6 (and earlier versions) does not support the property value "transparent".</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
border-color: <i>color</i>|transparent|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Specifies the background color. Look at <a href="css_colors_legal.asp">
	CSS Color Values</a> for a complete list of possible color values. Default 
	color is black</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-color">Play it &raquo;</a></td>		
  </tr><tr><td>transparent</td>
    <td>Specifies that the border color should be transparent</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-color&amp;preval=transparent">Play it &raquo;</a></td>			
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-color&amp;preval=initial">Play it &raquo;</a></td>			
    </tr><tr><td>inherit</td>
...
<a href="/jsref/prop_style_bordercolor.asp">borderColor property</a></p>
