...
<h1>CSS <span class="color_h1">list-style-position</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_list-style-image.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_list-style-type.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify that the the list-item markers should appear inside the content flow 
(results in an extra indentation):</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_list-style-position" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The list-style-position property specifies if the list-item markers should appear inside or outside the content flow.</p>
<p>Outside:</p>
<ul style="list-style-position:outside;width:25%;"><li style="border:1px solid #000000;">Coffee</li>
<li style="border:1px solid #000000;border-top:0;">Tea</li>
<li style="border:1px solid #000000;border-top:0;">Coca-cola</li>
</ul><p>Inside:</p>
<ul style="list-style-position:inside;width:25%;"><li style="border:1px solid #000000;">Coffee</li>
<li style="border:1px solid #000000;border-top:0;">Tea</li>
<li style="border:1px solid #000000;border-top:0;">Coca-cola</li>
</ul><br><div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">outside</td>
    ...
    <td>  <i>object</i>.style.listStylePosition="inside"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_list-style-position">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">list-style-position</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
list-style-position: inside|outside|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Indents the marker and the text. The bullets appear inside 
	the content flow</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_list-style-position&amp;preval=inside">Play it &raquo;</a></td>		              
  </tr><tr><td>outside</td>
    <td>Keeps the marker to the left of the text. The bullets 
	appears outside the content flow. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_list-style-position&amp;preval=outside">Play it &raquo;</a></td>		              	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_list-style-position&amp;preval=initial">Play it &raquo;</a></td>		              	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_liststyleposition.asp">listStylePosition property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_list-style-image.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_list-style-type.asp">Next &raquo;</a></div>
