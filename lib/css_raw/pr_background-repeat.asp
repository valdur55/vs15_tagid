...
<h1>CSS <span class="color_h1">background-repeat</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_background-position.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_background-size.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_background-repeaty" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The background-repeat property sets if/how a background image will be 
repeated.</p>
<p>By default, a background-image is repeated both vertically and horizontally.</p>
<p><b>Tip: </b>The background image is placed according to the 
background-position property. If no background-position is specified, the image 
is always placed at the element's top left corner.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">repeat</td>
    ...
    <td>  <i>object</i>.style.backgroundRepeat="repeat-x"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_background-repeat">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">background-repeat</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
<p><b>Note:</b> IE8 and earlier do not support multiple background images 
on one element.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
background-repeat: repeat|repeat-x|repeat-y|no-repeat|initial|inherit;</div></div>

<h2>Property Values</h2>

<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:12%">Value</th>
    <th>Description</th>
    <th>Play it</th>        
  </tr><tr><td>repeat</td>
    <td>The background image will be repeated both vertically and
      horizontally. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-repeat">Play it &raquo;</a></td>
  </tr><tr><td>repeat-x</td>
    <td>The background image will be repeated only horizontally</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-repeat&amp;preval=repeat-x">Play it &raquo;</a></td>    
  </tr><tr><td>repeat-y</td>
    <td>The background image will be repeated only vertically</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-repeat&amp;preval=repeat-y">Play it &raquo;</a></td>        
  </tr><tr><td>no-repeat</td>
    <td>The background-image will not be repeated</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-repeat&amp;preval=no-repeat">Play it &raquo;</a></td>    
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-repeat&amp;preval=initial">Play it &raquo;</a></td>    
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>How to repeat a background image both vertically and horizontally (default 
for background images):</p>
<div class="w3-code notranslate cssHigh">
    body
	{<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_background-repeat" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Repeat a background image only horizontally:</p>
<div class="w3-code notranslate cssHigh">
    body
	{<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_background-repeatx" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Display a background image only one time, with no-repeat:</p>
<div class="w3-code notranslate cssHigh">
    body
	{<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_background-repeat_no-repeat" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_background.asp">CSS Background</a></p>
<p>CSS reference: <a href="pr_background-position.asp">background-position 
property</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_backgroundrepeat.asp">backgroundRepeat property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_background-position.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_background-size.asp">Next &raquo;</a></div>
