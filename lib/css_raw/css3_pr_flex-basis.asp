...
<h1>CSS <span class="color_h1">flex-basis</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-direction.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the initial length of the second flex-item to 80 pixels:</p>
<div class="w3-code notranslate cssHigh">
	div:nth-of-type(2) {<br>&nbsp;&nbsp;&nbsp; -webkit-flex-basis: 80px; /* 
	Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp; flex-basis: 80px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_flex-basis" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The flex-basis property specifies the initial length of a flexible item.</p>
<p><b>Note:</b> If the element is not a flexible item, the flex-basis property has no effect.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_flex-basis">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.flexBasis="200px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_flex-basis">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left; height: 32px;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">flex-basis</td>
    <td>29.0<br>21.0 -webkit-</td>
    <td>11.0</td>
    <td>28.0<br>18.0 -moz-</td>
    <td>9.0<br>6.1 -webkit-&nbsp;</td>
    <td>17.0</td>
  </tr></table></div>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
flex-basis: <i>number</i>|auto|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:11%">Value</th>
    <th style="width:79%">Description</th>
    <th style="width:10%">Play it</th>    
  </tr><tr><td><em>number</em></td>
    <td>A length unit, or percentage, specifying the initial length of the flexible item(s)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-basis&amp;preval=10px">Play it &raquo;</a></td>              
    </tr><tr><td>auto</td>
    <td>Default value. The length is equal to the length of the flexible item. If the item has no length specified, the length will be according to its content</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-basis&amp;preval=auto">Play it &raquo;</a></td>              
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-basis&amp;preval=initial">Play it &raquo;</a></td>              
    </tr><tr><td>inherit</td>
...
<p>CSS Reference: <a href="css3_pr_flex.asp">flex property</a></p>
<p>CSS Reference: <a href="css3_pr_flex-direction.asp">flex-direction property</a></p>
<p>CSS Reference: <a href="css3_pr_flex-flow.asp">flex-flow property</a></p>
<p>CSS Reference: <a href="css3_pr_flex-grow.asp">flex-grow property</a></p>
<p>CSS Reference: <a href="css3_pr_flex-shrink.asp">flex-shrink property</a></p>
<p>CSS Reference: <a href="css3_pr_flex-wrap.asp">flex-wrap property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_flexbasis.asp">flexBasis property</a></p>
