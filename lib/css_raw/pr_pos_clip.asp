...
<h1>CSS <span class="color_h1">clip</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_class_clear.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_color.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_clip" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p> What happens if an image is larger than its containing element? - The clip property 
...
element to be clipped.</p>
<p><b>Note:</b> The clip property does not work if "overflow:visible".</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_clip">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS2</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.clip="rect(0px,50px,50px,0px)"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_clip">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">clip</td>
    <td>1.0</td>
    <td>8.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
clip: auto|<i>shape</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>No clipping will be applied. This is default</td>
 	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_clip&amp;preval=auto">Play it &raquo;</a></td>		                  
 </tr><tr><td><i>shape</i></td>
    <td>Clips an element. The only valid value is: rect (<i>top, right, bottom, left</i>)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_clip&amp;preval=rect(0px,25px,25px,0px)">Play it &raquo;</a></td>		                  
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
 	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_clip&amp;preval=initial">Play it &raquo;</a></td>		                  
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_clip.asp">clip property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_class_clear.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_color.asp">Next &raquo;</a></div>
