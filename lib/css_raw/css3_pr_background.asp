...
<h1>CSS <span class="color_h1">background</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_backface-visibility.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-attachment.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh"> 
	...
	{ <br>
	&nbsp;&nbsp;&nbsp;
	background: #00ff00 url("smiley.gif") no-repeat fixed center; <br>
	} 
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_background">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The background shorthand property sets all the background properties in one declaration.</p>
<p>The properties that can be set, are: background-color, background-image, background-position, background-size, background-repeat, background-origin, 
background-clip, and background-attachment.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td><i>see individual properties</i></td>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_background">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1 + new properties in CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.background="red url(smiley.gif) top left 
	no-repeat"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_background">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">background</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
<p><b>Note:</b> Internet Explorer 8 and earlier versions do not support multiple background images 
on one element.</p>
<p><strong>Note:</strong> See individual browser support for each value below.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
background: <i>color image position/size repeat origin clip attachment </i>initial|inherit;</div></div>
<p><strong>Note:</strong> If one of the properties in the shorthand declaration is the background-size property,
you must use a / (slash) to separate it from the background-position property, e.g. background:url(smiley.gif) 10px 20px/50px 50px;
...
<table class="w3-table-all notranslate"><tr><th>Value</th>
    <th>Description</th>
    <th>CSS</th>
  </tr><tr><td><i><a href="pr_background-color.asp">background-color</a></i></td>
    <td>Specifies the background color to be used</td>
    <td>1</td>
  </tr><tr><td><i><a href="pr_background-image.asp">background-image</a></i></td>
    <td>Specifies ONE or MORE background images to be used</td>
    <td>1</td>
    </tr><tr><td><i><a href="pr_background-position.asp">background-position</a></i></td>
    <td>Specifies the position of the background images</td>
    <td>1</td>
  </tr><tr><td><i><a href="css3_pr_background-size.asp">background-size</a></i></td>
    <td>Specifies the size of the background images</td>
    <td>3</td>
  </tr><tr><td><i><a href="pr_background-repeat.asp">background-repeat</a></i></td>
    <td>Specifies how to repeat the background images</td>
    <td>1</td>
  </tr><tr><td><i><a href="css3_pr_background-origin.asp">background-origin</a></i></td>
    <td>Specifies the positioning area of the background images</td>
    <td>3</td>
  </tr><tr><td><i><a href="css3_pr_background-clip.asp">background-clip</a></i></td>
    <td>Specifies the painting area of the background images</td>
    <td>3</td>
  </tr><tr><td><i><a href="pr_background-attachment.asp">background-attachment</a></i></td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_background.asp">background property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_backface-visibility.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-attachment.asp">Next &raquo;</a></div>
