...
<h1>CSS <span class="color_h1">white-space</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_class_visibility.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_dim_width.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify that the text in &lt;p&gt; elements will never wrap:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_text_white-space" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.whiteSpace="nowrap"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_white-space">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">white-space</td>
    <td>1.0</td>
    <td>8.0</td>
    <td>3.5</td>
    <td>3.0</td>
...
white-space: normal|nowrap|pre|pre-line|pre-wrap|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Sequences of whitespace will collapse into a single 
	whitespace. Text will wrap when necessary. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_white-space">Play it &raquo;</a></td>                	
  </tr><tr><td>nowrap</td>
    <td>Sequences of whitespace will collapse into a single 
	whitespace. Text will never wrap to the next line. The text continues on the same line until
      a &lt;br&gt; tag is encountered</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_white-space&amp;preval=nowrap">Play it &raquo;</a></td>                	
  </tr><tr><td>pre</td>
    <td>Whitespace is preserved by the browser. Text will only wrap 
	on line breaks. Acts like the
      &lt;pre&gt; tag in HTML</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_white-space&amp;preval=pre">Play it &raquo;</a></td>                	
  </tr><tr><td>pre-line</td>
    <td>Sequences of whitespace will collapse into a single 
	whitespace. Text will wrap when necessary, and on line breaks</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_white-space&amp;preval=pre-line">Play it &raquo;</a></td>                	
  </tr><tr><td>pre-wrap</td>
    <td>Whitespace is preserved by the browser. Text will wrap when 
	necessary, and on line breaks </td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_white-space&amp;preval=pre-wrap">Play it &raquo;</a></td>                	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_white-space&amp;preval=initial">Play it &raquo;</a></td>                	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_whitespace.asp">whiteSpace property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_class_visibility.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_dim_width.asp">Next &raquo;</a></div>
