<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS flex-direction property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">flex-direction</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-basis.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-flow.asp">Next &raquo;</a></div>
</div>
...
div
{<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex; /* Safari */<br>
  &nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss3_flex-direction" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The flex-direction property specifies the direction of the flexible items.</p>

<p><b>Note:</b> If the element is not a flexible item, the flex-direction property has no effect.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.flexDirection="column-reverse"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_flex-direction">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">flex-direction</td>
...
flex-direction: row|row-reverse|column|column-reverse|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-direction&amp;preval=row">Play it &raquo;</a></td>              
    </tr><tr><td>row-reverse</td>
    <td>Same as row, but in reverse order</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-direction&amp;preval=row-reverse">Play it &raquo;</a></td>              
    </tr><tr><td>column</td>
    <td>The flexible items are displayed vertically, as a column</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-direction&amp;preval=column">Play it &raquo;</a></td>              
    </tr><tr><td>column-reverse</td>
    <td>Same as column, but in reverse order</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-direction&amp;preval=column-reverse">Play it &raquo;</a></td>              
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-direction&amp;preval=initial">Play it &raquo;</a></td>              
    </tr><tr><td>inherit</td>
...
<p>CSS Reference: <a href="css3_pr_flex-direction.asp">flex-basis property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_flexdirection.asp">flexDirection property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-basis.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-flow.asp">Next &raquo;</a></div>
