...
<h1>CSS3 <span class="color_h1">word-break</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_dim_width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_word-spacing.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Break words between any two letters:</p>
<div class="w3-code notranslate cssHigh">
  
    p.test {<br>&nbsp;&nbsp;&nbsp; word-break: break-all;<br>}
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_word-break">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The word-break property specifies line breaking rules for non-CJK scripts.</p>
<p><b>Tip:</b> CJK scripts are Chinese, Japanese and Korean ("CJK") scripts.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.wordBreak="break-all"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_word-break">Try it</a>
</td>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">word-break&nbsp;</td>
    <td>4.0</td>
    <td>5.5</td>
    <td>15.0</td>
    <td>3.1</td>
...
word-break: normal|break-all|keep-all|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    <th>Description</th>
  </tr><tr><td>normal</td>
    <td>Default value. Break words according to their usual rules</td>
  </tr><tr><td>break-all</td>
    <td>Lines may break between any two letters</td>
  </tr><tr><td>keep-all&nbsp;</td>
