<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 animation-delay Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">animation-delay</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-direction.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Wait two seconds, then start the animation:</p>
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp; -webkit-animation-delay: 2s; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp;
    animation-delay: 2s;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-delay">Try it yourself &raquo;</a>
</div>
...
<p>The animation-delay value is defined in seconds (s) or milliseconds (ms).</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.animationDelay="1s"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_animation-delay">Try it</a>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">animation-delay</td>
...
animation-delay: <i>time</i>|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    <th style="width:68%">Description</th>
    <th>Play it</th>                
  </tr><tr><td><i>time</i></td>
    <td>Optional. Defines the number of seconds (s) or milliseconds (ms) to wait before the animation will start. Default value is 0. 
	Negative values are allowed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-delay&amp;preval=1s">Play it &raquo;</a></td>			    
  </tr><tr><td>initial</td>
...
<br><div class="w3-example">
<h3>Example</h3>
<p>Using negative values, notice that the animation starts 2 seconds into the 
animation cycle:</p>
<div class="w3-code notranslate cssHigh">
  
    div {<br>&nbsp;&nbsp;&nbsp;
    -webkit-animation-delay: -2s; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp;
  
    animation-delay: -2s;<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-delay2">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="/css/css3_animations.asp">CSS3 Animations</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_animationdelay.asp">animationDelay property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-direction.asp">Next &raquo;</a></div>
