...
<h1>CSS <span class="color_h1">text-decoration</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-align-last.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-decoration-color.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the text decoration for &lt;h1&gt;, &lt;h2&gt;, and &lt;h3&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
  
    h1 {<br>&nbsp;&nbsp;&nbsp; text-decoration: overline;<br>}<br><br>
	h2 {<br>&nbsp;&nbsp;&nbsp; text-decoration: line-through;<br>}<br><br>
	h3 {<br>&nbsp;&nbsp;&nbsp; text-decoration: underline;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=trycss_text-decoration" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The text-decoration property specifies the decoration added to text.</p>
<p><b>Note:</b> In CSS3, the text-decoration property is a shorthand property for <a href="css3_pr_text-decoration-line.asp">text-decoration-line</a>,
<a href="css3_pr_text-decoration-color.asp">text-decoration-color</a>, and <a href="css3_pr_text-decoration-style.asp">text-decoration-style</a>, but this is currently not supported in any of the major browsers.</p>
<p><b>Note:</b> In CSS3 you can use the 
<a href="css3_pr_text-decoration-color.asp">text-decoration-color</a> property to change the color of the decoration, otherwise the color is the same as the color of the text.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>no, <i>see individual properties</i>. <a href="css_animatable.asp">Read about <em>animatable</em></a>
	</td>
  </tr><tr><th>Version:</th>
    <td>CSS1, renewed in CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.textDecoration="underline"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_text-decoration">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">text-decoration</td>
    <td>1.0</td>
    <td>3.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
text-decoration: none|underline|overline|line-through|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Defines a normal text. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration">Play it &raquo;</a></td>            
  </tr><tr><td>underline</td>
    <td>Defines a line below the text</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration&amp;preval=underline">Play it &raquo;</a></td>            
  </tr><tr><td>overline</td>
    <td>Defines a line above the text</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration&amp;preval=overline">Play it &raquo;</a></td>            
  </tr><tr><td>line-through</td>
    <td>Defines a line through the text</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration&amp;preval=line-through">Play it &raquo;</a></td>            
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration&amp;preval=initial">Play it &raquo;</a></td>            
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_textdecoration.asp">textDecoration property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-align-last.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-decoration-color.asp">Next &raquo;</a></div>
