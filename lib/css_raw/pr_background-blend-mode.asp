<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS background-blend-mode property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">background-blend-mode</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_background-attachment.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_background-clip.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify a blending mode:</p>
<div class="w3-code notranslate cssHigh"> 
    div { <br>&nbsp;&nbsp;&nbsp; width: 
	200px;<br>&nbsp;&nbsp;&nbsp; height: 200px;<br>&nbsp;&nbsp;&nbsp; 
	background-size: 200px 200px;<br>&nbsp;&nbsp;&nbsp; 
	background-repeat:no-repeat;<br>&nbsp;&nbsp;&nbsp; background-image: 
	linear-gradient(to right, black 0%, white 100%), url('w3css.gif');<br>&nbsp;&nbsp;&nbsp; 
	background-blend-mode: color-dodge;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_background-blend-mode" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The background-blend-mode property defines the blending mode of each 
background layer (color and/or image).</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td><i>object</i>.style.backgroundBlendMode="screen"</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:25%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">background-blend-mode</td>
    <td>35.0</td>
...
background-blend-mode: 
	normal|multiply|screen|overlay|darken|lighten|color-dodge|saturation|color|luminosity;</div></div>

<h2>Property Values</h2>

<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    <th>Description</th>
    <th>Play it</th>
  </tr><tr><td>normal</td>
    <td>This is default. Sets the blending mode to normal</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode">Play it &raquo;</a></td>	
  </tr><tr><td>multiply</td>
    <td>Sets the blending mode to multiply</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=multiply">Play it &raquo;</a></td>
  </tr><tr><td>screen</td>
    <td>Sets the blending mode to screen</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=screen">Play it &raquo;</a></td>
  </tr><tr><td>overlay</td>
    <td>Sets the blending mode to overlay</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=overlay">Play it &raquo;</a></td>
    </tr><tr><td>darken</td>
    <td>Sets the blending mode to darken</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=darken">Play it &raquo;</a></td>
    </tr><tr><td>lighten</td>
    <td>Sets the blending mode to lighten</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=lighten">Play it &raquo;</a></td>
    </tr><tr><td>color-dodge</td>
    <td>Sets the blending mode to color-dodge</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=color-dodge">Play it &raquo;</a></td>
    </tr><tr><td>saturation</td>
    <td>Sets the blending mode to saturation</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=saturation">Play it &raquo;</a></td>
    </tr><tr><td>color</td>
    <td>Sets the blending mode to color</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=color">Play it &raquo;</a></td>
    </tr><tr><td>luminosity</td>
    <td>Sets the blending mode to luminosity</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-blend-mode&amp;preval=luminosity">Play it &raquo;</a></td>
    </tr></table></div>
