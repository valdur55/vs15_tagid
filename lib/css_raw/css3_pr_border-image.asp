<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 border-image property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">border-image</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-image-outset.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify an image as the border around an element:</p>
<div class="w3-code notranslate cssHigh">
    #borderimg { <br>&nbsp;&nbsp;&nbsp; -webkit-border-image: url(border.png) 30 
	round; /* Safari 3.1-5 */<br>&nbsp;&nbsp;&nbsp; -o-border-image: url(border.png) 
	30 round; /* Opera 11-12.1 */<br>&nbsp;&nbsp;&nbsp; border-image: url(border.png) 
	30 round;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-image">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The border-image property allows you to specify an image to be used instead 
of the normal border around an element.</p>
<p>The border-image property is a shorthand property for setting the 
<a href="css3_pr_border-image-source.asp">border-image-source</a>, 
<a href="css3_pr_border-image-slice.asp">border-image-slice</a>, 
<a href="css3_pr_border-image-width.asp">border-image-width</a>, 
<a href="css3_pr_border-image-outset.asp">border-image-outset</a> 
and <a href="css3_pr_border-image-repeat.asp">border-image-repeat</a> properties.</p>
<p>Omitted values are set to their default values.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">none 100% 1 0 stretch</td>
    ...
    <td>  <i>object</i>.style.borderImage="url(border.png) 30 round"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_border-image">Try it</a>
</td>
 </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">border-image&nbsp;</td>
...
<p><strong>Note:</strong> See individual browser support for each value below.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
border-image: <i>source slice width outset repeat</i>|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:23%">Value</th>
    <th style="width:65%">Description</th>
    <th style="width:12%">Play it</th>                
  </tr><tr><td> <i><a href="css3_pr_border-image-source.asp">border-image-source</a></i></td>
    <td>The path to the image to be used as a border</td>
    <td></td>
  </tr><tr><td> <i><a href="css3_pr_border-image-slice.asp">border-image-slice</a></i></td>
    <td>How to slice the border image</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image2">Play it &raquo;</a></td>    
  </tr><tr><td> <i><a href="css3_pr_border-image-width.asp">border-image-width</a></i></td>
    <td>The width of the border image</td>
    <td></td>
  </tr><tr><td> <i><a href="css3_pr_border-image-outset.asp">border-image-outset</a></i></td>
    <td>The amount by which the border image area extends beyond the border box</td>
    <td></td>
  </tr><tr><td> <i><a href="css3_pr_border-image-repeat.asp">border-image-repeat</a></i></td>
    <td>Whether the border image should be repeated, rounded or stretched</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image">Play it &raquo;</a></td>
  </tr><tr><td>initial</td>
...
<h3>Example</h3>
	<p>Different slice values completely changes the look of the 
	border:</p>
<div class="w3-code notranslate cssHigh">
    #borderimg1 {<br>&nbsp;&nbsp;&nbsp; border: 10px solid transparent;<br>&nbsp;&nbsp;&nbsp; 
	padding: 15px;<br>&nbsp;&nbsp;&nbsp; -webkit-border-image: url(border.png) 
	50 round; /* Safari 3.1-5 */<br>&nbsp;&nbsp;&nbsp; -o-border-image: url(border.png) 
	50 round; /* Opera 11-12.1 */<br>&nbsp;&nbsp;&nbsp; border-image: url(border.png) 
	50 round;<br>}<br><br>#borderimg2 {<br>&nbsp;&nbsp;&nbsp; 
	border: 10px solid transparent;<br>&nbsp;&nbsp;&nbsp; padding: 15px;<br>&nbsp;&nbsp;&nbsp; 
	-webkit-border-image: url(border.png) 20% round; /* Safari 3.1-5 */<br>&nbsp;&nbsp;&nbsp; 
	-o-border-image: url(border.png) 20% round; /* Opera 11-12.1 */<br>&nbsp;&nbsp;&nbsp; 
	border-image: url(border.png) 20% round;<br>}<br><br>
	#borderimg3 {<br>&nbsp;&nbsp;&nbsp; border: 10px solid transparent;<br>&nbsp;&nbsp;&nbsp; 
	padding: 15px;<br>&nbsp;&nbsp;&nbsp; -webkit-border-image: url(border.png) 
	30% round; /* Safari 3.1-5 */<br>&nbsp;&nbsp;&nbsp; -o-border-image: url(border.png) 
	30% round; /* Opera 11-12.1 */<br>&nbsp;&nbsp;&nbsp; border-image: url(border.png) 
	30% round;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-image2">Try it yourself &raquo;</a>
</div>

<hr><h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="/css/css3_border_images.asp">CSS3 Border Images</a></p>
<p>CSS Reference: <a href="css3_pr_border-image-outset.asp">border-image-outset property</a></p>
<p>CSS Reference: <a href="css3_pr_border-image-repeat.asp">border-image-repeat property</a></p>
<p>CSS Reference: <a href="css3_pr_border-image-slice.asp">border-image-slice property</a></p>
<p>CSS Reference: <a href="css3_pr_border-image-source.asp">border-image-source property</a></p>
<p>CSS Reference: <a href="css3_pr_border-image-width.asp">border-image-width property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_borderimage.asp">borderImage property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_border-color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-image-outset.asp">Next &raquo;</a></div>
