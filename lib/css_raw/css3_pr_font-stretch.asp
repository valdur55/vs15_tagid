<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 font-stretch property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">font-stretch</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_font-size-adjust.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_font_font-style.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Make the text in all &lt;div&gt; elements wider:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_font-stretch">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The font-stretch property allows you to make text wider or narrower.</p>
...
<p>None of the major browsers support the font-stretch property.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">font-stretch</td>
...
font-stretch: 
	ultra-condensed|extra-condensed|condensed|semi-condensed|normal|semi-expanded|expanded|extra-expanded|ultra-expanded|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:18%">Value</th>
    <th>Description</th>
  </tr><tr><td>ultra-condensed</td>
    <td>Makes the text as narrow as it gets</td>
  </tr><tr><td>extra-condensed</td>
    <td>Makes the text narrower than condensed, but not as narrow as 
	ultra-condensed</td>
  </tr><tr><td>condensed</td>
    <td>Makes the text narrower than semi-condensed, but not as narrow as 
	extra-condensed</td>
  </tr><tr><td>semi-condensed</td>
    <td>Makes the text narrower than normal, but not as narrow as condensed</td>
  </tr><tr><td>normal</td>
    <td>Default value. No font stretching</td>
  </tr><tr><td>semi-expanded</td>
    <td>Makes the text wider than normal, but not as wide as expanded</td>
  </tr><tr><td>expanded</td>
    <td>Makes the text wider than semi-expanded, but not as wide as 
	extra-expanded</td>
  </tr><tr><td>extra-expanded</td>
    <td>Makes the text wider than expanded, but not as wide as ultra-expanded</td>
  </tr><tr><td>ultra-expanded</td>
