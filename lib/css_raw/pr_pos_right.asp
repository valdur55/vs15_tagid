...
<h1>CSS <span class="color_h1">right</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_resize.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_tab-size.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the right edge of the absolute positioned &lt;div&gt; element 20px to the left 
of the right edge of its nearest positioned ancestor:</p>
<div class="w3-code notranslate cssHigh">
  
    div.absolute {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
	right: 20px;<br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; 
	height: 120px;<br>&nbsp;&nbsp;&nbsp; border: 3px solid #8AC007;<br>}&nbsp;
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_position_right" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>For absolutely positioned elements, the right property sets the right edge of an element to a unit 
to the left/right of the right edge of its nearest positioned ancestor. <strong>
Note:</strong> If an absolute positioned element has no positioned ancestors, it 
uses the document body, and moves along with page scrolling. <strong>Note:</strong> 
A "positioned" element is one whose position is anything except static.</p>
<p>For relatively positioned elements, the right property sets the right edge of an element to a unit to the left/right to its normal position. </p>
<p><b>Note:</b> If "position:static", the right property has no effect.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_right">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS2</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.right="200px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_right">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">right</td>
    <td>1.0</td>
    <td>5.5</td>
    <td>1.0</td>
    <td>1.0</td>
...
right:  auto|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Lets the browser calculate the right edge position. This is 
	default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_right">Play it &raquo;</a></td>		                      	
  </tr><tr><td><i>length</i></td>
    <td>Sets the right edge position in px, cm, etc. Negative values are allowed
    </td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_right&amp;preval=50px">Play it &raquo;</a></td>		                              
  </tr><tr><td><i>%</i></td>
    <td>Sets the right edge position in % of containing element. 
	Negative values are allowed </td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_right&amp;preval=10%25">Play it &raquo;</a></td>		
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_right&amp;preval=initial">Play it &raquo;</a></td>		
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_right.asp">right property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_resize.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_tab-size.asp">Next &raquo;</a></div>
