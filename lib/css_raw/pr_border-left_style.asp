<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS border-left-style property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">border-left-style</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-left_color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-left_width.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-left-style property sets the style of an element's left border.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.borderLeftStyle="dotted"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-left-style">Try it</a>
</td>
  </tr></table></div>
<hr><h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the property.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left; height: 32px;">Property</th>
    <th style="width:16%; height: 32px;" class="bsChrome" title="Chrome"></th>
    <th style="width:16%; height: 32px;" class="bsIE" title="Internet Explorer"></th>
    <th style="width:16%; height: 32px;" class="bsFirefox" title="Firefox"></th>
    <th style="width:16%; height: 32px;" class="bsSafari" title="Safari"></th>
    <th style="width:16%; height: 32px;" class="bsOpera" title="Opera"></th>                
  </tr><tr><td style="text-align:left;">border-left-style</td>
    <td>1.0</td>
    <td>5.5</td>
    <td>1.0</td>
    <td>1.0</td>
...
<p><b>Note:</b> The value "hidden" is not supported in IE7 and earlier. IE8 
requires a !DOCTYPE. IE9 and later support "hidden".</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
border-left-style:none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:10%">Value</th>
    ...
    <th>Play it</th>            
      ...
      <td>Specifies no border. This is default</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=none">Play it &raquo;</a></td>		      
    </tr><tr><td>hidden</td>
      <td>The same as "none", except in border conflict
        resolution for table elements</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=hidden">Play it &raquo;</a></td>		
    </tr><tr><td>dotted</td>
      <td>Specifies a dotted border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=dotted">Play it &raquo;</a></td>		
    </tr><tr><td>dashed</td>
      <td>Specifies a dashed border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=dashed">Play it &raquo;</a></td>
    </tr><tr><td>solid</td>
      <td>Specifies a solid border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=solid">Play it &raquo;</a></td>
    </tr><tr><td>double</td>
      <td>Specifies a double border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=double">Play it &raquo;</a></td>
    </tr><tr><td>groove</td>
      <td>Specifies a 3D grooved border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=groove">Play it &raquo;</a></td>
    </tr><tr><td>ridge</td>
      <td>Specifies a 3D ridged border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=ridge">Play it &raquo;</a></td>
    </tr><tr><td>inset</td>
      <td>Specifies a 3D inset border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=inset">Play it &raquo;</a></td>
    </tr><tr><td>outset</td>
      <td>Specifies a 3D outset border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=outset">Play it &raquo;</a></td>
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-style&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<p>CSS reference: <a href="pr_border-left.asp">border-left property</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_borderleftstyle.asp">borderLeftStyle property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_border-left_color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-left_width.asp">Next &raquo;</a></div>
