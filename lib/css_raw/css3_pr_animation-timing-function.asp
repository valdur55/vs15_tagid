<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 animation-timing-function Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">animation-timing-function </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-play-state.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_backface-visibility.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Play an animation with the same speed from beginning to end:</p>
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp; -webkit-animation-timing-function: linear; /* Chrome, Safari, 
	Opera */<br>&nbsp;&nbsp;&nbsp;
    animation-timing-function: linear;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-timing-function">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The animation-timing-function specifies the speed curve of an animation.</p>
<p>The speed curve defines the TIME an animation uses to change from one set of CSS styles to another.</p>
<p>The speed curve is used to make the changes smoothly.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.animationTimingFunction="linear"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_animation-timing-function">Try it</a>
</td>
  </tr></table></div>
...
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:25%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">animation-timing-function</td>
...
animation-timing-function: linear|ease|ease-in|ease-out|cubic-bezier(<i>n</i>,<i>n</i>,<i>n</i>,<i>n</i>)|initial|inherit;</div></div>
<p>The animation-timing-function uses a mathematical function, called the Cubic 
Bezier 
curve, to make the speed curve. You can use your own 
values in this function, or use one of the pre-defined values:<br></p>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    <th style="width:68%">Description</th>
    <th>Play it</th>                
  </tr><tr><td>linear</td>
    <td>The animation has the same speed from start to end</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-timing-function&amp;preval=linear">Play it &raquo;</a></td>			    
  </tr><tr><td>ease</td>
    <td>Default value. The animation has a slow start, then fast, before it ends 
	slowly</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-timing-function&amp;preval=ease">Play it &raquo;</a></td>			    	
  </tr><tr><td>ease-in</td>
    <td>The animation has a slow start</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-timing-function&amp;preval=ease-in">Play it &raquo;</a></td>			    	
  </tr><tr><td>ease-out</td>
    <td>The animation has a slow end</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-timing-function&amp;preval=ease-out">Play it &raquo;</a></td>			    	    
  </tr><tr><td>ease-in-out</td>
    <td>The animation has both a slow start and a slow end</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-timing-function&amp;preval=ease-in-out">Play it &raquo;</a></td>			    	    
  </tr><tr><td>cubic-bezier(<i>n</i>,<i>n</i>,<i>n</i>,<i>n</i>)</td>
...
<p><b>Tip:</b> Try the different values in the Try it Yourself section below.</p>
<hr><div class="tryit_ex">
<img src="/images/tryitimg.gif" style="height:46px;width:40px" alt="Examples"><h2>More Examples</h2>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>To better understand the different timing function values;<br>
Here are five different &lt;div&gt; elements with five different values:</p>
<div class="w3-code notranslate cssHigh">
  
	/* For Chrome, Safari and Opera */<br>
	#div1 {-webkit-animation-timing-function: linear;}<br>
	#div2 {-webkit-animation-timing-function: ease;}<br>
	#div3 {-webkit-animation-timing-function: ease-in;}<br>
	#div4 {-webkit-animation-timing-function: ease-out;}<br>
	#div5 {-webkit-animation-timing-function: ease-in-out;}<br><br>/* Standard 
	syntax */<br>#div1 {animation-timing-function: linear;}<br>
	#div2 {animation-timing-function: ease;}<br>
	#div3 {animation-timing-function: ease-in;}<br>
	#div4 {animation-timing-function: ease-out;}<br>
	#div5 {animation-timing-function: ease-in-out;}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-timing-function2">Try it yourself &raquo;</a>
</div>

<br><div class="w3-example">
<h3>Example</h3>
<p>Same as the example above, but the speed curves are defined with the 
cubic-bezier function:</p>
	<div class="w3-code notranslate cssHigh">
  
		/* For Chrome, Safari and Opera */<br>
	#div1 {-webkit-animation-timing-function: cubic-bezier(0,0,1,1);}<br>
	#div2 {-webkit-animation-timing-function: cubic-bezier(0.25,0.1,0.25,1);}<br>
	#div3 {-webkit-animation-timing-function: cubic-bezier(0.42,0,1,1);}<br>
	#div4 {-webkit-animation-timing-function: cubic-bezier(0,0,0.58,1);}<br>
	#div5 {-webkit-animation-timing-function: cubic-bezier(0.42,0,0.58,1);} <br><br>/* Standard syntax */<br>#div1 {animation-timing-function: cubic-bezier(0,0,1,1);}<br>
	#div2 {animation-timing-function: cubic-bezier(0.25,0.1,0.25,1);}<br>
	#div3 {animation-timing-function: cubic-bezier(0.42,0,1,1);}<br>
	#div4 {animation-timing-function: cubic-bezier(0,0,0.58,1);}<br>
	#div5 {animation-timing-function: cubic-bezier(0.42,0,0.58,1);}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-timing-function3">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="/css/css3_animations.asp">CSS3 Animations</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_animationtimingfunction.asp">animationTimingFunction property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-play-state.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_backface-visibility.asp">Next &raquo;</a></div>
