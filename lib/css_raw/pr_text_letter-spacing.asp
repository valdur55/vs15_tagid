<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS letter-spacing property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">letter-spacing</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_pos_left.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_dim_line-height.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the letter spacing for &lt;h1&gt; and &lt;h2&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
  
    h1 {<br>&nbsp;&nbsp;&nbsp; letter-spacing: 2px;<br>}<br><br>
	h2 {<br>&nbsp;&nbsp;&nbsp; letter-spacing: -3px;<br>}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_letter-spacing" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_letter-spacing">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.letterSpacing="3px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_letter-spacing">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">letter-spacing</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
letter-spacing: normal|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>No extra space between characters. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_letter-spacing">Play it &raquo;</a></td>
  </tr><tr><td><i>length</i></td>
    <td>Defines an extra space between characters (negative values 
	are allowed)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_letter-spacing&amp;preval=3px">Play it &raquo;</a></td>	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_letter-spacing&amp;preval=initial">Play it &raquo;</a></td>	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_letterspacing.asp">letterSpacing property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_pos_left.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_dim_line-height.asp">Next &raquo;</a></div>
