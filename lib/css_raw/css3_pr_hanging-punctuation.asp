<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 hanging-punctuation property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">hanging-punctuation</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_font_weight.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_dim_height.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Place a punctuation mark (if any) outside 
	the start edge of the first line in the &lt;p&gt; element:</p>
...
<p>The hanging-punctuation property specifies whether a punctuation mark may be placed outside the line box 
at the start or at the end of a full line of text.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.hangingPunctuation="first"</td>
  </tr></table></div>
<hr><h2>Browser Support</h2>
<p>None of the major browsers support the hanging-punctuation property.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">hanging-punctuation</td>
...
hanging-punctuation: none|first|last|allow-end|force-end|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    ...
    <td>No punctuation mark may be placed outside the line box at the start or 
	at the end of a full line of text</td>
  </tr><tr><td>first</td>
    <td>Punctuation may hang outside 
	the start edge of the first line</td>
  </tr><tr><td>last</td>
    <td>Punctuation may hang outside 
	the end edge of the last line</td>
  </tr><tr><td>allow-end</td>
    <td>Punctuation may hang outside the end 
	edge of all lines if the punctuation does not otherwise fit prior to 
	justification</td>
  </tr><tr><td>force-end</td>
    <td>Punctuation may hang outside the end 
	edge of all lines. If justification is enabled on this line, then it will 
	force the punctuation to hang</td>
  </tr><tr><td>initial</td>
