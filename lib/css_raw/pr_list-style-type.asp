...
<h1>CSS <span class="color_h1">list-style-type</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_list-style-position.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_margin.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
	...
	ol.upper-roman {list-style-type: upper-roman;}<br>
	ol.lower-alpha {list-style-type: lower-alpha;}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_list-style-type_ex" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The list-style-type specifies the type of list-item marker in a list.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">disc</td>
  </tr><tr><th style="width: 25%">Inherited:</th>
    <td>yes</td>
  </tr><tr><th style="width: 25%">Animatable:</th>
    <td>no. <a href="css_animatable.asp">Read about <em>animatable</em></a>
	</td>
  </tr><tr><th style="width: 25%">Version:</th>
    <td>CSS1</td>
  </tr><tr><th style="width: 25%">JavaScript syntax:</th>
    <td>  <i>object</i>.style.listStyleType="square"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_list-style-type">Try it</a>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">list-style-type</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
<p><b>Note:</b> Internet Explorer and Opera 12 and earlier versions do not support 
the values: cjk-ideographic, 
hebrew, hiragana, hiragana-iroha, katakana, and katakana-iroha.</p>
<p><b>Note:</b> IE8, and earlier, only support the property values: decimal-leading-zero, lower-greek, lower-latin, upper-latin, armenian, georgian, 
and inherit if a DOCTYPE is specified!</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
list-style-type: <i>value</i>;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:24%">Value</th>
		<th style="width:64%">Description</th>
		<th>Play it</th>		
	</tr><tr><td>disc</td>
		<td>Default value. The marker is a filled circle</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ul_list-style-type&amp;preval=disc">Play it &raquo;</a></td>		              	</tr><tr><td>armenian</td>
		<td>The marker is traditional Armenian numbering</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=armenian">Play it &raquo;</a></td>		              
	</tr><tr><td>circle</td>
		<td>The marker is a circle</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ul_list-style-type&amp;preval=circle">Play it &raquo;</a></td>		              	</tr><tr><td>cjk-ideographic</td>
		<td>The marker is plain ideographic numbers</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=cjk-ideographic">Play it &raquo;</a></td>		              	</tr><tr><td>decimal</td>
		<td>The marker is a number</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=decimal">Play it &raquo;</a></td>		              	</tr><tr><td>decimal-leading-zero</td>
		<td>The marker is a number with leading zeros (01, 02, 
		03, etc.)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=decimal-leading-zero">Play it &raquo;</a></td>		              	</tr><tr><td>georgian</td>
		<td>The marker is traditional Georgian numbering</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=georgian">Play it &raquo;</a></td>		              	</tr><tr><td>hebrew</td>
		<td>The marker is traditional Hebrew numbering</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=hebrew">Play it &raquo;</a></td>		              	</tr><tr><td>hiragana</td>
		<td>The marker is traditional Hiragana numbering</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=hiragana">Play it &raquo;</a></td>		              	</tr><tr><td>hiragana-iroha</td>
		<td>The marker is traditional Hiragana iroha numbering</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=hiragana-iroha">Play it &raquo;</a></td>		              	</tr><tr><td>katakana</td>
		<td>The marker is traditional Katakana numbering</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=katakana">Play it &raquo;</a></td>		              	</tr><tr><td>katakana-iroha</td>
		<td>The marker is traditional Katakana iroha numbering</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=katakana-iroha">Play it &raquo;</a></td>		              	</tr><tr><td>lower-alpha</td>
		<td>The marker is lower-alpha (a, b, c, d, e, etc.)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=lower-alpha">Play it &raquo;</a></td>		              	</tr><tr><td>lower-greek</td>
		<td>The marker is lower-greek</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=lower-greek">Play it &raquo;</a></td>		              	</tr><tr><td>lower-latin</td>
		<td>The marker is lower-latin (a, b, c, d, e, etc.)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=lower-latin">Play it &raquo;</a></td>		              	</tr><tr><td>lower-roman</td>
		<td>The marker is lower-roman (i, ii, iii, iv, v, etc.)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=lower-roman">Play it &raquo;</a></td>		              	</tr><tr><td>none</td>
		<td>No marker is shown</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=none">Play it &raquo;</a></td>		              	</tr><tr><td>square</td>
		<td>The marker is a square</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ul_list-style-type&amp;preval=square">Play it &raquo;</a></td>		              	</tr><tr><td>upper-alpha</td>
		<td>The marker is upper-alpha (A, B, C, D, E, etc.)&nbsp;</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=upper-alpha">Play it &raquo;</a></td>		              	</tr><tr><td>upper-latin</td>
		<td>The marker is upper-latin (A, B, C, D, E, etc.)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=upper-latin">Play it &raquo;</a></td>		              	</tr><tr><td>upper-roman</td>
		<td>The marker is upper-roman (I, II, III, IV, V, etc.)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=upper-roman">Play it &raquo;</a></td>		              	</tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=initial">Play it &raquo;</a></td>		              	
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>This example demonstrates all the different list-item markers:</p>
<div class="w3-code notranslate cssHigh">
    ul.a {list-style-type: circle;}<br>ul.b {list-style-type: disc;}<br>ul.c 
	{list-style-type: square;}<br><br>ol.d {list-style-type: armenian;}<br>ol.e 
	{list-style-type: cjk-ideographic;}<br>ol.f {list-style-type: decimal;}<br>
	ol.g {list-style-type: decimal-leading-zero;}<br>ol.h {list-style-type: 
	georgian;}<br>ol.i {list-style-type: hebrew;}<br>ol.j {list-style-type: 
	hiragana;}<br>ol.k {list-style-type: hiragana-iroha;}<br>ol.l 
	{list-style-type: katakana;}<br>ol.m {list-style-type: katakana-iroha;}<br>
	ol.n {list-style-type: lower-alpha;}<br>ol.o {list-style-type: lower-greek;}<br>
	ol.p {list-style-type: lower-latin;}<br>ol.q {list-style-type: lower-roman;}<br>
	ol.r {list-style-type: upper-alpha;}<br>ol.s {list-style-type: upper-latin;}<br>
	ol.t {list-style-type: upper-roman;}<br><br>ol.u {list-style-type: none;}<br>
	ol.v {list-style-type: inherit;}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_list-style-type_all">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_list.asp">CSS List</a></p>
<p>CSS reference: <a href="pr_list-style.asp">list-style property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_liststyletype.asp">listStyleType property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_list-style-position.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_margin.asp">Next &raquo;</a></div>
