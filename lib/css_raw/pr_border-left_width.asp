<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS border-left-width property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">border-left-width</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-left_style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-radius.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-left-width" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-left-width property sets the width of an element's left border.</p>

<p><b>Note:</b> Always declare the border-style property before the border-left-width
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-left-width">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.borderLeftWidth="5px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-left-width">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">border-left-width</td>
    <td>1.0</td>
    <td>4.0&nbsp;</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
border-left-width: medium|thin|thick|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Specifies a medium left border. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-width&amp;preval=medium">Play it &raquo;</a></td>		      
  </tr><tr><td>thin</td>
    <td>Specifies a thin left border</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-width&amp;preval=thin">Play it &raquo;</a></td>		      
  </tr><tr><td>thick</td>
    <td>Specifies a thick left border</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-width&amp;preval=thick">Play it &raquo;</a></td>		          
  </tr><tr><td><i>length</i></td>
    <td>Allows you to define the thickness of the left border</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-width&amp;preval=10px">Play it &raquo;</a></td>		      
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-left-width&amp;preval=initial">Play it &raquo;</a></td>		      
    </tr><tr><td>inherit</td>
...
<a href="/jsref/prop_style_borderleftwidth.asp">borderLeftWidth property</a></p>
