...
<h1>CSS3 <span class="color_h1">column-rule-style</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-rule-color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-rule-width.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp;
	-webkit-column-rule-style: dotted; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-rule-style: dotted; /* Firefox */<br>
	&nbsp;&nbsp;&nbsp;
	column-rule-style: dotted;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_column-rule-style">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The column-rule-style property specifies the style of the rule between columns.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.columnRuleStyle="dotted"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_column-rule-style">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">column-rule-style</td>
    <td>4.0 -webkit-</td>
    <td>10.0</td>
    <td>2.0 -moz-</td>
    <td>3.1 -webkit-</td>
...
column-rule-style: none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. Defines no rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style">Play it &raquo;</a></td>			    	    
  </tr><tr><td> hidden</td>
    <td>Defines a hidden rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=hidden">Play it &raquo;</a></td>			    	        
  </tr><tr><td> dotted</td>
    <td>Defines a dotted rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=dotted">Play it &raquo;</a></td>			    	            
  </tr><tr><td> dashed</td>
    <td>Defines a dashed rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=dashed">Play it &raquo;</a></td>			    	            
  </tr><tr><td> solid</td>
    <td>Defines a solid rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=solid">Play it &raquo;</a></td>			    	            
  </tr><tr><td> double</td>
    <td>Defines a double rule</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=double">Play it &raquo;</a></td>			    	            
  </tr><tr><td> groove</td>
    <td>Specifies a 3D grooved rule. The effect depends on the width and color 
	values</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=groove">Play it &raquo;</a></td>			    	        	
  </tr><tr><td> ridge</td>
    <td>Specifies a 3D ridged rule. The effect depends on the width and color 
	values</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=ridge">Play it &raquo;</a></td>			    	        	
  </tr><tr><td> inset</td>
    <td>Specifies a 3D inset rule. The effect depends on the width and color 
	values</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=inset">Play it &raquo;</a></td>			    	        	
  </tr><tr><td> outset</td>
    <td>Specifies a 3D outset rule. The effect depends on the width and color 
	values</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=outset">Play it &raquo;</a></td>			    	        	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-style&amp;preval=initial">Play it &raquo;</a></td>			    	        	
    </tr><tr><td>inherit</td>
...
<h3>Column-count</h3>
<p>Divide the text in a &lt;div&gt; element into three columns:</p>
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp;
	-webkit-column-count: 3; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-count: 3; /* Firefox */<br>
	&nbsp;&nbsp;&nbsp;
	column-count: 3;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_column-count">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Column-gap</h3>
<p>Divide the text in a &lt;div&gt; element into three columns, and specify a 40 pixels gap 
between the columns.</p>
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp; -webkit-column-count: 3; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; 
	-moz-column-count: 3; /* Firefox */<br>&nbsp;&nbsp;&nbsp; column-count: 3;<br><br>&nbsp;&nbsp;&nbsp; -webkit-column-gap: 40px; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; 
	-moz-column-gap: 40px; /* Firefox */<br>&nbsp;&nbsp;&nbsp; column-gap: 40px;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_column-gap">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Column-rule</h3>
...
<div class="w3-code notranslate cssHigh">
	...
	{<br>&nbsp;&nbsp;&nbsp; -webkit-column-count: 3; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; 
	-moz-column-count: 3; /* Firefox */<br>&nbsp;&nbsp;&nbsp; column-count: 3;<br><br>&nbsp;&nbsp;&nbsp; -webkit-column-gap: 40px; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; 
	-moz-column-gap: 40px; /* Firefox */<br>&nbsp;&nbsp;&nbsp; column-gap: 40px;<br><br>&nbsp;&nbsp;&nbsp; -webkit-column-rule: 4px outset #ff00ff; /* Chrome, 
	Safari, Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-rule: 4px outset #ff00ff; 
	/* Firefox */<br>&nbsp;&nbsp;&nbsp; column-rule: 4px outset #ff00ff;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_column-rule">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="/css/css3_multiple_columns.asp">CSS3 Multiple Columns</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_columnrulestyle.asp">columnRuleStyle property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-rule-color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-rule-width.asp">Next &raquo;</a></div>
