...
<h1>CSS <span class="color_h1">flex-flow</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-direction.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-grow.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Make the flexible items display in reverse order, and wrap if necesarry:</p>
<div class="w3-code notranslate cssHigh">
	div {<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex; /* Safari */<br>
  &nbsp;&nbsp;&nbsp;
    -webkit-flex-flow: row-reverse wrap; /* Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp;
	display: flex;<br>&nbsp;&nbsp;&nbsp; flex-flow: row-reverse wrap;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_flex-flow" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p>The flex-direction property specifies the direction of the flexible items.</p>
<p>The flex-wrap property specifies whether the flexible items should wrap or not.</p>

<p><b>Note:</b> If the elements are not flexible items, the flex-flow property has no effect.</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">row nowrap</td>
    ...
    <td><i>object</i>.style.flexFlow="column nowrap"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_flex-flow">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">flex-flow</td>
...
flex-flow: <i>flex-direction</i> <i>flex-wrap</i>|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:21%">Value</th>
    <th style="width:69%">Description</th>
    <th style="width:10%">Play it</th>    
  </tr><tr><td><em>flex-direction</em></td>
    <td>Possible values:<br><br>row<br>row-reverse<br>column<br>column-reverse<br>initial<br>inherit
		<p>Default value is "row".</p>
		<p>Specifying the direction of the flexible items</p></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-flow">Play it &raquo;</a></td>              
    </tr><tr><td><em>flex-wrap</em></td>
    <td>Possible values:<br><br>nowrap<br>wrap<br>wrap-reverse<br>initial<br>inherit
		<p>Default value is "nowrap".</p>

		<p>Specifying whether the flexible items should wrap or not</p>

</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-flow">Play it &raquo;</a></td>              
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-flow&amp;preval=initial">Play it &raquo;</a></td>              
    </tr><tr><td>inherit</td>
...
<p>CSS Reference: <a href="css3_pr_flex-basis.asp">flex-basis property</a></p>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_flexflow.asp">flexFlow property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-direction.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-grow.asp">Next &raquo;</a></div>
