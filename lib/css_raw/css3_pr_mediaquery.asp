...
<h1>CSS3 <span class="color_h1">@media</span> Rule</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_dim_max-width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_dim_min-height.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Change the background-color if the viewport is 480 pixels wide or wider:</p>
<div class="w3-code notranslate cssHigh">
	@media screen and (min-width: 480px) {<br>&nbsp;&nbsp;&nbsp; body {<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	background-color: lightgreen;<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_media_example1">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The @media rule is used to define different style rules for different media types/devices.</p>
<p>In CSS2 this was called media types, while in CSS3 it is called media 
queries. </p>
<p>Media queries look at the capability of the device, and can be used to check many things, such as:</p>
<ul><li>width and height of the viewport</li>
	<li>width and height of the device</li>
	<li>orientation (is the tablet/phone in landscape or portrait mode?)</li>
	<li>resolution</li>
	<li>and much more</li>
</ul><hr><h2>Browser Support</h2>
<p>The numbers in the table specifies the first browser version that fully supports the @media rule.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Rule</th>
    <th style="width:16%;" class="bsChrome" title="Chrome"></th>
    <th style="width:16%;" class="bsIE" title="Internet Explorer"></th>
    <th style="width:16%;" class="bsFirefox" title="Firefox"></th>
    <th style="width:16%;" class="bsSafari" title="Safari"></th>
    <th style="width:16%;" class="bsOpera" title="Opera"></th>                
  </tr><tr><td style="text-align:left;">@media</td>
    <td>21</td>
    <td>9</td>
    <td>3.5</td>
    <td>4.0</td>
...
@media not|only <i>mediatype </i>and<i> (media feature)</i> {<i><br>&nbsp;&nbsp;&nbsp; 
	CSS-Code;<br></i>}</div></div>
	
<p>You can also have different <em>stylesheets</em> for different media:</p>

<div class="w3-code w3-border notranslate"><div>
	&lt;link rel="stylesheet" media="<em>mediatype</em> and|not|only (<em>media 
	feature</em>)" 
	href="<em>mystylesheet.css</em>"&gt;</div></div>
...
<h3>Example</h3>
<p>Use the @media rule to make responsive design:</p>
<div class="w3-code notranslate cssHigh">
    @media only screen and (max-width: 500px) {<br>&nbsp;&nbsp;&nbsp; .gridmenu 
	{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width:100%;<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp;&nbsp;&nbsp; .gridmain 
	{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width:100%;<br>&nbsp;&nbsp;&nbsp; 
	}<br><br>&nbsp;&nbsp;&nbsp; .gridright {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	width:100%;<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_mediaquery">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_mediatypes.asp">CSS Media Types</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_dim_max-width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_dim_min-height.asp">Next &raquo;</a></div>
