...
<h1>CSS3 <span class="color_h1">font-size-adjust</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_font_font-size.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_font-stretch.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>By specifying the font-size-adjust property, the browser will adjust the font 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_font-size-adjust">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The font-size-adjust property gives you better control of the font size when 
the first selected font is not available.</p>
<p>When a font is not available, the browser uses the second specified font. 
This could result in a big change for the font size. To prevent this, use the 
font-size-adjust property.</p>
<p>All fonts have an "aspect value" which is the size-difference between the 
lowercase letter "x" and the uppercase letter "X".</p>
<p>When the browser knows the "aspect value" for the first selected font, the 
browser can figure out what font-size to use when displaying text with the 
second choice font.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.fontSizeAdjust="0.58"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_font-size-adjust">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">font-size-adjust</td>
...
font-size-adjust: <i>number</i>|none|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Defines the aspect value to use</td>
  </tr><tr><td>none</td>
    <td>Default value. No font size adjustment</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_fontsizeadjust.asp">fontSizeAdjust property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_font_font-size.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_font-stretch.asp">Next &raquo;</a></div>
