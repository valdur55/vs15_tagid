...
<h1>CSS <span class="color_h1">justify-content</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_dim_height.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-keyframes.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Make some space around the items of the flexible &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  
    div
	{<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex; /* Safari */<br>&nbsp;&nbsp;&nbsp; -webkit-justify-content: space-around; /* Safari 6.1+ */<br>
	&nbsp;&nbsp;&nbsp;
	display: flex;<br>
    &nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss3_justify-content" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> Use the <a href="css3_pr_align-items.asp">align-items</a> property to align the items on the cross-axis (vertically).</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">flex-start</td>
    ...
    <td>  <i>object</i>.style.justifyContent="space-between"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_justify-content">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">justify-content</td>
...
justify-content: flex-start|flex-end|center|space-between|space-around|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_justify-content&amp;preval=flex-start">Play it &raquo;</a></td>          
    </tr><tr><td>flex-end</td>
    <td>Items are positioned at the end of the container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_justify-content&amp;preval=flex-end">Play it &raquo;</a></td>          
    </tr><tr><td>center</td>
    <td>Items are positioned at the center of the container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_justify-content&amp;preval=center">Play it &raquo;</a></td>          
    </tr><tr><td>space-between</td>
    <td>Items are positioned with space between the lines</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_justify-content&amp;preval=space-between">Play it &raquo;</a></td>          
    </tr><tr><td>space-around</td>
    <td>Items are positioned with space before, between, and after the lines</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_justify-content&amp;preval=space-around">Play it &raquo;</a></td>          
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_justify-content&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_justifycontent.asp">justifyContent property</a></p>
