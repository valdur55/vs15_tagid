...
<h1>CSS <span class="color_h1">list-style-image</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_list-style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_list-style-position.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_list-style-image" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The list-style-image property replaces the list-item marker with an image.</p>
<p><b>Note: </b>Always specify the list-style-type property in addition. This property is used if the image for some reason is unavailable.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.listStyleImage="url('smiley.gif')"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_list-style-image">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">list-style-image</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
list-style-image: none|<i>url</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>No image will be displayed. Instead, the list-style-type 
	property will define what type of list marker will be rendered. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_list-style-image&amp;preval=none">Play it &raquo;</a></td>		                  	
  </tr><tr><td>url</td>
    <td>The path to the image to be used as a list-item marker</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_list-style-image">Play it &raquo;</a></td>		                  
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_list-style-image&amp;preval=initial">Play it &raquo;</a></td>		                  	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_liststyleimage.asp">listStyleImage property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_list-style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_list-style-position.asp">Next &raquo;</a></div>
