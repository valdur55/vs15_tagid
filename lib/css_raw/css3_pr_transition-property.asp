<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 transition-property Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">transition-property </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transition-duration.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transition-timing-function.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
	...
	{<br>
    &nbsp;&nbsp;&nbsp;
    -webkit-transition-property: width; /* Safari */<br>&nbsp;&nbsp;&nbsp;
	transition-property: width;<br>
	}<br><br>div:hover {<br>&nbsp;&nbsp;&nbsp; width: 300px;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition-property">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The transition-property property specifies the name of the CSS property the transition 
effect is for (the transition effect will start when the specified CSS property changes).</p>
<p><b>Tip:</b> A transition effect could typically occur when a user hover over an element.</p>
<p><b>Note:</b> Always specify the transition-duration property, otherwise the duration is 0, and the transition will have no effect.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.transitionProperty="width,height"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_transition-property">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left; height: 32px;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">transition-property</td>
...
transition-property: none|all|<i>property</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. All properties will get a transition effect</td>
  </tr><tr><td><i>property</i></td>
    <td>Defines a comma separated list of CSS property names the transition 
	effect is for</td>
  </tr><tr><td>initial</td>
...
<h3>Example</h3>
<p>Hover over a &lt;div&gt; element, and change the width AND height with a smooth 
transition effect:</p>
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp; -webkit-transition-property: width, height; /* 
	Safari */<br>&nbsp;&nbsp;&nbsp; transition-property: width, height;<br>}<br><br>div:hover {<br>&nbsp;&nbsp;&nbsp; width: 300px;<br>&nbsp;&nbsp;&nbsp; 
	height: 300px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition-property2">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_transitions.asp">CSS3 Transitions</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_transitionproperty.asp">transitionProperty property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transition-duration.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transition-timing-function.asp">Next &raquo;</a></div>
