<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 perspective-origin property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">perspective-origin </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_perspective.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_position.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set a 3D element's base placement:</p>
<div class="w3-code notranslate cssHigh">
  
    div
	{<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-perspective: 150px; /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-perspective-origin: 10% 10%; /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
	perspective: 150px;<br>
	&nbsp;&nbsp;&nbsp;
	perspective-origin: 10% 10%;<br>
	}
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_perspective-origin1">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The perspective-origin property defines where a 3D element is based in the x- 
and the y-axis. This property allows you to change the bottom position of 3D 
elements.</p>
<p>When defining the perspective-origin property for an element, it is the CHILD elements 
that are positioned, NOT the element itself.</p>
<p><b>Note:</b> This property must be used together with the 
<a href="css3_pr_perspective.asp">perspective</a> property, and only affects 3D 
transformed elements!</p>
<p>To better understand the perspective-origin property,
<a href="trycss3_perspective-origin_inuse.htm" target="_blank">view a demo</a>.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">50% 50%</td>
  </tr><tr><th>Inherited:</th>
    <td>no</td>
  </tr><tr><th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_perspective-origin">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.perspectiveOrigin="10px 50%"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_perspective-origin">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">perspective-origin</td>
    <td>36.0<br>12.0 -webkit-</td>
    <td>10.0</td>
    <td>16.0<br>10.0 -moz-</td>
    <td>9.0<br>4.0.3 -webkit-</td>
    <td>23.0<br>15.0 -webkit-</td>
  </tr></table></div>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
perspective-origin: <i>x-axis y-axis</i>|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Property Value</th>
    <th>Description</th>
  </tr><tr><td><i>x-axis</i></td>
    <td>Defining where the view is placed at the x-axis<p>Possible values:</p>
	<ul><li>left</li>
		<li>center</li>
		<li>right</li>
		<li><i>length</i></li>
		<li><i>%</i></li>
	</ul><p>Default value: 50%</p></td>
  </tr><tr><td><i>y-axis</i></td>
    <td>Defining where the view is placed at the y-axis<p>Possible values:</p>
	<ul><li>top</li>
		<li>center</li>
		<li>bottom</li>
		<li><i>length</i></li>
...
<a href="/jsref/prop_style_perspectiveorigin.asp">perspectiveOrigin property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_perspective.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_position.asp">Next &raquo;</a></div>
