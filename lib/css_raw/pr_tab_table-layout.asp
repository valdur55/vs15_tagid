...
<h1>CSS <span class="color_h1">table-layout</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_tab-size.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_text-align.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the table layout algorithm:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_table_table-layout" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The table-layout property sets the table layout algorithm to be used for a table.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.tableLayout="fixed"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_table-layout">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">table-layout</td>
    <td>14.0</td>
    <td>5.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
table-layout: auto|fixed|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <th>Play it</th>    
		...
		<td>Automatic table layout algorithm (this is default):
		<ul><li>The column width is set by the widest unbreakable content in the cells</li>
			<li>Can be slow, since it needs to read through all the content in the table, before determining the final layout</li>
		</ul></td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_table-layout">Play it &raquo;</a></td>		
	</tr><tr><td>fixed</td>
		<td>Fixed table layout algorithm:
		<ul><li>The horizontal layout only depends on the table's width and the width of the columns, not the contents of the cells</li>
			<li>Allows a browser to lay out the table faster than the automatic table layout</li>
			<li>The browser can begin to display the table once the first row has been received</li>
		</ul></td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_table-layout&amp;preval=fixed">Play it &raquo;</a></td>				
	</tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_table-layout&amp;preval=initial">Play it &raquo;</a></td>				
    </tr><tr><td>inherit</td>
...
<p>CSS tutorial: <a href="/css/css_table.asp">CSS Table</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_tablelayout.asp">tableLayout property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_tab-size.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_text-align.asp">Next &raquo;</a></div>
