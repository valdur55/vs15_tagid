...
<h1>CSS3 <span class="color_h1">column-span</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-rule-width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-width.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    h2
	{<br>
	&nbsp;&nbsp;&nbsp; -webkit-column-span: all; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp;
	column-span: all;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_column-span">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The column-span property specifies how many columns an element should span across.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.columnSpan="all"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_column-span">Try it</a>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">column-span&nbsp;</td>
    <td>4.0 -webkit-</td>
    <td>10.0</td>
...
column-span: 1|all|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. The element should span across one column</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-span">Play it &raquo;</a></td>
  </tr><tr><td>all</td>
    <td>The element should span across all columns</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-span&amp;preval=all">Play it &raquo;</a></td>    
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-span&amp;preval=initial">Play it &raquo;</a></td>    
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_columnspan.asp">columnSpan property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-rule-width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-width.asp">Next &raquo;</a></div>
