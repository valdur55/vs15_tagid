...
<h1>CSS <span class="color_h1">background-color</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_background-clip.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-image.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the background-color of different elements:</p>
<div class="w3-code notranslate cssHigh">
    body
	{<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>}<br><br>
	h1
	{<br>&nbsp;&nbsp;&nbsp; background-color: #00ff00;<br>}<br><br>
	p&nbsp;{<br>&nbsp;&nbsp;&nbsp; background-color: rgb(255,0,255);<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_background-color" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p>The background of an element is the total size of the element, including 
padding and border (but not the margin).</p>
<p><b>Tip:</b> Use a background color and a text color that makes the text easy 
to read.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">transparent</td>
  </tr><tr><th>Inherited:</th>
    <td>no</td>
  </tr><tr><th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a>
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_background-color">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.backgroundColor="#00FF00"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_background-color">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">background-color</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
background-color: <i>color</i>|transparent|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
	...
	CSS Color Values</a> for a complete list of possible color values.</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-color">Play it &raquo;</a></td>	
  </tr><tr><td>transparent</td>
    <td>Specifies that the background color should be transparent. 
	This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-color&amp;preval=transparent">Play it &raquo;</a></td>
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-color&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the background-color of a part of the text:</p>
<div class="w3-code notranslate cssHigh">
  
    span.highlight {<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text_background">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_background.asp">CSS Background</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_backgroundcolor.asp">backgroundColor property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_background-clip.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-image.asp">Next &raquo;</a></div>
