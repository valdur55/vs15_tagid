...
<h1>CSS <span class="color_h1">clear</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_tab_caption-side.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_clip.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>No floating elements allowed on the left or the right side of a specified &lt;p&gt; 
element:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_class-clear" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The clear property specifies on which sides of an element where floating elements are not allowed 
to float.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.clear="both"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_clear">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">clear</td>
    <td>1.0</td>
    <td>5.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
clear: none|left|right|both|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    ...
    <td>Default. Allows floating elements on both sides</td>
  </tr><tr><td>left</td>
    <td>No floating elements allowed on the left side</td>
  </tr><tr><td>right</td>
    <td>No floating elements allowed on the right side</td>
  </tr><tr><td>both</td>
    <td>No floating elements allowed on either the left or the right
      side</td>
  </tr><tr><td>initial</td>
...
<a href="/jsref/prop_style_clear.asp">clear property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_tab_caption-side.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_clip.asp">Next &raquo;</a></div>
