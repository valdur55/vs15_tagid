...
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_word-wrap.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="default.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_zindex" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p><b>Note:</b> z-index only works on positioned elements (position:absolute, position:relative, or position:fixed).</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_z-index">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS2</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.zIndex="-1"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_z-index">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">z-index&nbsp;</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>3.0</td>
    <td>1.0</td>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_z-index">Play it &raquo;</a></td>		                      	
  </tr><tr><td><i>number</i></td>
    <td>Sets the stack order of the element. Negative numbers are 
	allowed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_z-index&amp;preval=2">Play it &raquo;</a></td>		                      		
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_z-index&amp;preval=initial">Play it &raquo;</a></td>		                      		
    </tr><tr><td>inherit</td>
...
<a href="/jsref/prop_style_zindex.asp">zIndex property</a><br></p>
