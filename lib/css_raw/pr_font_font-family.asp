...
<h1>CSS <span class="color_h1">font-family</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_font-face_rule.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_font_font-size.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify the font for a paragraph:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_font-family" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The font-family property specifies the font for an element.</p>
<p>The font-family property can hold several font names as a "fallback" system. 
If the browser does not support the first font, it tries the next font.</p>
<p>There are two types of font family names:</p>

<ul><li><b>family-name</b> - The name of a font-family, like "times", "courier", "arial", etc.</li>
<li><b>generic-family</b> - The name of a generic-family, like "serif", "sans-serif", "cursive", "fantasy", "monospace".</li>
</ul><p>Start with the font you want, and always end with a generic family, to let the browser pick a similar font in the generic family, if no other fonts are available.</p>
<p><b>Note:</b> Separate each value with a comma.</p>
<p><b>Note: </b>If a font name contains white-space, it must be quoted. Single quotes must be used when using the "style" attribute in HTML.</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%"><i>depends on the browser</i></td>
    ...
    <td>  <i>object</i>.style.fontFamily="Verdana,sans-serif"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_font-family">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">font-family</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
font-family: <i>font</i>|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:16%">Value</th>
    <th>Description</th>
    <th>Play it</th>                
  </tr><tr><td><i>family-name<br>
      generic-family</i></td>
    <td>A prioritized list of font family names and/or generic 
	family names</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-family">Play it &raquo;</a></td>		              	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-family&amp;preval=initial">Play it &raquo;</a></td>		              	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_fontfamily.asp">fontFamily property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_font-face_rule.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_font_font-size.asp">Next &raquo;</a></div>
