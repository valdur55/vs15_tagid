...
<h1>CSS3 <span class="color_h1">@font-face</span> Rule</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_font_font.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_font_font-family.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_font-face_rule">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>With the @font-face rule, web designers do no longer have to use one of the "web-safe" fonts.</p>
<p>In the new @font-face rule you must first define a name for the font (e.g. myFirstFont), and then point to the font file.</p>
<p><strong>Tip:</strong> Use lowercase letters for the font URL. Uppercase 
letters can give unexpected results in IE!</p>
<p>To use the font for an HTML element, refer to the name of the font (myFirstFont) through the font-family property:</p>
...
<p>The @font-face rule is supported in Internet Explorer, Firefox, Opera, Chrome, and Safari.</p>
<p>The numbers in the table specifies the first browser version that fully supports the 
font format.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:15%;font-size:16px;text-align:left;">Font format</th>
...
<p>*Firefox: Disabled by default, but can be enabled (need to set a flag to 
"true" to use WOFF2).</p>
<hr><h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
@font-face
	{<br>
	&nbsp;&nbsp;&nbsp; <i>font-properties</i><br>
	}</div></div>

<br><div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Font descriptor</th>
    <th style="width:20%">Values</th>
    <th style="width:60%">Description</th>
  </tr><tr><td>font-family</td>
    <td><i>name</i></td>
    <td>Required. Defines the name of the font.</td>
  </tr><tr><td>src</td>
    <td><i>URL</i></td>
    <td>Required. Defines the URL(s) where the font should be downloaded from</td>
  </tr><tr><td>font-stretch</td>
    <td>normal<br>
	condensed<br>
	ultra-condensed<br>
	extra-condensed<br>
	...
	extra-expanded<br>
	ultra-expanded</td>
    <td>Optional. Defines how the font should be stretched. Default value is 
	"normal"</td>
  </tr><tr><td>font-style</td>
    <td>normal<br>
	italic<br>
	oblique</td>
    <td>Optional. Defines how the font should be styled. Default value is 
	"normal"</td>
	...
	800<br>
	900</td>
    <td>Optional. Defines the boldness of the font. Default value is "normal"</td>
  </tr><tr><td>unicode-range</td>
    <td><i>unicode-range</i></td>
    <td>Optional. Defines the range of unicode characters the font supports. 
	Default value is "U+0-10FFFF"</td>
  </tr></table></div>
<hr><div class="tryit_ex">
<img src="/images/tryitimg.gif" style="width:40px;height:46px" alt="Examples"><h2>Try it Yourself - Examples</h2>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>You must add another @font-face rule containing descriptors for bold text:</p>
<div class="w3-code notranslate cssHigh">
    @font-face {<br>&nbsp;&nbsp;&nbsp; font-family: myFirstFont;<br>&nbsp;&nbsp;&nbsp; src: url(sansation_bold.woff);<br>
	&nbsp;&nbsp;&nbsp;
	font-weight: bold;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_font-face_rule_bold">Try it yourself &raquo;</a>
</div>
<p>The file "sansation_bold.woff" is another font file, that contains the bold 
characters for the Sansation font.</p>
<p>Browsers will use this whenever a piece of text with the font-family "myFirstFont" should render as bold.</p>
<p>This way you can have many @font-face rules for the same font.</p>
<hr><h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="/css/css3_fonts.asp">CSS3 Fonts</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_font_font.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_font_font-family.asp">Next &raquo;</a></div>
