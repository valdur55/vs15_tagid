...
<h1>CSS3 <span class="color_h1">animation </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_all.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-delay.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    div
	{<br>
    &nbsp;&nbsp;&nbsp; -webkit-animation: mymove 5s infinite; /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
	animation: mymove 5s infinite;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The animation property is a shorthand property for eight of the animation properties:</p>
<ul><li>animation-name</li>
...
</ul><p><b>Note:</b> Always specify the animation-duration property, otherwise the duration is 0, and will never be played.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.animation="mymove 5s infinite"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_animation">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">animation&nbsp;</td>
...
animation: <i>name duration timing-function delay iteration-count 
direction fill-mode play-state</i>;</div></div>
<h2>Property Values</h2>

<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th>Value</th>
    <th>Description</th>
  </tr><tr><td><i><a href="css3_pr_animation-name.asp">animation-name</a></i></td>
    <td>Specifies the name of the keyframe you want to bind to the selector</td>
  </tr><tr><td><i><a href="css3_pr_animation-duration.asp">animation-duration</a></i></td>
    <td>Specifies how many seconds or milliseconds an animation takes to 
	complete</td>
  </tr><tr><td><i><a href="css3_pr_animation-timing-function.asp">
	animation-timing-function</a></i></td>
    <td>Specifies the speed curve of the animation</td>
  </tr><tr><td><i><a href="css3_pr_animation-delay.asp">animation-delay</a></i></td>
    <td>Specifies a delay before the animation will start</td>
  </tr><tr><td><i><a href="css3_pr_animation-iteration-count.asp">
	animation-iteration-count</a></i></td>
    <td>Specifies how many times an animation should be played</td>
  </tr><tr><td><i><a href="css3_pr_animation-direction.asp">animation-direction</a></i></td>
    <td>Specifies whether or not the animation should play in reverse on 
	alternate cycles</td>
  </tr><tr><td><em><a href="css3_pr_animation-fill-mode.asp">animation-fill-mode</a></em></td>
    <td>Specifies what values are applied by the animation outside the time it 
	is executing</td>
  </tr><tr><td><em><a href="css3_pr_animation-play-state.asp">animation-play-state</a></em></td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_animation.asp">animation property</a></p>
