<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS counter-increment property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">counter-increment</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_gen_content.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_counter-reset.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>A way to number sections and sub-sections with "Section 1", "1.1", "1.2", etc.:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_gen_counter-reset" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The counter-increment property increments one or more counter values.</p>
<p>The counter-increment property is usually used together with the counter-reset property and the content property.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.counterIncrement = "subsection";
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_counter-increment">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">counter-increment</td>
    <td>4.0</td>
    <td>8.0</td>
    <td>2.0</td>
    <td>3.1</td>
...
<p><b>Note:</b> IE8 supports the counter-increment property only if a !DOCTYPE 
is specified.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
counter-increment: none|<i>id</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. No counters will be incremented</td>
  </tr><tr><td><i>id number</i></td>
    <td>The <i>id</i> defines which counter that should be 
	incremented. The <i>number</i> sets how much the counter will increment on 
	each occurrence of the selector. The default increment is 1. 0 or negative 
	values, are allowed. If the <i>id</i> refers to a counter that has not been 
	initialized by counter-reset, the default initial value is 0</td>
  </tr><tr><td>initial</td>
...
<p>CSS reference: <a href="pr_gen_content.asp">content property</a></p>
<p>CSS reference: <a href="pr_gen_counter-reset.asp">counter-reset property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_counterincrement.asp">counterIncrement property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_gen_content.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_counter-reset.asp">Next &raquo;</a></div>
