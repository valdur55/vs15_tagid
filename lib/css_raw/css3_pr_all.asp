...
<h1>CSS <span class="color_h1">all</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_align-self.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Change all the properties applied to the element or the element's 
	parent to their initial value:</p>
<div class="w3-code notranslate cssHigh">  
    div
	{<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>&nbsp;&nbsp;&nbsp; 
	color: red;<br>&nbsp;&nbsp;&nbsp; all: initial;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_all" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The all property resets all properties, apart from unicode-bidi and 
direction, to their initial or inherited value.</p>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">all</td>
    <td>37.0</td>
...
all: initial|inherit|unset;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>Changes all the properties applied to the element or the element's 
	parent to their initial value</td>
    </tr><tr><td>inherit</td>
    <td>Changes all the properties applied to the element or the element's 
	parent to their parent value</td>
    </tr><tr><td>unset</td>
    <td>Changes all the properties applied to the element or the element's 
