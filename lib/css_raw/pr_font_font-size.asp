...
<h1>CSS <span class="color_h1">font-size</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_font_font-family.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_font-size-adjust.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the font size for different HTML elements:</p>
<div class="w3-code notranslate cssHigh">
  
    h1 {<br>&nbsp;&nbsp;&nbsp; font-size: 250%;<br>}<br><br>
	h2 {<br>&nbsp;&nbsp;&nbsp; font-size: 200%;<br>}<br><br>p {<br>&nbsp;&nbsp;&nbsp; font-size: 100%;<br>}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_font-size" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">medium</td>
  </tr><tr><th>Inherited:</th>
    <td>yes</td>
  </tr><tr><th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a>
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_font-size">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.fontSize="14px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_font-size">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">font-size</td>
    <td>1.0</td>
    <td>5.5</td>
    <td>1.0</td>
    <td>1.0</td>
...
font-size:medium|xx-small|x-small|small|large|x-large|xx-large|smaller|larger|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Sets the font-size to a medium size. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=medium">Play it &raquo;</a></td>        
  </tr><tr><td>xx-small</td>
    <td>Sets the font-size to an xx-small size</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=xx-small">Play it &raquo;</a></td>    
  </tr><tr><td>x-small</td>
    <td>Sets the font-size to an extra small size</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=x-small">Play it &raquo;</a></td>        
  </tr><tr><td>small</td>
    <td>Sets the font-size to a small size</td>
   	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=small">Play it &raquo;</a></td>    
  </tr><tr><td>large</td>
    <td>Sets the font-size to a large size</td>
   	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=large">Play it &raquo;</a></td>    
  </tr><tr><td>x-large</td>
    <td>Sets the font-size to an extra large size</td>
   	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=x-large">Play it &raquo;</a></td>    
  </tr><tr><td>xx-large</td>
    <td>Sets the font-size to an xx-large size</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=xx-large">Play it &raquo;</a></td>        
  </tr><tr><td>smaller</td>
    <td>Sets the font-size to a smaller size than the parent
      element</td>
     	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=smaller">Play it &raquo;</a></td>    
  </tr><tr><td>larger</td>
    <td>Sets the font-size to a larger size than the parent element</td>
   	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=larger">Play it &raquo;</a></td>    
  </tr><tr><td><i>length</i></td>
    <td>Sets the font-size to a fixed size in px, cm, etc.</td>
   	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=10px">Play it &raquo;</a></td>    
  </tr><tr><td><i>%</i></td>
    <td>Sets the font-size to a percent of&nbsp; the parent element's 
	font size</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=50%25">Play it &raquo;</a></td>    
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<p>CSS reference: <a href="pr_font_font.asp">font property</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_fontsize.asp">fontSize property</a></p>
