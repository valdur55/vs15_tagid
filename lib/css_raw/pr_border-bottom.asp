<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS border-bottom property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">border-bottom</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-bottom_color.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-bottom shorthand property sets all the bottom border properties in 
one declaration.</p>
<p>The properties that can be set, are (in order): border-bottom-width, border-bottom-style, and border-bottom-color.</p>
<p>It does not matter if one of the values above are missing, e.g.
	border-bottom:solid #ff0000; is allowed.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">medium none <i>color</i></td>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-bottom">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.borderBottom="3px solid blue"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-bottom">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">border-bottom</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
border-bottom: <i>border-width</i> <i>border-style</i> <i>border-color</i>|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:25%">Value</th>
    <th>Description</th>
  </tr><tr><td><i><a href="pr_border-bottom_width.asp">border-bottom-width</a></i></td>
    <td>Specifies the width of the bottom border. Default value is "medium"</td>
  </tr><tr><td><i><a href="pr_border-bottom_style.asp">border-bottom-style</a></i></td>
    <td>Specifies the style of the bottom border. Default value is "none"</td>
  </tr><tr><td><i><a href="pr_border-bottom_color.asp">border-bottom-color</a></i></td>
    <td>Specifies the color of the bottom border. Default value is the color of the element</td>
  </tr><tr><td>initial</td>
...
<a href="/jsref/prop_style_borderbottom.asp">borderBottom property</a></p>
