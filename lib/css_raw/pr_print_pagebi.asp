<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS page-break-inside property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">page-break-inside</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_print_pagebb.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_perspective.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Avoid page break inside paragraphs, across pages (when printing):</p>
<div class="w3-code notranslate cssHigh">
  
	@media print
{<br>
	&nbsp;&nbsp;&nbsp;
	p {page-break-inside: avoid;}<br>
}</div>
<br></div>
<hr><h2>Definition and Usage</h2>
<p>The page-break-inside property sets whether a page break is allowed inside a specified element.</p>
<p><b>Note:</b>  You cannot use this property on absolutely positioned elements.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.pageBreakInside="avoid"</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">page-break-inside</td>
    <td>1.0</td>
    <td>8.0</td>
    <td>19.0</td>
    <td>1.3</td>
...
page-break-inside: auto|avoid|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    <th>Description</th>
      ...
      <td>Avoid page break inside the element (if possible)</td>
    </tr><tr><td>initial</td>
...
<a href="/jsref/prop_style_pagebreakinside.asp">pageBreakInside property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_print_pagebb.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_perspective.asp">Next &raquo;</a></div>
