...
<h1>CSS <span class="color_h1">left</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-keyframes.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_letter-spacing.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the left edge of the absolute positioned &lt;div&gt; element 80px to the right 
of the left edge of its nearest positioned ancestor:</p>
<div class="w3-code notranslate cssHigh">
  
    div.absolute {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
	left: 80px;<br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; 
	height: 120px;<br>&nbsp;&nbsp;&nbsp; border: 3px solid #8AC007;<br>}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_position_left" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>For absolutely positioned elements, the left property sets the left edge of an element to a unit 
to the left/right of the left edge of its nearest positioned ancestor. <strong>
...
<p>For relatively positioned elements, the left property sets the left edge of an element to a unit to the left/right to its normal position. </p>
<p><b>Note:</b> If "position:static", the left property has no effect.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_left">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS2</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.left="100px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_left">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">left</td>
    <td>1.0</td>
    <td>5.5&nbsp;</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
left: auto|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Lets the browser calculate the left edge position. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_left">Play it &raquo;</a></td>		                      
  </tr><tr><td><i>length</i></td>
    <td>Sets the left edge position in px, cm, etc. Negative values are allowed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_left&amp;preval=50px">Play it &raquo;</a></td>		                          
  </tr><tr><td><i>%</i></td>
    <td>Sets the left edge position in % of containing element. 
	Negative values are allowed </td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_left&amp;preval=10%25">Play it &raquo;</a></td>	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_left&amp;preval=initial">Play it &raquo;</a></td>	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_left.asp">left property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-keyframes.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_letter-spacing.asp">Next &raquo;</a></div>
