<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 animation-play-state Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">animation-play-state </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-name.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-timing-function.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp; -webkit-animation-play-state: paused; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp;
  
    animation-play-state: paused;<br>
    }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-play-state">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The animation-play-state property specifies whether the animation is running 
or paused.</p>
<p><b>Note:</b> Use this property in a JavaScript to pause an animation in the 
middle of a cycle.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">running</td>
    ...
    <td>  <i>object</i>.style.animationPlayState="paused"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_animation-play-state">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">animation-play-state</td>
...
animation-play-state: paused|running|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-play-state&amp;preval=paused">Play it &raquo;</a></td>			    
  </tr><tr><td>running</td>
    <td>Default value. Specifies that the animation is running</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-play-state&amp;preval=running">Play it &raquo;</a></td>			        
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_animationplaystate.asp">animationPlayState property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-name.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-timing-function.asp">Next &raquo;</a></div>
