<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 border-image-slice property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">border-image-slice</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-image-repeat.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-image-source.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-image-slice">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-image-slice property specifies how to slice the image specified by
<a href="css3_pr_border-image-source.asp">border-image-source</a>. The image is 
always sliced into nine sections: four corners, four edges and the middle.</p>
<p>The "middle" part is treated as 
fully transparent, unless the fill keyword is set.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.borderImageSlice="30%"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_border-image-slice">Try it</a>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">border-image-slice</td>
    <td>15.0</td>
    <td>11.0</td>
    <td>15.0</td>
    <td>6.0</td>
...
border-image-slice: <i>number</i>|<i>%</i>|fill|initial|inherit;</div></div>
<p><b>Note:</b> The border-image-slice property can take from one to four values. If the fourth 
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>The number(s) represent pixels for raster images 
	or coordinates for vector images</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-slice">Play it &raquo;</a></td>              
  </tr><tr><td> <i>%</i></td>
    <td>Percentages are relative to the height or width of the image</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-slice2">Play it &raquo;</a></td>              
  </tr><tr><td> fill</td>
    <td>Causes the middle part of the image to be displayed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-slice3">Play it &raquo;</a></td>              
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_borderimageslice.asp">borderImageSlice property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-image-repeat.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-image-source.asp">Next &raquo;</a></div>
