<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS outline-style Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">outline-style</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_outline-offset.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_outline-width.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_outline-color" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>An outline is a line that is drawn around elements (outside the borders)
to make the element "stand out".</p>
<p>The outline-style property specifies the style of an
outline.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.outlineStyle="dashed"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_outline-style">Try it</a>
</td>
  </tr></table></div>
<hr><h2>Tips and Notes</h2>
<p>An outline is a line around an element. It is displayed around the margin of 
the element. However, it is different from the border property.</p>
<p>The outline is not a part of the element's dimensions, therefore the 
element's width and height properties do not contain the width of the outline.</p>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">outline-style</td>
    <td>1.0</td>
    <td>8.0</td>
    <td>1.5</td>
    <td>1.2</td>
...
<p><b>Note:</b> IE8 supports the outline-style property only if a !DOCTYPE is specified.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
outline-style: none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <th>Play it</th>            
      ...
      <td>Specifies no outline. This is default</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style">Play it &raquo;</a></td>		      	
    </tr><tr><td>hidden</td>
      <td>Specifies a hidden outline</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=hidden">Play it &raquo;</a></td>		      	      
    </tr><tr><td>dotted</td>
      <td>Specifies a dotted outline</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=dotted">Play it &raquo;</a></td>		      	      
    </tr><tr><td>dashed</td>
      <td>Specifies a dashed outline</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=dashed">Play it &raquo;</a></td>		      	      
    </tr><tr><td>solid</td>
      <td>Specifies a solid outline</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=solid">Play it &raquo;</a></td>		      	      
    </tr><tr><td>double</td>
      <td>Specifies a double outliner</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=double">Play it &raquo;</a></td>		      	      
    </tr><tr><td>groove</td>
      <td>Specifies a 3D grooved outline. The effect depends on the outline-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=groove">Play it &raquo;</a></td>		      	              
    </tr><tr><td>ridge</td>
      <td>Specifies a 3D ridged outline. The effect depends on the outline-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=ridge">Play it &raquo;</a></td>		      	              
    </tr><tr><td>inset</td>
      <td>Specifies a 3D inset outline. The effect depends on the outline-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=inset">Play it &raquo;</a></td>		      	              
    </tr><tr><td>outset</td>
      <td>Specifies a 3D outset outline. The effect depends on the outline-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=outset">Play it &raquo;</a></td>		      	              
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_outline-style&amp;preval=initial">Play it &raquo;</a></td>		      	              
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>Set the style of an outline using different values:</p>
<div class="w3-code notranslate cssHigh">
    p.dotted {outline-style: dotted;}<br>p.dashed {outline-style: dashed;}<br>
	p.solid {outline-style: solid;}<br>p.double {outline-style: double;}<br>
	p.groove {outline-style: groove;}<br>p.ridge {outline-style: ridge;}<br>
	p.inset {outline-style: inset;}<br>p.outset {outline-style: outset;}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_outline-style">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_outline.asp">CSS Outline</a></p>
<p>CSS reference: <a href="pr_outline.asp">outline property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_outlinestyle.asp">outlineStyle property</a></p>
