...
<h1>CSS <span class="color_h1">background-image</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_background-color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_background-origin.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_background-image" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p>By default, a background-image is placed at the top-left corner of an 
element, and repeated both vertically and horizontally.</p>
<p><b>Tip: </b>Always set a background-color to be used if the image is unavailable.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>CSS1 + new values in CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.backgroundImage="url(smiley.gif)"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_background-image">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">background-image</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
background-image: <i>url</i>|none|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th>Value</th>
    ...
    <td>The URL to the image. To specify more than one image, separate the URLs 
	with a comma</td>
  </tr><tr><td>none</td>
...
<h3>Example</h3>
<p>Set multiple background images for the &lt;body&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  
    body {<br>&nbsp;&nbsp;&nbsp; background-image: url("img_tree.gif"), 
	url("img_flwr.gif");<br>&nbsp;&nbsp;&nbsp; background-color: #cccccc;<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_multiple">Try it yourself &raquo;</a>
</div>
...
<a href="/jsref/prop_style_backgroundimage.asp">backgroundImage property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_background-color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_background-origin.asp">Next &raquo;</a></div>
