...
<h1>CSS <span class="color_h1">text-decoration-style</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-decoration-line.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_text-indent.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Display a wavy line under a &lt;p&gt; element:</p>
<div class="w3-code notranslate cssHigh">
p
{<br>&nbsp;&nbsp;&nbsp;
-moz-text-decoration-style: wavy; /* Code for Firefox */<br>
&nbsp;&nbsp;&nbsp;
text-decoration: underline;<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_text-decoration-style" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The text-decoration-style property specifies how the line, if any, will display.</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">solid</td>
    ...
    <td>  <i>object</i>.style.textDecorationStyle="wavy"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_text-decoration-style">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">text-decoration-style</td>
...
text-decoration-style: solid|double|dotted|dashed|wavy|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>Default value. The line will display as a single line</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=solid">Play it &raquo;</a></td>          
    </tr><tr><td>double</td>
    <td>The line will display as a double line</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=double">Play it &raquo;</a></td>          
    </tr><tr><td>dotted</td>
    <td>The line will display as a dotted line</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=dotted">Play it &raquo;</a></td>          
    </tr><tr><td>dashed</td>
    <td>The line will display as a dashed line</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=dashed">Play it &raquo;</a></td>          
    </tr><tr><td>wavy</td>
    <td>The line will display as a wavy line</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=wavy">Play it &raquo;</a></td>          
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_textdecorationstyle.asp">textDecorationStyle property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-decoration-line.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_text-indent.asp">Next &raquo;</a></div>
