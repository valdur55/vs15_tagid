...
<h1>CSS <span class="color_h1">line-height</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_text_letter-spacing.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_list-style.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the line height in percent:</p>
<div class="w3-code notranslate cssHigh">
    p.small {<br>&nbsp;&nbsp;&nbsp; line-height: 90%;<br>}<br><br>
	p.big {<br>&nbsp;&nbsp;&nbsp; line-height: 200%;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_line-height" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The line-height property specifies the line height.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_line-height">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.lineHeight="30px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_line-height">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">line-height</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
line-height: normal|<i>number</i>|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_line-height">Play it &raquo;</a></td>    
  </tr><tr><td><i>number</i></td>
    <td>A number that will be multiplied with the current
      font size to set the line height</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_line-height&amp;preval=3">Play it &raquo;</a></td>    
  </tr><tr><td><i>length</i></td>
    <td>A fixed line height in px, pt, cm, etc.</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_line-height&amp;preval=25px">Play it &raquo;</a></td>    
  </tr><tr><td><i>%</i></td>
    <td>A line height in percent of the current font
      size</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_line-height&amp;preval=150%25">Play it &raquo;</a></td>          
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_line-height&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>Specify the space between the lines in two paragraphs using a pixel value.</p>
<div class="w3-code notranslate cssHigh">
    p.small {<br>&nbsp;&nbsp;&nbsp; line-height: 10px;<br>}<br><br>p.big {<br>&nbsp;&nbsp;&nbsp; 
	line-height: 30px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_dim_line-height_pixel">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify the space between the lines in two paragraphs using a number value.</p>
<div class="w3-code notranslate cssHigh">
    p.small {<br>&nbsp;&nbsp;&nbsp; line-height: 0.5;<br>}<br><br>p.big {<br>&nbsp;&nbsp;&nbsp; 
	line-height: 2;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_dim_line-height_number">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_text.asp">CSS Text</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_lineheight.asp">lineHeight property</a></p>
