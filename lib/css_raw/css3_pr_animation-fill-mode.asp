<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 animation-fill-mode Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">animation-fill-mode </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-duration.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-iteration-count.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Animate something moving from one place to another and have it stay there:</p>
<div class="w3-code notranslate cssHigh">
  
    div {<br>&nbsp;&nbsp;&nbsp; -webkit-animation-fill-mode: forwards; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp;
  
    animation-fill-mode: forwards;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-fill-mode" target="_blank">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The animation-fill-mode property specifies a style for the element when the animation is 
	not playing (when it is finished, or when it has a delay).</p>
<p>By default, CSS animations do not affect the element until the first keyframe is "played", and then stops once the last keyframe has completed. The animation-fill-mode property can override this 
behavior. </p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.animationFillMode="forwards"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_animation-fill-mode">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">animation-fill-mode</td>
    <td>4.0 -webkit-</td>
    <td>10.0</td>
...
animation-fill-mode: none|forwards|backwards|both|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    <th>Description</th>
  </tr><tr><td>none</td>
    <td>Default value. The animation will not apply any styles to the target 
	element before or after it 
	is executing</td>
  </tr><tr><td>forwards</td>
    <td>After the animation ends (determined by animation-iteration-count), the 
	animation will apply the property values for the time the animation ended</td>
  </tr><tr><td>backwards</td>
	...
	defined by animation-delay. These are either the values of the from keyframe 
	(when animation-direction is "normal" or "alternate") or those of the to 
	keyframe (when animation-direction is "reverse" or "alternate-reverse")</td>
  </tr><tr><td>both</td>
    <td>The animation will follow the rules for both forwards and backwards. 
	That is, it will extend the animation properties in both directions </td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_animationfillmode.asp">animationFillMode property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-duration.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-iteration-count.asp">Next &raquo;</a></div>
