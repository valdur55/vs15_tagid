...
<h1>CSS <span class="color_h1">max-width</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_dim_max-height.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_mediaquery.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the maximum width of a &lt;p&gt; element:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_dim_max-width" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The max-width property is used to set the maximum width of an element.</p>
<p>This prevents the value of the width property from becoming larger than 
max-width.</p>
<p><strong>Note:</strong> The value of the max-width property overrides
<a href="pr_dim_width.asp">width</a>.&nbsp;</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_max-width">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS2</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.maxWidth="600px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_max-width">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">max-width</td>
    <td>1.0</td>
    <td>7.0</td>
    <td>1.0</td>
    <td>2.0.2</td>
...
max-width: none|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>No maximum width. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_max-width">Play it &raquo;</a></td>		              
  </tr><tr><td><i>length</i></td>
    <td>Defines the maximum width in px, cm, etc.&nbsp;</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_max-width&amp;preval=50px">Play it &raquo;</a></td>		                  
  </tr><tr><td><i>%</i></td>
    <td>Defines the maximum width in percent of the containing block</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_max-width&amp;preval=50%25">Play it &raquo;</a></td>		                      
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_max-width&amp;preval=initial">Play it &raquo;</a></td>		                      
    </tr><tr><td>inherit</td>
...
<p>CSS reference: <a href="pr_dim_min-width.asp">min-width property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_maxwidth.asp">maxWidth property</a></p>
