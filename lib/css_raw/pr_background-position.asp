...
<h1>CSS <span class="color_h1">background-position</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_background-origin.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-repeat.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_background-position" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p><b>Tip: </b>By default, a background-image is placed at the top-left corner of an 
element, and repeated both vertically and horizontally.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_background-position">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.backgroundPosition="center"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_background-position">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">background-position</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
background-position: <i>value</i>;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:18%">Value</th>
    <th>Description</th>
    <th>Play it</th>    
  </tr><tr><td>left top<br>
      left center<br>
      left bottom<br>
      right top<br>
      right center<br>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-position">Play it &raquo;</a></td>
  </tr><tr><td><i>x% y%</i></td>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-position&amp;preval=50%25%2050%25">Play it &raquo;</a></td>
  </tr><tr><td><i>xpos ypos</i></td>
    <td>The first value&nbsp;is the horizontal position and the second
      value is the vertical. The top left corner is 0 0. Units can be pixels
      (0px 0px) or any other <a href="css_units.asp">CSS units</a>. If you only specify one value, the other 
	value will be 50%. You can mix % and positions</td>

	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-position&amp;preval=10px%20200px">Play it &raquo;</a></td>
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-position&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
    <td>Inherits this property from its parent element. 
	<a href="css_inherit.asp">Read about <em>inherit</em></a></td>
	<td></td>
    </tr></table></div>
...
<h3>Example</h3>
<p>How to position a background-image using percent:</p>
<div class="w3-code notranslate cssHigh">
    body
	{ <br>
	&nbsp;&nbsp;&nbsp;
	...
	background-attachment: fixed;<br>
	&nbsp;&nbsp;&nbsp;
	background-position: 30% 20%; <br>
	}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_background-position_percent" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>How to position a background-image using pixels:</p>
<div class="w3-code notranslate cssHigh">
    body
	{ <br>
	&nbsp;&nbsp;&nbsp;
	...
	&nbsp;&nbsp;&nbsp;
	background-attachment: fixed;<br>
	&nbsp;&nbsp;&nbsp; background-position: 50px 100px; <br>
	}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_background-position_pixel" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_background.asp">CSS Background</a></p>
<p>CSS reference: <a href="pr_background-image.asp">background-image property</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_backgroundposition.asp">backgroundPosition property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_background-origin.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-repeat.asp">Next &raquo;</a></div>
