<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 backface-visibility property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">backface-visibility</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-timing-function.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_background.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Hide the backside of a rotated &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh"> 
    div
	{<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-backface-visibility: hidden; /* Chrome, Safari, Opera */<br>	
	&nbsp;&nbsp;&nbsp;	
	backface-visibility: hidden;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_backface-visibility">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The backface-visibility property defines whether or not an element 
should be visible when not facing the screen.</p>
<p>This property is useful when an element is rotated, and you do not want to 
see its backside.</p>
<p>To better understand this property,
<a target="_blank" href="trycss3_backface_inuse.htm">view a demo</a>.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.backfaceVisibility="hidden"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_backface-visibility">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">backface-visibility</td>
...
backface-visibility: visible|hidden|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. The backside is visible</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_backface-visibility">Play it &raquo;</a></td>
  </tr><tr><td>hidden</td>
    <td>The backside is not visible</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_backface-visibility&amp;preval=hidden">Play it &raquo;</a></td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_backfacevisibility.asp">backfaceVisibility property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-timing-function.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_background.asp">Next &raquo;</a></div>
