...
<h1>CSS <span class="color_h1">empty-cells</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_class_display.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_filter.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Hide border and background on empty cells in a table:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_table_empty-cells" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The empty-cells property sets whether or not to display borders and background on empty cells in a table (only for the "separated borders" model).</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.emptyCells="hide"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_empty-cells">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">empty-cells</td>
    <td>1.0</td>
    <td>8.0</td>
    <td>1.0</td>
    <td>1.2</td>
...
<p><b>Note:</b> IE8 supports the empty-cells property only if a !DOCTYPE 
is specified.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
empty-cells: show|hide|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <th>Play it</th>    
		...
		<td>Background and borders are shown on empty cells. This 
		is default</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_empty-cells&amp;preval=show">Play it &raquo;</a></td>		
	</tr><tr><td>hide</td>
		<td>No background or borders are shown on empty cells</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_empty-cells&amp;preval=hide">Play it &raquo;</a></td>
	</tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_empty-cells&amp;preval=initial">Play it &raquo;</a></td>		
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_emptycells.asp">emptyCells property</a></p>
<hr><div class="nav">
<div class="prev"><a class="chapter" href="pr_class_display.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_filter.asp">Next &raquo;</a></div>
