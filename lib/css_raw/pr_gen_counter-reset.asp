<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS counter-reset property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">counter-reset</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_gen_counter-increment.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_cursor.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>A way to number sections and sub-sections with
      "Section 1", "1.1", "1.2", etc.:</p>
...
<p>The counter-reset property creates or resets one or more counters.</p>
<p>The counter-reset property is usually used together with the counter-increment property and the content property.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.counterReset="section"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_counter-reset">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">counter-reset</td>
    <td>4.0</td>
    <td>8.0</td>
    <td>2.0</td>
    <td>3.1</td>
...
<p><b>Note:</b> IE8 supports the counter-reset property only if a !DOCTYPE 
is specified.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
counter-reset: none|<i>name number</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. No counters will be reset</td>
  </tr><tr><td><i>name</i></td>
    <td>The <i>name</i> defines which counter that should be reset</td>
  </tr><tr><td><i>number</i></td>
    <td>The <i>id</i> defines which counter that should be reset. The <i>number</i> sets the value the counter is
      set to on each occurrence of the selector. The default reset value is 0</td>
  </tr><tr><td>initial</td>
...
<p>CSS reference: <a href="pr_gen_counter-increment.asp">counter-increment property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_counterreset.asp">counterReset property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_gen_counter-increment.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_cursor.asp">Next &raquo;</a></div>
