...
<h1>CSS3 <span class="color_h1">background-clip</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_background-blend-mode.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-color.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify the painting area of the background:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background-clip">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The background-clip property specifies the painting area of the 
background.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">border-box</td>
    ...
    <td>  <i>object</i>.style.backgroundClip="content-box"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_background-clip">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">background-clip</td>
    <td>4.0</td>
    <td>9.0</td>
    <td>4.0</td>
    <td>3.0&nbsp;</td>
...
background-clip: border-box|padding-box|content-box|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. The background is clipped to the border box</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-clip">Play it &raquo;</a></td>
  </tr><tr><td>padding-box</td>
    <td>The background is clipped to the padding box</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-clip&amp;preval=padding-box">Play it &raquo;</a></td>
  </tr><tr><td>content-box</td>
    <td>The background is clipped to the content box</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-clip&amp;preval=content-box">Play it &raquo;</a></td>
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-clip&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_backgroundclip.asp">backgroundClip property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_background-blend-mode.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-color.asp">Next &raquo;</a></div>
