...
<h1>CSS3 <span class="color_h1">word-wrap</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_text_word-spacing.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_z-index.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    ...
    p.test {<br>&nbsp;&nbsp;&nbsp; word-wrap: break-word;<br>}
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_word-wrap">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The word-wrap property allows long words to be able to be broken and wrap 
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.wordWrap="break-word"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_word-wrap">Try it</a>
</td>
  </tr></table><hr><h2>Browser Support</h2>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">word-wrap</td>
    <td>4.0</td>
    <td>5.5</td>
    <td>3.5</td>
    <td>3.1</td>
    <td>10.5&nbsp;</td>
  </tr></table><hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
word-wrap: normal|break-word|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    <th>Description</th>
  </tr><tr><td>normal</td>
    <td>Break words only at allowed break points</td>
  </tr><tr><td>break-word</td>
    <td>Allows unbreakable words to be broken</td>
  </tr><tr><td>initial</td>
    ...
    </tr></table><hr><h2>Related Pages</h2>
