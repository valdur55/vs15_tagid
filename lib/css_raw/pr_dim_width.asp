...
<h1>CSS <span class="color_h1">width</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_text_white-space.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_word-break.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the height and width of a &lt;p&gt; element:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_dim_height" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>

<p>The width property sets the width of an element.</p>
<p><b>Note:</b> The width property does not include padding, borders, or margins; 
it sets the width of the area inside the padding, border, and margin of the 
element!</p>
<p><b>Note:</b> The <a href="pr_dim_min-width.asp">min-width</a> and
<a href="pr_dim_max-width.asp">max-width</a> properties override width.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_width">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.width="500px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_width">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">width</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
width: auto|<i>value</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Default value. The browser calculates the width</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_width&amp;preval=auto">Play it &raquo;</a></td>		              
  </tr><tr><td><i>length</i></td>
    <td>Defines the width in px, cm, etc.&nbsp;</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_width&amp;preval=150px">Play it &raquo;</a></td>		              
  </tr><tr><td><i>%</i></td>
    <td>Defines the width in percent of the containing block</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_width&amp;preval=50%25">Play it &raquo;</a></td>		              
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_width&amp;preval=initial">Play it &raquo;</a></td>		              
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>Set the width of an &lt;img&gt; element using a percent value:</p>
<div class="w3-code notranslate cssHigh">
    img {<br>&nbsp;&nbsp;&nbsp; width: 50%;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_dim_width_percent">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_dimension.asp">CSS Dimension</a></p>
<p>CSS tutorial: <a href="/css/css_boxmodel.asp">CSS Box model</a></p>
<p>CSS reference: <a href="pr_dim_height.asp">height property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_width.asp">width property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_text_white-space.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_word-break.asp">Next &raquo;</a></div>
