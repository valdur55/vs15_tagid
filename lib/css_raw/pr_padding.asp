...
<h1>CSS <span class="color_h1">padding</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_overflow-y.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_padding-bottom.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the padding of a &lt;p&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  
    p 
	{<br>
	&nbsp;&nbsp;&nbsp;
	padding: 2cm 4cm 3cm 4cm;<br>
	}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_padding" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The padding shorthand property sets all the padding properties in one declaration. This property can have from one to four values.</p>
<p>Examples:</p>
<ul><li><b>padding:10px 5px 15px 20px;</b>
	<ul><li>top padding is 10px</li>
	<li>right padding is 5px</li>
	<li>bottom padding is 15px</li>
	<li>left padding is 20px</li></ul><br></li>
	<li><b>padding:10px 5px 15px;</b><ul><li>top padding is 10px</li>
	<li>right and left padding are 5px</li>
	<li>bottom padding is 15px</li></ul><br></li>
	<li><b>padding:10px 5px;</b><ul><li>top and bottom padding are 10px</li>
	<li>right and left padding are 5px</li></ul><br></li>
	<li><b>padding:10px;</b><ul><li>all four paddings are 10px</li></ul></li>
</ul><p><b>Note:</b> Negative values are not allowed.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_padding">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.padding="100px 20px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_padding">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">padding&nbsp;</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
padding: <i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Specifies the padding in px, pt, cm, etc. Default value is 0</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_padding">Play it &raquo;</a></td>		                  
  </tr><tr><td><i>%</i></td>
    <td>Specifies the padding in percent of the width of the 
	containing element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_padding&amp;preval=20%25">Play it &raquo;</a></td>		                  	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_padding&amp;preval=initial">Play it &raquo;</a></td>		                  	
    </tr><tr><td>inherit</td>
...
<p>CSS tutorial: <a href="/css/css_padding.asp">CSS Padding</a></p>
<p>CSS tutorial: <a href="/css/css_boxmodel.asp">CSS Box Model</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_padding.asp">padding 
property</a></p>
