...
<h1>CSS <span class="color_h1">text-indent</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-decoration-style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-justify.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Indent the first line of all &lt;p&gt; elements with 50 pixels:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_text-indent" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The text-indent property specifies the indentation of the first line in a text-block.</p>
<p><b>Note:</b>  Negative values are allowed. The first line will be indented to the left if the value is negative.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_text-indent">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.textIndent="50px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_text-indent">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">text-indent</td>
    <td>1.0</td>
    <td>3.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
text-indent: <i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Defines a fixed indentation in px, pt, cm, em, etc. Default value is 0</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-indent">Play it &raquo;</a></td>                
  </tr><tr><td><i>%</i></td>
    <td>Defines the indentation in % of the width of the parent 
	element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-indent&amp;preval=10%25">Play it &raquo;</a></td>                	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-indent&amp;preval=initial">Play it &raquo;</a></td>                	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_textindent.asp">textIndent property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-decoration-style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-justify.asp">Next &raquo;</a></div>
