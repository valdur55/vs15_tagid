...
<h1>CSS3 <span class="color_h1">box-sizing</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_box-shadow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_tab_caption-side.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify that &lt;div&gt; elements should have padding and border included in 
the 
element's total width and height:</p>
<div class="w3-code notranslate cssHigh">
    .div {<br>&nbsp;&nbsp;&nbsp; width: 300px;<br>&nbsp;&nbsp;&nbsp; height: 
	100px;<br>&nbsp;&nbsp;&nbsp; border: 1px solid blue;<br>&nbsp;&nbsp;&nbsp; 
	box-sizing: border-box;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-sizing">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The box-sizing property is used to tell the browser what the sizing 
properties (width and height) should include.</p>
<p>Should they include the border-box? Or just the content-box (which is the 
default value of the width and height properties)?</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">content-box</td>
    ...
    <td>  <i>object</i>.style.boxSizing="border-box"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_box-sizing">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">box-sizing</td>
    <td>10.0<br>4.0 -webkit-</td>
    <td>8.0</td>
    <td>29.0<br>2.0 -moz-</td>
    <td>5.1<br>3.2 -webkit-</td>
    <td>9.5</td>
  </tr></table></div>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
box-sizing: content-box|border-box|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    <th>Description</th>
  </tr><tr><td> content-box</td>
    <td>Default. The width and height properties (and min/max properties) 
	includes only the content. Border, padding, or margin are not included</td>
  </tr><tr><td> border-box</td>
    <td>The width and height properties (and min/max properties) includes 
	content, padding and border, but not the margin</td>
  </tr><tr><td>initial</td>
...
<h3>Example</h3>
<p>Specify two bordered boxes side by side:</p>
<div class="w3-code notranslate cssHigh">
    div
	{<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-sizing2">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="/css/css3_box-sizing.asp">CSS3 Box Sizing</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_boxsizing.asp">boxSizing property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_box-shadow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_tab_caption-side.asp">Next &raquo;</a></div>
