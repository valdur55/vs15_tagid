...
</script><meta content="text/html; charset=utf-8" http-equiv="Content-Type"><link rel="stylesheet" type="text/css" href="/browserref.css"><link rel="stylesheet" type="text/css" href="/stdtheme.css"></head><body>
...
<h1>CSS <span class="color_h1">quotes</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_class_position.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_resize.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify the quotation marks for quotations:</p>
<div class="w3-code notranslate cssHigh">
  
    q
	{<br>
	&nbsp;&nbsp;&nbsp;
	quotes: "&laquo;" "&raquo;";<br>
	}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_gen_quotes" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%"><i>not specified</i></td>
    ...
    <td>  <i>object</i>.style.quotes="'&laquo;' '&raquo;'"
 <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_quotes">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">quotes&nbsp;</td>
    <td>11.0</td>
    <td>8.0</td>
    <td>1.5</td>
    <td>5.1</td>
...
quotes: none|<i>string</i>|initial|inherit;</div></div>


<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:28%">Value</th>
    <th style="width:54%">Description</th>
    <th>Play it</th>                
  </tr><tr><td>none</td>
    <td>Specifies that the "open-quote" and "close-quote" values of the 
	"content" property will not produce any quotation marks</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_quotes">
	Play it &raquo;</a></td>		              
  </tr><tr><td><i>string string string string</i></td>
    <td>Specifies which quotation marks to use. The first two values specifies 
	the first level of quotation embedding, the next two values specifies the 
	next level of quote embedding, etc</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_quotes&amp;preval=%22">
	Play it &raquo;</a></td>		                    
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_quotes&amp;preval=initial;">
	Play it &raquo;</a></td>		                    
    </tr><tr><td>inherit</td>
    <td>Inherits this property from its parent element. <a href="css_inherit.asp">Read about <em>inherit</em></a></td>
	<td></td>
    </tr></table></div>
<h2>Quotation Mark Characters</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:15%">Result</th>
    <th style="width:55%">Description</th>
    <th style="width:30%">Entity Number</th>
  </tr><tr><td>"</td>
    <td> double quote</td>
    <td>&amp;#34;</td>
  </tr><tr><td>'</td>
    ...
    <td>single, left angle quote</td>
    <td>
    &amp;#8249;</td>
  </tr><tr><td>&rsaquo;</td>
    <td>single, right angle quote</td>
    <td>
    &amp;#8250;</td>
  </tr><tr><td>&laquo;</td>
    <td>double, left angle quote</td>
    <td>
    &amp;#171;
    </td>
  </tr><tr><td>&raquo;</td>
    <td>double, right angle quote</td>
    <td>
    &amp;#187;
    </td>
  </tr><tr><td>&lsquo;</td>
    <td>left quote (single high-6)</td>
    <td>
    &amp;#8216;
    </td>
  </tr><tr><td>&rsquo;</td>
    <td>right quote (single high-9)</td>
    <td>
    &amp;#8217;
    </td>
  </tr><tr><td>&ldquo;</td>
    <td>left quote (double high-6)</td>
    <td>
    &amp;#8220;
    </td>
  </tr><tr><td>&rdquo;</td>
    <td>right quote (double high-9)</td>
    <td>
    &amp;#8221;
    </td>
  </tr><tr><td>&bdquo;</td>
    <td>double quote (double low-9)</td>
    <td>
    &amp;#8222;
    </td>
  </tr></table></div>
<hr><h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/prop_style_quotes.asp">quotes property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_class_position.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_resize.asp">Next &raquo;</a></div>
