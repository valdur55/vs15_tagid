...
<h1>CSS <span class="color_h1">border-collapse</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-bottom_width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-color.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the collapsing borders model for a table:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_table_border-collapse" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-collapse property sets whether the table borders are collapsed into a single border or detached as in standard HTML.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">separate</td>
    ...
    <td>  <i>object</i>.style.borderCollapse="collapse"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-collapse">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">border-collapse</td>
    <td>1.0</td>
    <td>5.0</td>
    <td>1.0</td>
    <td>1.2</td>
...
border-collapse: separate|collapse|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    <th>Description</th>
    <th>Play it</th>    
  </tr><tr><td>separate</td>
    <td>Borders are detached (border-spacing and empty-cells 
	properties will not be ignored). This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-collapse&amp;preval=separate">Play it &raquo;</a></td>
  </tr><tr><td>collapse</td>
    <td>Borders are collapsed into a single border when 
	possible (border-spacing and empty-cells properties will be ignored)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-collapse&amp;preval=collapse">Play it &raquo;</a></td>		                      		
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-collapse&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_bordercollapse.asp">borderCollapse property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_border-bottom_width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-color.asp">Next &raquo;</a></div>
