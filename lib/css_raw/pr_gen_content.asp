...
<h1>CSS <span class="color_h1">content</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_columns.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_counter-increment.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>The following example inserts the URL in parenthesis after each link:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_gen_content" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The content property is used with the :before and :after pseudo-elements, to insert generated content.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>You can't give an element a pseudo-class by using JavaScript,<br>but there are other ways to get the same result:
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_content">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">content</td>
    <td>1.0</td>
    <td>8.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
<p><b>Note:</b> IE8 only supports the content property if a !DOCTYPE 
is specified.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
content: normal|none|counter|attr|<i>string</i>|open-quote|close-quote|no-open-quote|no-close-quote|<i>url</i>|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:110px;">Value</th>
    <th>Description</th>
    <th>Example</th>
  </tr><tr><td>normal</td>
    <td>Default value. Sets the content, if specified, to normal, which default is "none" (which is nothing)</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_normal">Try it &raquo;</a></td>  </tr><tr><td>none</td>
    <td>Sets the content, if specified, to nothing</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_none">Try it &raquo;</a></td>
  </tr><tr><td>counter</td>
    <td>Sets the content as a counter</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_counter">Try it &raquo;</a></td>
  </tr><tr><td>attr<i>(attribute)</i></td>
    <td>Sets the content as one of the selector's attribute</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_attr">Try it &raquo;</a></td>
  </tr><tr><td><i>string</i></td>
    <td>Sets the content to the text you specify</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_string">Try it &raquo;</a></td>
  </tr><tr><td>open-quote</td>
    <td>Sets the content to be an opening quote</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_quote">Try it &raquo;</a></td>
  </tr><tr><td>close-quote</td>
    <td>Sets the content to be a closing quote</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_quote">Try it &raquo;</a></td>
  </tr><tr><td>no-open-quote</td>
    <td>Removes the opening quote from the content, if specified</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_noquote">Try it &raquo;</a></td>
  </tr><tr><td>no-close-quote</td>
    <td>Removes the closing quote from the content, if specified</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_noquote">Try it &raquo;</a></td>
  </tr><tr><td>url(<i>url</i>)</td>
    <td>Sets the content to be some kind of media (an image, a sound, a video, etc.)</td>
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_url">Try it &raquo;</a></td>
  </tr><tr><td>initial</td>
...
<p>CSS reference: <a href="sel_before.asp">:before pseudo element</a></p>
<p>CSS reference: <a href="sel_after.asp">:after pseudo element</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_columns.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_counter-increment.asp">Next &raquo;</a></div>
