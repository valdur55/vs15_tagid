...
<h1>CSS <span class="color_h1">text-decoration-line</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-decoration-color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-decoration-style.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Display &lt;p&gt; elements with a line on top:</p>
<div class="w3-code notranslate cssHigh">
p
{<br>&nbsp;&nbsp;&nbsp;
-moz-text-decoration-line: overline; /* Code for Firefox */<br>
&nbsp;&nbsp;&nbsp;
text-decoration-line: overline;<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_text-decoration-line" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The text-decoration-line property specifies what type of line, if any, the decoration will have.</p>
<p><strong>Note:</strong> You can also set the text-decoration-line using the text-decoration property,
which is a short-hand property for the text-decoration-line, text-decoration-style, and the text-decoration-color properties.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.textDecorationLine="overline"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_text-decoration-line">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">text-decoration-line</td>
...
text-decoration-line: none|underline|overline|line-through|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=none">Play it &raquo;</a></td>          
    </tr><tr><td>underline</td>
    <td>Specifies that a line will be displayed under the text</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=underline">Play it &raquo;</a></td>          
    </tr><tr><td>overline</td>
    <td>Specifies that a line will be displayed over the text</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=overline">Play it &raquo;</a></td>          
    </tr><tr><td>line-through</td>
    <td>Specifies that a line will be displayed through the text</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=line-through">Play it &raquo;</a></td>          
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_textdecorationline.asp">textDecorationLine property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-decoration-color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-decoration-style.asp">Next &raquo;</a></div>
