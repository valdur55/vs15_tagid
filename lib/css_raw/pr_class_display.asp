...
<h1>CSS <span class="color_h1">display</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_text_direction.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_tab_empty-cells.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Display &lt;p&gt; elements as inline elements:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_display_inline" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The display property specifies the type of box used for an HTML element.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">inline</td>
    ...
    <td>  <i>object</i>.style.display="none"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_display">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">display</td>
    <td>4.0</td>
    <td>8.0<br><span class="deprecated">Partial from 5.5</span></td> 
    <td>3.0</td>
    <td>3.1</td>
    <td>7.0</td>
  </tr></table></div>
<p><b>Note:</b> The values "inline-table", "table", "table-caption", 
"table-cell", "table-column", "table-column-group", "table-row", 
and "table-row-group" are not supported in IE7 and earlier. IE8 
requires a !DOCTYPE. IE9 supports the values.</p>
<p><strong>Note:</strong> The values "flex" and "inline-flex" requires a prefix 
to work in Safari. For "flex" use "display: -webkit-flex", for "inline-flex" use 
"display: -webkit-inline-flex;".</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
display: <i>value</i>;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    <th style="width:68%">Description</th>
    <th style="width:10%">Play it</th>    
  </tr><tr><td>inline</td>
    <td>Default value. Displays an element as an inline element (like &lt;span&gt;)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&amp;preval=inline">Play it &raquo;</a></td>          
    </tr><tr><td>block</td>
    <td>Displays an element as a block element (like &lt;p&gt;)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&amp;preval=block">Play it &raquo;</a></td>    
    </tr><tr><td>flex</td>
    <td>Displays an element as an block-level flex container. New in CSS3</td>
	<td></td>
    </tr><tr><td>inline-block</td>
    <td>Displays an element as an inline-level block container. The inside of 
	this block is formatted as block-level box, and the element itself is 
	formatted as an inline-level box</td>
	<td></td>
    </tr><tr><td>inline-flex</td>
    <td>Displays an element as an inline-level flex container. New in CSS3</td>
	<td></td>
    </tr><tr><td>inline-table</td>
    <td>The element is displayed as an inline-level table</td>
	<td>&nbsp;</td>    	
    </tr><tr><td>list-item</td>
    <td>Let the element behave like a &lt;li&gt; element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&amp;preval=list-item">Play it &raquo;</a></td>    	
    </tr><tr><td>run-in</td>
	...
	<td></td>
    </tr><tr><td>table-header-group</td>
    <td>Let the element behave like a &lt;thead&gt; element</td>
	<td></td>
    </tr><tr><td>table-footer-group</td>
    <td>Let the element behave like a &lt;tfoot&gt; element</td>
	<td></td>
    </tr><tr><td>table-row-group</td>
    <td>Let the element behave like a &lt;tbody&gt; element</td>
	<td></td>
    </tr><tr><td>table-cell</td>
    <td>Let the element behave like a &lt;td&gt; element</td>
	<td></td>
    </tr><tr><td>table-column</td>
    <td>Let the element behave like a &lt;col&gt; element</td>
	<td></td>
    </tr><tr><td>table-row</td>
    <td>Let the element behave like a &lt;tr&gt; element</td>
	<td></td>
    </tr><tr><td>none</td>
    <td>The element will not be displayed at all (has no effect on layout)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&amp;preval=none">Play it &raquo;</a></td>    
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&amp;preval=initial">Play it &raquo;</a></td>    
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>A demonstration of how to use the inherit property value:</p>
<div class="w3-code notranslate cssHigh">
    body {<br>&nbsp;&nbsp;&nbsp; display: inline;<br>}<br><br>p {<br>&nbsp;&nbsp;&nbsp; 
	display: inherit;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_display_inline2">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the direction of some flexible items inside a &lt;div&gt; element in reverse 
order:</p>
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex; /* Safari */<br>&nbsp;&nbsp;&nbsp; 
	-webkit-flex-direction: row-reverse; /* Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp; 
	display: flex;<br>&nbsp;&nbsp;&nbsp; flex-direction: row-reverse;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_flex-direction">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_display_visibility.asp">CSS Display and 
visibility</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_display.asp">display property</a></p>
<hr><div class="nav">
<div class="prev"><a class="chapter" href="pr_text_direction.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_tab_empty-cells.asp">Next &raquo;</a></div>
