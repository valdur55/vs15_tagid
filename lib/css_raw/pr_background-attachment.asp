...
<h1>CSS <span class="color_h1">background-attachment</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_background.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-blend-mode.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>How to specify a fixed background-image:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_background-attachment" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.backgroundAttachment="fixed"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_background-attachment">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:25%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">background-attachment</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
background-attachment: scroll|fixed|local|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    ...
    <td>The background scrolls along with the element. 
	This is default</td>
  </tr><tr><td>fixed</td>
    <td>The background is fixed with regard to the viewport</td>
  </tr><tr><td>local</td>
    <td>The background scrolls along with the element's contents</td>
  </tr><tr><td>initial</td>
...
<h3>Example</h3>
<p>How to create a simple parallax scrolling effect (create an illusion of 3D depth):</p>
<div class="w3-code notranslate cssHigh">
  
    .fixed-bg {<br>&nbsp;&nbsp;&nbsp; /* The background image */<br>&nbsp;&nbsp;&nbsp; 
	background-image: url("img_tree.gif"), url("img_flwr.gif");<br>&nbsp;&nbsp;&nbsp; 
	/* Set a specified height, or the minimum height for the background image */<br>&nbsp;&nbsp;&nbsp; 
	min-height: 500px;<br>&nbsp;&nbsp;&nbsp; /* Set background image to fixed 
	(don't scroll along with the page) */<br>&nbsp;&nbsp;&nbsp; 
	background-attachment: fixed;<br>&nbsp;&nbsp;&nbsp; /* Center the background 
	image */<br>&nbsp;&nbsp;&nbsp; background-position: center;<br>&nbsp;&nbsp;&nbsp; 
	/* Set the background image to no repeat */<br>&nbsp;&nbsp;&nbsp; 
	background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; /* Scale the background 
	image to be as large as possible */<br>&nbsp;&nbsp;&nbsp; background-size: 
	cover;<br>}
    </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_background-attachment_fixed">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_background.asp">CSS Background</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_backgroundattachment.asp">backgroundAttachment 
property</a></p>
