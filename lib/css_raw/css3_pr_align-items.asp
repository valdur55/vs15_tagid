...
<h1>CSS <span class="color_h1">align-items</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_align-content.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_align-self.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
	...
	-webkit-align-items: center; /* Safari 7.0+ */<br>
	&nbsp;&nbsp;&nbsp;
...
<p>The align-items property specifies the default alignment for items inside the flexible container.</p>

<p><b>Tip:</b> Use the align-self property of each item to override the align-items property.</p>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">align-items</td>
    <td>21.0</td>
    <td>11.0</td>
    <td>20.0</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_alignitems.asp">alignItems property</a></p>
