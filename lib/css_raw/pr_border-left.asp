...
<h1>CSS <span class="color_h1">border-left</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-image-width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-left_color.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh"> 
	...
	&nbsp;&nbsp;&nbsp;
	border-left: thick double #ff0000;<br>
	}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-left shorthand property sets all the left border properties in 
one declaration.</p>
<p>The properties that can be set, are (in order): border-left-width, border-left-style, and border-left-color.</p>
<p>It does not matter if one of the values above are missing, e.g.
	border-left:solid #ff0000; is allowed.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-left">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.borderLeft="3px dotted blue"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-left">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">border-left</td>
    <td>1.0</td>
    <td>4.0&nbsp;</td>
    <td>1.0</td>
    <td>3.5</td>
...
border-left: <i>border-width</i> <i>border-style</i> <i>border-color</i>|initial|inherit;</div></div>
<h2>Property Values</h2>

<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:25%">Value</th>
    <th>Description</th>
  </tr><tr><td><i><a href="pr_border-left_width.asp">border-left-width</a></i></td>
    <td>Specifies the width of the left border. Default value is "medium"</td>
  </tr><tr><td><i><a href="pr_border-left_style.asp">border-left-style</a></i></td>
    <td>Specifies the style of the left border. Default value is "none"</td>
  </tr><tr><td><i><a href="pr_border-left_color.asp">border-left-color</a></i></td>
    <td>Specifies the color of the left border. Default value is the color of the element</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_borderleft.asp">borderLeft property</a></p>
