...
<h1>CSS3 <span class="color_h1">text-overflow</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-justify.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-shadow.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-overflow">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The text-overflow property specifies how overflowed content that is not 
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.textOverflow="ellipsis"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_text-overflow">Try it</a>
</td>
  </tr></table></div>
<hr><h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the property.</p>
<p>Numbers followed by -o- specify the first version that worked with a prefix.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">text-overflow</td>
    <td>4.0</td>
    <td>6.0</td>
    <td>7.0</td>
    <td>3.1</td>
...
text-overflow: clip|ellipsis|<i>string</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. Clips the text</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-overflow">Play it &raquo;</a></td>
  </tr><tr><td>ellipsis</td>
    <td>Render an ellipsis ("...") to represent clipped text</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-overflow&amp;preval=ellipsis">Play it &raquo;</a></td>    
  </tr><tr><td><i>string</i></td>
    <td>Render the given string to represent clipped text</td>
    <td></td>
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-overflow&amp;preval=initial">Play it &raquo;</a></td>    
    </tr><tr><td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_text-overflow_hover">
Text-overflow with a hover effect</a><br>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_textoverflow.asp">textOverflow property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_text-justify.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-shadow.asp">Next &raquo;</a></div>
