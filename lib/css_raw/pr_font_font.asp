...
<h1>CSS <span class="color_h1">font</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_class_float.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_font-face_rule.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify all the font properties in one declaration:</p>
<div class="w3-code notranslate cssHigh">
	...
	{<br>
	&nbsp;&nbsp;&nbsp;
	font: italic bold 12px/30px Georgia, serif;<br>
	}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_font" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The font shorthand property sets all the font properties in one declaration.</p>
<p>The properties that can be set, are (in order): "font-style font-variant font-weight font-size/line-height 
font-family"</p>
<p>The font-size and font-family values are required. If one of the other values 
are missing, the default values will be inserted, if any.</p>
<p><b>Note:</b> The line-height property sets the space between lines.</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%"><i>The default value of all the font properties</i></td>
  </tr><tr><th>Inherited:</th>
    <td>yes</td>
  </tr><tr><th>Animatable:</th>
    <td>yes, <i>see individual properties</i>. <a href="css_animatable.asp">Read about <em>animatable</em></a>
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_font">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.font="italic small-caps bold 12px arial,sans-serif"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_font">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">font</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
font: <i>font-style</i> <i>font-variant</i> <i>font-weight</i> <i>font-size/line-height 
	font-family</i>|caption|icon|menu|message-box|small-caption|status-bar|initial|inherit;</div></div>

<h2>Property Values</h2>

<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:25%">Property/Value</th>
    <th>Description</th>
  </tr><tr><td><i>font-style</i></td>
    <td>Specifies the font style. Default value is "normal". See
	<a href="pr_font_font-style.asp">font-style</a> for possible 
	values</td>
  </tr><tr><td><i>font-variant</i></td>
    <td>Specifies the font variant. Default value is "normal". See
	<a href="pr_font_font-variant.asp">font-variant</a> for possible 
	values</td>
  </tr><tr><td><i>font-weight</i></td>
    <td>Specifies the font weight. Default value is "normal". See
	<a href="pr_font_weight.asp">font-weight</a> for possible 
	values</td>
  </tr><tr><td><i>font-size/line-height</i></td>
    <td>Specifies the font size and the line-height. Default value is "normal". See
	<a href="pr_font_font-size.asp">font-size</a> and
	<a href="pr_dim_line-height.asp">line-height</a> for possible 
	values</td>
  </tr><tr><td><i>font-family</i></td>
    <td>Specifies the font family. Default value depends on the browser. See
	<a href="pr_font_font-family.asp">font-family</a> for possible 
	values</td>
  </tr><tr><td>caption</td>
    <td>Uses the font that are used by captioned controls (like
      buttons, drop-downs, etc.)</td>
  </tr><tr><td>icon</td>
    <td>Uses the font that are used by icon labels</td>
  </tr><tr><td>menu</td>
    <td>Uses the fonts that are used by dropdown menus</td>
  </tr><tr><td>message-box</td>
    <td>Uses the fonts that are used by dialog boxes</td>
  </tr><tr><td>small-caption</td>
    <td>A smaller version of the caption font</td>
  </tr><tr><td>status-bar</td>
    <td>Uses the fonts that are used by the status bar</td>
  </tr><tr><td>initial</td>
...
<h3>Example</h3>
<p>A demonstration of some of the other font property values.</p>
<div class="w3-code notranslate htmlHigh">
    &lt;p style="font:caption"&gt;The browser font used in captioned controls.&lt;/p&gt;<br>
	&lt;p style="font:icon"&gt;The browser font used in icon labels.&lt;/p&gt;<br>&lt;p 
	style="font:menu"&gt;The browser font used in dropdown menus.&lt;/p&gt;<br>&lt;p 
	style="font:message-box"&gt;The browser font used in dialog boxes.&lt;/p&gt;<br>&lt;p 
	style="font:small-caption"&gt;A smaller version of the caption font.&lt;/p&gt;<br>&lt;p 
	style="font:status-bar"&gt;The browser font used in the status bar.&lt;/p&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_font_caption">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_font.asp">CSS Font</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_font.asp">font property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_class_float.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_font-face_rule.asp">Next &raquo;</a></div>
