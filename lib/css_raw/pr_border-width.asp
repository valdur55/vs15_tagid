...
<h1>CSS <span class="color_h1">border-width</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-top_width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_bottom.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the width of the four borders:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-width" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-width property sets the width of an element's four borders. This property can 
have from one to four values.</p>
<p>Examples:</p>
<ul><li><b>border-width:thin medium thick 10px; </b>
	<ul><li>top border is thin</li>
	<li>right border is medium</li>
	<li>bottom border is thick</li>
	<li>left border is 10px</li></ul><br></li>
	<li><b>border-width:thin medium thick;</b>
	<ul><li>top border is thin</li>
	<li>right and left borders are medium</li>
	<li>bottom border is thick</li></ul><br></li>
	<li><b>border-width:thin medium;</b>
	<ul><li>top and bottom borders are thin</li>
	<li>right and left borders are medium</li></ul><br></li>
	<li><b>border-width:thin;</b><ul><li>all four borders are thin</li></ul></li>
</ul><p><b>Note:</b> Always declare the border-style property before the border-width
property. An element must have borders before you can set the width.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-width">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.borderWidth="1px 5px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-width">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">border-width</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
border-width: medium|thin|thick|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Specifies a medium border. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-width&amp;preval=medium">Play it &raquo;</a></td>		      
  </tr><tr><td>thin</td>
    <td>Specifies a thin border</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-width&amp;preval=thin">Play it &raquo;</a></td>		      
  </tr><tr><td>thick</td>
    <td>Specifies a thick border</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-width&amp;preval=thick">Play it &raquo;</a></td>		          
  </tr><tr><td><i>length</i></td>
    <td>Allows you to define the thickness of the border</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-width&amp;preval=10px">Play it &raquo;</a></td>		      
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-width&amp;preval=initial">Play it &raquo;</a></td>		      
    </tr><tr><td>inherit</td>
...
<a href="/jsref/prop_style_borderwidth.asp">borderWidth property</a></p>
