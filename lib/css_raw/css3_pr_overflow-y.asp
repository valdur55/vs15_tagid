...
<h1>CSS3 <span class="color_h1">overflow-y</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_overflow-x.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_padding.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Clip the top/bottom edges of the content inside the &lt;div&gt; element - if it overflows the element's 
	content area:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_overflow-xy">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The overflow-y property specifies what to do with the top/bottom edges of the content - if it overflows the element's 
	content area.</p>
<p><b>Tip:</b> Use the <a href="css3_pr_overflow-x.asp">overflow-x</a> property 
to determine clipping at the left and right edges.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.overflowY="scroll"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_overflow-y">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">overflow-y</td>
    <td>4.0</td>
    <td>9.0</td>
    <td>3.5</td>
    <td>3.0</td>
...
overflow-y: visible|hidden|scroll|auto|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. The content is not clipped, and it may be rendered outside the content 
	box</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_overflow-y">Play it &raquo;</a></td>   		        	
  </tr><tr><td>hidden</td>
    <td>The content is clipped - and no scrolling mechanism is provided</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_overflow-y&amp;preval=hidden">Play it &raquo;</a></td>   		        
  </tr><tr><td>scroll</td>
    <td>The content is clipped and a scrolling mechanism is provided</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_overflow-y&amp;preval=scroll">Play it &raquo;</a></td>   		            
  </tr><tr><td>auto</td>
    <td>Should cause a scrolling mechanism to be provided for overflowing boxes</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_overflow-y&amp;preval=auto">Play it &raquo;</a></td>   		            
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_overflow-y&amp;preval=initial">Play it &raquo;</a></td>   		            
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_overflowy.asp">overflowY property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_overflow-x.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_padding.asp">Next &raquo;</a></div>
