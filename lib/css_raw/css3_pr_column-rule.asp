...
<h1>CSS3 <span class="color_h1">column-rule</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-gap.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-rule-color.asp">Next &raquo;</a></div>
</div>
...
<p>The column-rule property is a shorthand property for setting all the column-rule-* properties.</p>
<p>The column-rule property sets the width, style, and color of the rule between columns.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">medium none <em>color</em></td>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_column-rule">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.columnRule="3px outset blue"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_column-rule">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">column-rule</td>
    <td>4.0 -webkit-</td>
    <td>10.0</td>
    <td>2.0 -moz-</td>
    <td>3.1 -webkit-</td>
...
column-rule: <i>column-rule-width column-rule-style column-rule-color</i>|initial|inherit;</div></div>
<h2>Property Values</h2>

<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th>Value</th>
    <th>Description</th>
  </tr><tr><td> <i><a href="css3_pr_column-rule-width.asp">column-rule-width</a></i></td>
    <td>Sets the width of the rule between columns. Default value is medium</td>
  </tr><tr><td> <i><a href="css3_pr_column-rule-style.asp">column-rule-style</a></i></td>
    <td>Sets the style of the rule between columns. Default value is none</td>
  </tr><tr><td> <i><a href="css3_pr_column-rule-color.asp">column-rule-color</a></i></td>
    <td>Sets the color of the rule between columns. Default value is the color of the element</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_columnrule.asp">columnRule property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-gap.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-rule-color.asp">Next &raquo;</a></div>
