...
<h1>CSS <span class="color_h1">list-style</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_dim_line-height.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_list-style-image.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_list-style" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The list-style shorthand property sets all the list properties in one declaration.</p>
<p>The properties that can be set, are (in order): list-style-type, 
list-style-position, list-style-image.</p>
<p>If one of the values above are missing, e.g. "list-style:circle inside;", the 
default value for the missing property will be inserted, if any.</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">disc outside none</td>
    ...
    <td>  <i>object</i>.style.listStyle="decimal inside"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_list-style">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">list-style</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
<div class="w3-code w3-border notranslate"><div>
	list-style: <i>list-style-type</i> <i>list-style-position</i> <i>list-style-image</i>|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    <th>Description</th>
  </tr><tr><td><i>list-style-type</i></td>
    <td>Specifies the type of list-item marker. See
	<a href="pr_list-style-type.asp">list-style-type</a> for possible 
	values</td>
  </tr><tr><td><i>list-style-position</i></td>
    <td>Specifies where to place the list-item marker. See
	<a href="pr_list-style-position.asp">list-style-position</a> for possible 
	values</td>
  </tr><tr><td><i>list-style-image</i></td>
    <td>Specifies the type of list-item marker. See
	<a href="pr_list-style-image.asp">list-style-image</a> for possible values</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_liststyle.asp">listStyle property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_dim_line-height.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_list-style-image.asp">Next &raquo;</a></div>
