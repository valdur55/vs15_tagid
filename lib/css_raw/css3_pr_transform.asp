...
<h1>CSS3 <span class="color_h1">transform</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_pos_top.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transform-origin.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Rotate a &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  
    div
	{<br>&nbsp;&nbsp;&nbsp;
	-ms-transform: rotate(7deg); /* IE 9 */<br>&nbsp;&nbsp;&nbsp; 
	-webkit-transform: rotate(7deg); /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
	transform: rotate(7deg);<br>
	}
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transform">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The transform property applies a 2D or 3D transformation to an element. This property allows you to rotate, 
scale, move, skew, etc., elements.</p>
<p>To better understand the transform property,
<a target="_blank" href="trycss3_transform_inuse.htm">view a demo</a>.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_transform">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.transform="rotate(7deg)"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_transform">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">transform (2D)</td>
  ...
  </tr><tr><td style="text-align:left;">transform (3D)</td>
...
transform: none|<i>transform-functions</i>|initial|inherit;</div></div>

<h2>Property Values</h2>

<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:33%">Value</th>
    <th style="width:55%">Description</th>
    <th>Play it</th>                
  </tr><tr><td>none</td>
    <td>Defines that there should be no transformation</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_rotate&amp;preval=none">Play it &raquo;</a></td>   			
  </tr><tr><td>matrix(<i>n,n,n,n,n,n</i>)</td>
    <td>Defines a 2D transformation, using a matrix of six values</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_matrix">Play it &raquo;</a></td>
  </tr><tr><td>matrix3d<br>
	(<i>n,n,n,n,n,n,n,n,n,n,n,n,n,n,n,n</i>)</td>
    <td>Defines a 3D transformation, using a 4x4 matrix of 16 values</td>
	<td></td>  
  </tr><tr><td>translate(<i>x,y</i>)</td>
    <td>Defines a 2D translation</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_translate">Play it &raquo;</a></td>   			
  </tr><tr><td>translate3d(<i>x,y,z</i>)</td>
    <td>Defines a 3D translation</td>
	<td></td>
  </tr><tr><td>translateX(<i>x</i>)</td>
    <td>Defines a translation, using only the value for the X-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_translatex">Play it &raquo;</a></td>   			
  </tr><tr><td>translateY(<i>y</i>)</td>
    <td>Defines a translation, using only the value for the Y-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_translatey">Play it &raquo;</a></td>   			
  </tr><tr><td>translateZ(<i>z</i>)</td>
    <td>Defines a 3D translation, using only the value for the Z-axis</td>
	<td></td>  
  </tr><tr><td>scale(<i>x,y</i>)</td>
    <td>Defines a 2D scale transformation</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_scale">Play it &raquo;</a></td>   			
  </tr><tr><td>scale3d(<i>x,y,z</i>)</td>
    <td>Defines a 3D scale transformation</td>
	<td></td>  
  </tr><tr><td>scaleX(<i>x</i>)</td>
    <td>Defines a scale transformation by giving a value for the X-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_scalex">Play it &raquo;</a></td>   			
  </tr><tr><td>scaleY(<i>y</i>)</td>
    <td>Defines a scale transformation by giving a value for the Y-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_scaley">Play it &raquo;</a></td>   			
  </tr><tr><td>scaleZ(<i>z</i>)</td>
    <td>Defines a 3D scale transformation by giving a value for the Z-axis</td>
	<td></td>  
  </tr><tr><td>rotate(<i>angle</i>)</td>
    <td>Defines a 2D rotation, the angle is specified in the 
		parameter</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_rotate">Play it &raquo;</a></td>   			
  </tr><tr><td>rotate3d(<i>x,y,z,angle</i>)</td>
    <td>Defines a 3D rotation</td>
    <td></td>
  </tr><tr><td>rotateX(<i>angle</i>)</td>
    <td>Defines a 3D rotation along the X-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_rotatex">Play it &raquo;</a></td>
  </tr><tr><td>rotateY(<i>angle</i>)</td>
    <td>Defines a 3D rotation along the Y-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_rotatey">Play it &raquo;</a></td>
  </tr><tr><td>rotateZ(<i>angle</i>)</td>
    <td>Defines a 3D rotation along the Z-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_rotatez">Play it &raquo;</a></td>
  </tr><tr><td>skew(<i>x-angle,y-angle</i>)</td>
    <td>Defines a 2D skew transformation along the X- and the Y-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_skew">Play it &raquo;</a></td>   			
  </tr><tr><td>skewX(<i>angle</i>)</td>
    <td>Defines a 2D skew transformation along the X-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_skewx">Play it &raquo;</a></td>   			
  </tr><tr><td>skewY(<i>angle</i>)</td>
    <td>Defines a 2D skew transformation along the Y-axis</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_transform_skewy">Play it &raquo;</a></td>   			
  </tr><tr><td>perspective(<i>n</i>)</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_image_gallery">Images 
thrown on the table</a><br>
This example demonstrates how to create "polaroid" pictures and rotate the 
pictures.</p>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_2dtransforms.asp">CSS 2D Transforms</a></p>
<p>CSS tutorial: <a href="/css/css3_3dtransforms.asp">CSS 3D Transforms</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_transform.asp">transform property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_pos_top.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transform-origin.asp">Next &raquo;</a></div>
