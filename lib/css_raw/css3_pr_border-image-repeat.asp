<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 border-image-repeat property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">border-image-repeat</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-image-outset.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-image-slice.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-image-repeat">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.borderImageRepeat="round"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_border-image-repeat">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">border-image-repeat</td>
    <td>15.0</td>
    <td>11.0</td>
    <td>15.0</td>
    <td>6.0</td>
...
border-image-repeat: stretch|repeat|round|initial|inherit;</div></div>
<p><b>Note:</b> This property specifies how the images for the sides and the 
middle part of the border image are scaled and tiled. So, you can specify two 
values here. If the second value is omitted, it is assumed to be the same as the 
first.</p>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>Default value. The image is stretched to fill the area</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-repeat&amp;preval=stretch">Play it &raquo;</a></td>              

  </tr><tr><td> repeat</td>
    <td>The image is tiled (repeated) to fill the area</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-repeat&amp;preval=repeat">Play it &raquo;</a></td>              

  </tr><tr><td> round</td>
    <td>The image is tiled (repeated) to fill the area. If it does not fill the 
	area with a whole number of tiles, the image is rescaled so it fits</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-repeat&amp;preval=round">Play it &raquo;</a></td>              

  </tr><tr><td>space</td>
    <td>The image is tiled (repeated) to fill the area. If it does not fill the 
	area with a whole number of tiles, the extra space is distributed around the tiles</td>
	<td></td>              

  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-repeat&amp;preval=initial">Play it &raquo;</a></td>              
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_borderimagerepeat.asp">borderImageRepeat property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-image-outset.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-image-slice.asp">Next &raquo;</a></div>
