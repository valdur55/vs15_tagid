...
<h1>CSS <span class="color_h1">flex</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_filter.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-basis.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Let all the flexible items be the same length, regardles of its content:</p>
<div class="w3-code notranslate cssHigh">
    #main div {<br>&nbsp;&nbsp;&nbsp; -webkit-flex: 1; /* Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp; 
	-ms-flex: 1; /* IE 10 */ <br>&nbsp;&nbsp;&nbsp; flex: 1;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_flex" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The flex property specifies the length of the item, relative to the rest of the
flexible items inside the same container.</p>

<p>The flex property is a shorthand for the flex-grow, flex-shrink, and the flex-basis properties.</p>
<p><b>Note:</b> If the element is not a flexible item, the flex property has no effect.</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">0 1 auto</td>
    ...
    <td>  <i>object</i>.style.flex="1"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_flex">Try it</a>
    </td>
  </tr></table></div>
<hr><h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the property.</p>
<p>Numbers followed by -webkit-, -ms- or -moz- specify the first version that worked with a prefix.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">flex</td>
    <td>29.0<br>21.0 -webkit-</td>
    <td>11.0<br>10.0 -ms-</td>
...
flex: <i>flex-grow</i> <i>flex-shrink</i> <i>flex-basis</i>|auto|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    <th style="width:78%">Description</th>
  </tr><tr><td><em><a href="css3_pr_flex-grow.asp">flex-grow</a></em></td>
    <td>A number specifying how much the item will grow relative to the rest of the flexible items</td>
    </tr><tr><td><em><a href="css3_pr_flex-shrink.asp">flex-shrink</a></em></td>
    <td>A number specifying how much the item will shrink relative to the rest of the flexible items</td>
    </tr><tr><td><em><a href="css3_pr_flex-basis.asp">flex-basis</a></em></td>
    <td>The length of the item. Legal values: "auto", "inherit", or a number followed by "%", "px", "em" or any other length unit</td>
    </tr><tr><td>auto</td>
    <td>Same as 1 1 auto.</td>
    </tr><tr><td>initial</td>
    <td>Same as 0 1 auto. <a href="css_initial.asp">Read about <em>initial</em></a></td>
    </tr><tr><td>none</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_flex.asp">flex property</a></p>
