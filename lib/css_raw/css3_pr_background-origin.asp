<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 background-origin property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">background-origin</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_background-image.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-position.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
	...
	background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; padding:35px;<br>&nbsp;&nbsp;&nbsp; 
	background-origin: content-box;<br>}
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background-origin">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The background-origin property specifies where the background image is 
positioned.</p>
<p><b>Note:</b> If the background-attachment property is set to "fixed", this property has no effect.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">padding-box</td>
    ...
    <td>  <i>object</i>.style.backgroundOrigin="content-box"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_background-origin">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">background-origin</td>
    <td>4.0</td>
    <td>9.0</td>
    <td>4.0</td>
    <td>3.0&nbsp;</td>
...
background-origin: padding-box|border-box|content-box|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <th>Play it</th>                
  </tr><tr><td>padding-box</td>
    <td>Default value. The background image starts from the upper left corner of 
	the padding edge</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-origin">Play it &raquo;</a></td>
  </tr><tr><td>border-box</td>
    <td>The background image starts from the upper left corner of the border</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-origin&amp;preval=border-box">Play it &raquo;</a></td>
  </tr><tr><td>content-box</td>
    <td>The background image starts from the upper left corner of the content</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-origin&amp;preval=content-box">Play it &raquo;</a></td>
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-origin&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_backgroundorigin.asp">backgroundOrigin property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_background-image.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_background-position.asp">Next &raquo;</a></div>
