...
<h1>CSS <span class="color_h1">cursor</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_gen_counter-reset.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_direction.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Some different cursors:</p>
<div class="w3-code notranslate cssHigh">

    span.crosshair
	{<br>&nbsp;&nbsp;&nbsp; cursor: crosshair;<br>}<br><br>
	span.help
	{<br>&nbsp;&nbsp;&nbsp; cursor: help;<br>}<br><br>
	span.wait
	{<br>&nbsp;&nbsp;&nbsp; cursor: wait;<br>}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_cursor" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The cursor property specifies the type of cursor to be displayed when pointing on an element.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>no. <a href="css_animatable.asp">Read about <em>animatable</em></a>
	</td>
  </tr><tr><th>Version:</th>
    <td>CSS2</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.cursor="crosshair"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_cursor">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">cursor</td>
    <td>5.0</td>
    <td>5.5</td>
    <td>4.0</td>
    <td>5.0</td>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>The cursor indicates an alias of something is to be created</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=alias">Play it &raquo;</a></td>		                      
  </tr><tr><td>all-scroll</td>
    <td>The cursor indicates that something can be scrolled in any direction</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=all-scroll">Play it &raquo;</a></td>		                      
  </tr><tr><td>auto</td>
    <td>Default. The browser sets a cursor</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor">Play it &raquo;</a></td>		                  
  </tr><tr><td>cell</td>
    <td>The cursor indicates that a cell (or set of cells) may be selected</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=cell">Play it &raquo;</a></td>		                      
  </tr><tr><td>context-menu</td>
    <td>The cursor indicates that a context-menu is available</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=context-menu">Play it &raquo;</a></td>		                      
  </tr><tr><td>col-resize</td>
    <td>The cursor indicates that the column can be resized horizontally</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=col-resize">Play it &raquo;</a></td>		                      
  </tr><tr><td>copy</td>
    <td>The cursor indicates something is to be copied</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=copy">Play it &raquo;</a></td>		                      
  </tr><tr><td>crosshair</td>
    <td>The cursor render as a crosshair</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=crosshair">Play it &raquo;</a></td>		                      
  </tr><tr><td>default</td>
    <td>The default cursor</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=default">Play it &raquo;</a></td>
  </tr><tr><td>e-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved right (east)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=e-resize">Play it &raquo;</a></td>
  </tr><tr><td>ew-resize</td>
    <td>Indicates a bidirectional resize cursor</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=ew-resize">Play it &raquo;</a></td>
  </tr><tr><td>grab</td>
    <td>The cursor indicates that something can be grabbed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=grab">Play it &raquo;</a></td>
  </tr><tr><td>grabbing</td>
    <td>The cursor indicates that something can be grabbed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=grabbing">Play it &raquo;</a></td>
  </tr><tr><td>help</td>
    <td>The cursor indicates that help is available</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=help">Play it &raquo;</a></td>
  </tr><tr><td>move</td>
    <td>The cursor indicates something is to be moved</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=move">Play it &raquo;</a></td>
  </tr><tr><td>n-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved up (north)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=n-resize">Play it &raquo;</a></td>
  </tr><tr><td>ne-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved up and right (north/east)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=ne-resize">Play it &raquo;</a></td>
  </tr><tr><td>nesw-resize</td>
    <td>Indicates a bidirectional resize cursor</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=nesw-resize">Play it &raquo;</a></td>
  </tr><tr><td>ns-resize</td>
    <td>Indicates a bidirectional resize cursor</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=ns-resize">Play it &raquo;</a></td>
  </tr><tr><td>nw-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved up and left (north/west)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=nw-resize">Play it &raquo;</a></td>
	</tr><tr><td>nwse-resize</td>
    <td>Indicates a bidirectional resize cursor</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=nwse-resize">Play it &raquo;</a></td>
  </tr><tr><td>no-drop</td>
    <td>The cursor indicates that the dragged item cannot be dropped here</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=no-drop">Play it &raquo;</a></td>
  </tr><tr><td>none</td>
    <td>No cursor is rendered for the element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=none">Play it &raquo;</a></td>
  </tr><tr><td>not-allowed</td>
    <td>The cursor indicates that the requested action will not be executed</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=not-allowed">Play it &raquo;</a></td>
  </tr><tr><td>pointer</td>
    <td>The cursor is a pointer and indicates a link</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=pointer">Play it &raquo;</a></td>
  </tr><tr><td>progress</td>
    <td>The cursor indicates that the program is busy (in progress)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=progress">Play it &raquo;</a></td>
  </tr><tr><td>row-resize</td>
    <td>The cursor indicates that the row can be resized vertically</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=row-resize">Play it &raquo;</a></td>
  </tr><tr><td>s-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved down (south)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=s-resize">Play it &raquo;</a></td>
  </tr><tr><td>se-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved down and right (south/east)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=se-resize">Play it &raquo;</a></td>
  </tr><tr><td>sw-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved down and left (south/west)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=sw-resize">Play it &raquo;</a></td>
  </tr><tr><td>text</td>
    <td>The cursor indicates text that may be selected</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=text">Play it &raquo;</a></td>
  </tr><tr><td><i>URL</i></td>
    <td>A comma separated list of URLs to custom cursors.<b> Note:</b> Always specify a generic cursor at the end of the list, in case none of the URL-defined cursors can be used</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=url(smiley.gif),url(myBall.cur),auto">Play it &raquo;</a></td>
  </tr><tr><td>vertical-text</td>
    <td>The cursor indicates vertical-text that may be selected</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=vertical-text">Play it &raquo;</a></td>
  </tr><tr><td>w-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved left (west)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=w-resize">Play it &raquo;</a></td>
  </tr><tr><td>wait</td>
    <td>The cursor indicates that the program is busy</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=wait">Play it &raquo;</a></td>
  </tr><tr><td>zoom-in</td>
    <td>The cursor indicates that something can be zoomed in</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=zoom-in">Play it &raquo;</a></td>
  </tr><tr><td>zoom-out</td>
    <td>The cursor indicates that something can be zoomed out</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=zoom-out">Play it &raquo;</a></td>
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_cursor.asp">cursor property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_gen_counter-reset.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_direction.asp">Next &raquo;</a></div>
