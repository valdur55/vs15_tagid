...
<h1>CSS <span class="color_h1">tab-size</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_pos_right.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_tab_table-layout.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the tab-size of a &lt;pre&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  
pre {-moz-tab-size: 16;} /* Code for Firefox */<br>pre {-o-tab-size: 16;} /* Code for Opera 
	10.6-12.1 */<br>pre {tab-size: 16;}<br></div>
<a target="_blank" href="tryit.asp?filename=trycss3_tab-size" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The tab-size property specifies the length of the space used for the tab character.</p>
<p>In HTML, the tab character is usually displayed as a single space-character, except for some elements,
like &lt;textarea&gt; and &lt;pre&gt;, and the result of the tab-size property will only be visible for these elements.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.tabSize="16"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_tab-size">Try it</a>
    </td>
  </tr></table></div>
<hr><h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the property.</p>
<p>Numbers followed by -moz- or -o- specify the first version that worked with a prefix.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">tab-size&nbsp;</td>
    <td>21.0</td>
    <td><span class="deprecated">Not supported</span></td>
    <td>4.0 -moz-</td>
    <td>6.1</td>
    <td>15.0<br>10.6 -o-</td>
  </tr></table></div>
<p><strong>Note:</strong> No browser is currently supporting the value as a length unit.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
tab-size: <i>number</i>|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>Default value 8. Specifies the number of space-characters that should be displayed for each tab-character</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_tab-size&amp;preval=8">Play it &raquo;</a></td>          
    </tr><tr><td><em>length</em></td>
    <td>Specifies the length of a tab-character. This property value is not supported in any of the major browsers</td>
	<td></td>
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_tab-size&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
