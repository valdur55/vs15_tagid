...
<h1>CSS <span class="color_h1">flex-shrink</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-grow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-wrap.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Let the second flex-item shrink three times more than the rest:</p>
<div class="w3-code notranslate cssHigh">
	/* Safari 6.1+ */<br>div:nth-of-type(2) {<br>&nbsp;&nbsp;&nbsp; -webkit-flex-shrink: 3;
	<br>} <br><br>/* Standard syntax */<br>div:nth-of-type(2) {<br>&nbsp;&nbsp;&nbsp; flex-shrink: 3;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_flex-shrink" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The flex-shrink property specifies how the item will shrink relative to the rest 
of the flexible items inside the same container.</p>

<p><b>Note:</b> If the element is not a flexible item, the flex-shrink property has no effect.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_flex-shrink">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.flexShrink="5"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_flex-shrink">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">flex-shrink</td>
...
flex-shrink: <i>number</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:11%">Value</th>
    ...
    <td>A number specifying how much the item will shrink relative to the rest of the flexible items. Default value is 1</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-shrink&amp;preval=1">Play it &raquo;</a></td>              
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-shrink&amp;preval=initial">Play it &raquo;</a></td>              
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_flexshrink.asp">flexShrink property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-grow.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_flex-wrap.asp">Next &raquo;</a></div>
