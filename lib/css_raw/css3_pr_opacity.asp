...
<h1>CSS3 <span class="color_h1">opacity</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_nav-up.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_order.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_opacity">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The opacity property sets the opacity level for an element.</p>
<p>The opacity-level describes the transparency-level, where 1 is not transparent at all, 0.5 is 50% see-through, and 0 is completely transparent.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_opacity">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.opacity="0.5"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_opacity">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">opacity</td>
    <td>4.0</td>
    <td>9.0</td>
    <td>2.0</td>
    <td>3.1</td>
...
<p><strong>Note:</strong> IE8 and earlier versions supports an alternative, the filter property. Like: filter:Alpha(opacity=50).</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
opacity: <i>number</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Specifies the opacity. From 0.0 (fully transparent) to 1.0 
	(fully opaque) </td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_opacity">Play it &raquo;</a></td>   	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_opacity&amp;preval=initial">Play it &raquo;</a></td>   	
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>How to use JavaScript to change the opacity for an element:</p>
<div class="w3-code notranslate jsHigh">
    function myFunction(x) {<br>// Return the text of the selected option<br>&nbsp;&nbsp;&nbsp; 
	var opacity = x.options[x.selectedIndex].text;<br>&nbsp;&nbsp;&nbsp; var el 
	= document.getElementById("p1");<br>&nbsp;&nbsp;&nbsp; if (el.style.opacity 
	!== undefined) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	el.style.opacity = opacity;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	alert("Your browser doesn't support this example!");<br>&nbsp;&nbsp;&nbsp; }<br>
	}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_opacity_js">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_image_transparency.asp">CSS Image Opacity / Transparency</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_opacity.asp">opacity property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_nav-up.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_order.asp">Next &raquo;</a></div>
