...
<h1>CSS <span class="color_h1">align-content</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_browsersupport.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_align-items.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">  
    div
	{<br>&nbsp;&nbsp;&nbsp; width: 70px;<br>&nbsp;&nbsp;&nbsp; height: 300px;<br>&nbsp;&nbsp;&nbsp; 
	border: 1px solid #c3c3c3;<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex;<br>&nbsp;&nbsp;&nbsp; 
	display: flex;<br>&nbsp;&nbsp;&nbsp; -webkit-flex-wrap: wrap;<br>&nbsp;&nbsp;&nbsp; 
	flex-wrap: wrap;<br>&nbsp;&nbsp;&nbsp; -webkit-align-content: center;<br>&nbsp;&nbsp;&nbsp; 
	align-content: center;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_align-content" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The align-content property modifies the behavior of the flex-wrap property. It is similar to align-items, but 
instead of aligning flex items, it aligns flex lines.</p>
<p><strong>Tip:</strong> Use the <a href="css3_pr_justify-content.asp">justify-content</a> property to align the items on the main-axis (horizontally).</p>
<p><strong>Note:</strong> There must be multiple lines of items for this property to have any effect.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_align-content">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">align-content</td>
    <td>21.0</td>
    <td>11.0</td>
    <td>28.0</td>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>Default value. Lines stretch to take up the remaining space</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-content&amp;preval=stretch">Play it &raquo;</a></td>          
    </tr><tr><td>center</td>
    <td>Lines are packed toward the center of the flex container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-content&amp;preval=center">Play it &raquo;</a></td>          
    </tr><tr><td>flex-start</td>
    <td>Lines are packed toward the start of the flex container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-content&amp;preval=flex-start">Play it &raquo;</a></td>          
    </tr><tr><td>flex-end</td>
    <td>Lines are packed toward the end of the flex container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-content&amp;preval=flex-end">Play it &raquo;</a></td>          
    </tr><tr><td>space-between</td>
    <td>Lines are evenly distributed in the flex container</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-content&amp;preval=space-between">Play it &raquo;</a></td>          
    </tr><tr><td>space-around</td>
    <td>Lines are evenly distributed in the flex container, with half-size 
	spaces on either end</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-content&amp;preval=space-around">Play it &raquo;</a></td>          
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-content&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
...
<p>CSS Reference: <a href="css3_pr_align-items.asp">align-items property</a></p>
<p>CSS Reference: <a href="css3_pr_align-self.asp">align-self property</a></p>
<p>CSS Reference: <a href="css3_pr_justify-content.asp">justify-content property</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_aligncontent.asp">alignContent property</a></p>
