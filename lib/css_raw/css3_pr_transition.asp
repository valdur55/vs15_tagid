...
<h1>CSS3 <span class="color_h1">transition </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transform-style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transition-delay.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Hover over a &lt;div&gt; element to gradually change the width from 100px to 
300px:</p>
<div class="w3-code notranslate cssHigh">
	...
	&nbsp;&nbsp;&nbsp;
	width: 100px;<br>&nbsp;&nbsp;&nbsp;
    -webkit-transition: width 2s; /* Safari 3.1 to 6.0 */<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The transition property is a shorthand property for the four transition properties:</p>
<p>transition-property,
transition-duration,
transition-timing-function, and
transition-delay.</p>
<p><b>Note:</b> Always specify the transition-duration property, otherwise the duration 
is 0s, and the transition will have no effect.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">all 0s ease 0s</td>
    ...
    <td>  <i>object</i>.style.transition="all 2s"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_transition">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left; height: 32px;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">transition</td>
...
transition: <i>property duration timing-function delay</i>|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    <th>Description</th>
  </tr><tr><td><i><a href="css3_pr_transition-property.asp">transition-property</a></i></td>
    <td>Specifies the name of the CSS property the transition effect is for</td>
  </tr><tr><td><i><a href="css3_pr_transition-duration.asp">transition-duration</a></i></td>
    <td>Specifies how many seconds or milliseconds the transition effect takes to 
	complete</td>
  </tr><tr><td><i><a href="css3_pr_transition-timing-function.asp">transition-timing-function</a></i></td>
    <td>Specifies the speed curve of the transition effect</td>
  </tr><tr><td><i><a href="css3_pr_transition-delay.asp">transition-delay</a></i></td>
    <td>Defines when the transition effect will start</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_transition.asp">transition property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transform-style.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transition-delay.asp">Next &raquo;</a></div>
