...
<h1>CSS <span class="color_h1">caption-side</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_box-sizing.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_clear.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify the placement of a table caption:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_table_caption-side" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.captionSide="bottom"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_caption-side">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">caption-side</td>
    <td>1.0</td>
    <td>8.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
<p><b>Note:</b> IE8 supports the caption-side property only if a !DOCTYPE 
is specified.</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
caption-side: top|bottom|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <th>Play it</th>    
		...
		<td>Puts the caption above the table. This is default</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_caption-side">Play it &raquo;</a></td>
	</tr><tr><td>bottom</td>
		<td>Puts the caption below the table</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_caption-side&amp;preval=bottom">Play it &raquo;</a></td>
	</tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_caption-side&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_captionside.asp">captionSide property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_box-sizing.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_clear.asp">Next &raquo;</a></div>
