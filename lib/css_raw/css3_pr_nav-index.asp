...
<h1>CSS3 <span class="color_h1">nav-index</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_nav-down.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_nav-left.asp">Next &raquo;</a></div>
</div>
...
<p>The nav-index property specifies the sequential navigation order ("tabbing order") 
for an element.</p>
...
<p>The nav-index property is only supported in Opera 12 and some earlier 
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">nav-index</td>
...
nav-index: auto|<i>number</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. The element's tabbing order is assigned by the browser</td>
  </tr><tr><td><i>number</i></td>
    <td>Indicates the tabbing order for the element. 1 means first</td>
  </tr><tr><td>initial</td>
