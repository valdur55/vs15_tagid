...
<h1>CSS3 <span class="color_h1">transition-timing-function </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transition-property.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_unicode-bidi.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp;
    -webkit-transition-timing-function: linear; /* Safari and Chrome */<br>&nbsp;&nbsp;&nbsp;
    transition-timing-function: linear;<br>
    }<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition-timing-function">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The transition-timing-function property specifies the speed curve of the transition 
effect.</p>
<p>This property allows a transition effect to change speed over its duration.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.transitionTimingFunction="linear"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_transition-timing-function">Try it</a>
</td>
  </tr></table></div>
...
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:25%;font-size:16px;text-align:left; height: 32px;">Property</th>
    <th style="width:15%; height: 32px;" class="bsChrome" title="Chrome"></th>
    <th style="width:15%; height: 32px;" class="bsIE" title="Internet Explorer"></th>
    <th style="width:15%; height: 32px;" class="bsFirefox" title="Firefox"></th>
    <th style="width:15%; height: 32px;" class="bsSafari" title="Safari"></th>
    <th style="width:15%; height: 32px;" class="bsOpera" title="Opera"></th>                
  </tr><tr><td style="text-align:left; width: 20%;">transition-timing-function</td>
...
transition-timing-function: ease|linear|ease-in|ease-out|ease-in-out|cubic-bezier()|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:19%;">Value</th>
    <th>Description</th>
  </tr><tr><td>ease</td>
    <td>Default value. Specifies a transition effect with a slow start, then fast, then end 
	slowly (equivalent to cubic-bezier(0.25,0.1,0.25,1))</td>
  </tr><tr><td>linear</td>
    <td>Specifies a transition effect with the same speed from start to end 
	(equivalent to cubic-bezier(0,0,1,1))</td>
  </tr><tr><td>ease-in</td>
    <td>Specifies a transition effect with a slow start (equivalent to 
	cubic-bezier(0.42,0,1,1))</td>
  </tr><tr><td>ease-out</td>
    <td>Specifies a transition effect with a slow end (equivalent to 
	cubic-bezier(0,0,0.58,1))</td>
  </tr><tr><td>ease-in-out</td>
    <td>Specifies a transition effect with a slow start and end (equivalent to 
	cubic-bezier(0.42,0,0.58,1))</td>
...
<p><b>Tip:</b> Try the different values in the examples below to understand how 
it works!</p>
...
<h3>Example</h3>
<p>To better understand the different function values:
Here are five different div elements with five different values:</p>
<div class="w3-code notranslate cssHigh">
  
	/* For Safari 3.1 to 6.0 */<br>
	#div1 {-webkit-transition-timing-function: linear;}<br>
	#div2 {-webkit-transition-timing-function: ease;}<br>
	#div3 {-webkit-transition-timing-function: ease-in;}<br>
	#div4 {-webkit-transition-timing-function: ease-out;}<br>
	#div5 {-webkit-transition-timing-function: ease-in-out;}<br><br>/* Standard 
	syntax */<br>#div1 {transition-timing-function: linear;}<br>
	...
	#div5 {transition-timing-function: ease-in-out;}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition-timing-function2">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">

<h3>Example</h3>
<p>Same as the example above, but the speed curves are specified with the 
cubic-bezier function:</p>
<div class="w3-code notranslate cssHigh">
  
	/* For Safari 3.1 to 6.0 */<br>
	#div1 {-webkit-transition-timing-function: cubic-bezier(0,0,1,1;}<br>
	#div2 {-webkit-transition-timing-function: cubic-bezier(0.25,0.1,0.25,1);}<br>
	#div3 {-webkit-transition-timing-function: cubic-bezier(0.42,0,1,1);}<br>
	#div4 {-webkit-transition-timing-function: cubic-bezier(0,0,0.58,1);}<br>
	#div5 {-webkit-transition-timing-function: cubic-bezier(0.42,0,0.58,1);}<br><br>/* Standard syntax */<br>#div1 {transition-timing-function: cubic-bezier(0,0,1,1;}<br>
	#div2 {transition-timing-function: cubic-bezier(0.25,0.1,0.25,1);}<br>
	#div3 {transition-timing-function: cubic-bezier(0.42,0,1,1);}<br>
	#div4 {transition-timing-function: cubic-bezier(0,0,0.58,1);}<br>
	#div5 {transition-timing-function: cubic-bezier(0.42,0,0.58,1);}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition-timing-function3">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_transitions.asp">CSS3 Transitions</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_transitiontimingfunction.asp">transitionTimingFunction property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transition-property.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_text_unicode-bidi.asp">Next &raquo;</a></div>
