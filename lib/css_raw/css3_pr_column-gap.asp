...
<h1>CSS3 <span class="color_h1">column-gap</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-fill.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-rule.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp;
	-webkit-column-gap: 40px; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-gap: 40px; /* Firefox */<br>
	&nbsp;&nbsp;&nbsp;
	column-gap: 40px;<br>
	}
</div>
...
<p>The column-gap property specifies the gap between the columns.</p>
<p><b>Note:</b> If there is a column-rule between columns, it will appear in the 
middle of the gap.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_column-gap">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.columnGap="50px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_column-gap">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">column-gap</td>
    <td>4.0 -webkit-</td>
    <td>10.0</td>
    <td>2.0 -moz-</td>
    <td>3.1 -webkit-</td>
...
column-gap: <i>length</i>|normal|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>A specified length that will set the gap between the columns</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-gap">Play it &raquo;</a></td>			    
  </tr><tr><td>normal</td>
    <td>Default value. Specifies a normal gap between the columns. W3C suggests a value of 1em</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-gap&amp;preval=normal">Play it &raquo;</a></td>			        
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-gap&amp;preval=initial">Play it &raquo;</a></td>			        
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_columngap.asp">columnGap property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-fill.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-rule.asp">Next &raquo;</a></div>
