<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS margin-bottom property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">margin-bottom</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_margin.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_margin-left.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the bottom margin for a &lt;p&gt; element:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_margin-bottom" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The margin-bottom property sets the bottom margin of an element.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_margin-bottom">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.marginBottom="100px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_margin-bottom">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">margin-bottom</td>
    <td>1.0</td>
    <td>6.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
margin-bottom: <i>length</i>|auto|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Specifies a fixed bottom margin in px, pt, cm, etc. Default value is 0</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-bottom&amp;preval=10px">Play it &raquo;</a></td>		                  
  </tr><tr><td><i>%</i></td>
    <td>Specifies a bottom margin in percent of the width of the 
	containing element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-bottom&amp;preval=10%25">Play it &raquo;</a></td>		                  
  </tr><tr><td>auto</td>
    <td>The browser calculates a bottom margin</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-bottom&amp;preval=auto">Play it &raquo;</a></td>		                  
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-bottom&amp;preval=initial">Play it &raquo;</a></td>		                  
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_marginbottom.asp">marginBottom property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_margin.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_margin-left.asp">Next &raquo;</a></div>
