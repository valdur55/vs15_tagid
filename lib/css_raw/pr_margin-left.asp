...
<h1>CSS <span class="color_h1">margin-left</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_margin-bottom.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_margin-right.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the left margin for a &lt;p&gt; element:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_margin-left" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_margin-left">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.marginLeft="100px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_margin-left">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">margin-left</td>
    <td>1.0</td>
    <td>6.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
margin-left: <i>length</i>|auto|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Specifies a fixed left margin in px, pt, cm, etc. Default value is 0px</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-left&amp;preval=10px">Play it &raquo;</a></td>		                  
  </tr><tr><td><i>%</i></td>
    <td>Specifies a left margin in percent of the width of the 
	containing element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-left&amp;preval=10%25">Play it &raquo;</a></td>		                  	
  </tr><tr><td>auto</td>
    <td>The browser calculates a left margin</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-left&amp;preval=auto">Play it &raquo;</a></td>		                  
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-left&amp;preval=initial">Play it &raquo;</a></td>		                  	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_marginleft.asp">marginLeft property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_margin-bottom.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_margin-right.asp">Next &raquo;</a></div>
