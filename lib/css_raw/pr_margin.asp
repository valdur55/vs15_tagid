...
<h1>CSS <span class="color_h1">margin</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_list-style-type.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_margin-bottom.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set all the four margins of a &lt;p&gt; element:</p>
<div class="w3-code notranslate cssHigh">
    p 
	{<br>
	&nbsp;&nbsp;&nbsp;
	margin: 2cm 4cm 3cm 4cm;<br>
	}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_margin" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The margin shorthand property sets all the margin properties in one declaration. This property can have from one to four values.</p>
<p>Examples:</p>
<ul><li><b>margin:10px 5px 15px 20px;</b>
	<ul><li>top margin is 10px</li>
	<li>right margin is 5px</li>
	<li>bottom margin is 15px</li>
	<li>left margin is 20px</li></ul><br></li>
	<li><b>margin:10px 5px 15px;</b><ul><li>top margin is 10px</li>
	<li>right and left margins are 5px</li>
	<li>bottom margin is 15px</li></ul><br></li>
	<li><b>margin:10px 5px;</b><ul><li>top and bottom margins are 10px</li>
	<li>right and left margins are 5px</li></ul><br></li>
	<li><b>margin:10px;</b><ul><li>all four margins are 10px</li></ul></li>
</ul><p><b>Note:</b> Negative values are allowed.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_margin">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.margin="100px 50px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_margin">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">margin</td>
    <td>1.0</td>
    <td>6.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
margin: <i>length</i>|auto|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Specifies a margin in px, pt, cm, etc. Default value is 0</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin&amp;preval=10px">Play it &raquo;</a></td>		                  
  </tr><tr><td><i>%</i></td>
    <td>Specifies a margin in percent of the width of the 
	containing element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin&amp;preval=10%25">Play it &raquo;</a></td>		                  	
  </tr><tr><td>auto</td>
    <td>The browser calculates a margin</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin&amp;preval=auto">Play it &raquo;</a></td>		                  
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin&amp;preval=initial">Play it &raquo;</a></td>		                  	
    </tr><tr><td>inherit</td>
...
<p>CSS tutorial: <a href="/css/css_boxmodel.asp">CSS Box Model</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_margin.asp">margin property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_list-style-type.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_margin-bottom.asp">Next &raquo;</a></div>
