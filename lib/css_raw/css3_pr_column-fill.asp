...
<h1>CSS3 <span class="color_h1">column-fill</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-count.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-gap.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp; -moz-column-fill: auto; /* Firefox */<br>
	&nbsp;&nbsp;&nbsp;
	column-fill: auto;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_column-fill">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The column-fill property specifies how to fill columns, balanced or not.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.columnFill="auto"  
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_column-fill">Try it</a></td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">column-fill&nbsp;</td>
...
column-fill: balance|auto|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    ...
    <td>Default value. Columns are balanced. Browsers should minimize the variation in column 
	length</td>
  </tr><tr><td>auto</td>
    <td>Columns are filled sequentially, and they will have different lengths</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_columnfill.asp">columnFill property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-count.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-gap.asp">Next &raquo;</a></div>
