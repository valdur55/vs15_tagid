...
<h1>CSS <span class="color_h1">border-style</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-spacing.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-top.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the style of the four borders:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-style" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The border-style property sets the style of an element's four borders. This property can have from one to four values.</p>
<p>Examples:</p>
<ul><li><b>border-style:dotted solid double dashed; </b>
	<ul><li>top border is dotted</li>
	<li>right border is solid</li>
	<li>bottom border is double</li>
	<li>left border is dashed</li></ul><br></li>
	<li><b>border-style:dotted solid double;</b>
	<ul><li>top border is dotted</li>
	<li>right and left borders are solid</li>
	<li>bottom border is double</li></ul><br></li>
	<li><b>border-style:dotted solid;</b>
	<ul><li>top and bottom borders are dotted</li>
	<li>right and left borders are solid</li></ul><br></li>
	<li><b>border-style:dotted;</b><ul><li>all four borders are dotted</li></ul></li>
</ul><div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.borderStyle="dotted double"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-style">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">border-style</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
<p><b>Note:</b> The value "hidden" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "hidden".</p>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
border-style:none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:10%">Value</th>
    <th>Description</th>
    <th>Play it</th>            
  </tr><tr><td>none</td>
      <td>Default value. Specifies no border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=none">Play it &raquo;</a></td>		      
    </tr><tr><td>hidden</td>
      <td>The same as "none", except in border conflict
        resolution for table elements</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=hidden">Play it &raquo;</a></td>		
    </tr><tr><td>dotted</td>
      <td>Specifies a dotted border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=dotted">Play it &raquo;</a></td>		
    </tr><tr><td>dashed</td>
      <td>Specifies a dashed border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=dashed">Play it &raquo;</a></td>
    </tr><tr><td>solid</td>
      <td>Specifies a solid border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=solid">Play it &raquo;</a></td>
    </tr><tr><td>double</td>
      <td>Specifies a double border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=double">Play it &raquo;</a></td>
    </tr><tr><td>groove</td>
      <td>Specifies a 3D grooved border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=groove">Play it &raquo;</a></td>
    </tr><tr><td>ridge</td>
      <td>Specifies a 3D ridged border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=ridge">Play it &raquo;</a></td>
    </tr><tr><td>inset</td>
      <td>Specifies a 3D inset border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=inset">Play it &raquo;</a></td>
    </tr><tr><td>outset</td>
      <td>Specifies a 3D outset border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=outset">Play it &raquo;</a></td>
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-style&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>Set different borders on each side of an element:</p>
<div class="w3-code notranslate cssHigh">
    p.one {border-style: dotted solid dashed double;}<br>p.two {border-style: 
	dotted solid dashed;}<br>p.three {border-style: dotted solid;}<br>p.four 
	{border-style: dotted;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-style2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_border.asp">CSS Border</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_borderstyle.asp">borderStyle property</a></p>
