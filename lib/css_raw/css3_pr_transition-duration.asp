<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 transition-duration Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">transition-duration </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transition-delay.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transition-property.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Let the transition effect 
last for 5 seconds:</p>
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp;
    -webkit-transition-duration: 5s; /* Safari */<br>&nbsp;&nbsp;&nbsp;
    transition-duration: 5s;<br>
    }<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition-duration">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The transition-duration property specifies how many seconds (s) or milliseconds 
(ms) a 
transition effect takes to complete.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.transitionDuration="1s"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_transition-duration">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left; height: 32px;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">transition-duration</td>
...
transition-duration: <i>time</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
	...
	complete. 
	Default value is 0s, meaning there will be no effect</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_transitionduration.asp">transitionDuration property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transition-delay.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transition-property.asp">Next &raquo;</a></div>
