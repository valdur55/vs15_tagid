...
<h1>CSS <span class="color_h1">border-right</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-radius.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-right_color.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
	...
	&nbsp;&nbsp;&nbsp;
	border-right: thick double #ff0000;<br>
	}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-right shorthand property sets all the right border properties in one declaration.</p>
<p>The properties that can be set, are (in order): border-right-width, border-right-style, and border-right-color.</p>
<p>It does not matter if one of the values above are missing, e.g. border-right:solid #ff0000; is allowed.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-right">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.borderRight="5px dotted blue"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-right">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">border-right</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
border-right: <i>border-width</i> <i>border-style</i> <i>border-color</i>|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:25%">Value</th>
    <th>Description</th>
  </tr><tr><td><i><a href="pr_border-right_width.asp">border-right-width</a></i></td>
    <td>Specifies the width of the right border</td>
  </tr><tr><td><i><a href="pr_border-right_style.asp">border-right-style</a></i></td>
    <td>Specifies the style of the right border</td>
  </tr><tr><td><i><a href="pr_border-right_color.asp">border-right-color</a></i></td>
    <td>Specifies the color of the right border</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_borderright.asp">borderRight property</a></p>
