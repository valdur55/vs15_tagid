...
<h1>CSS3 <span class="color_h1">border-top-left-radius</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-top_color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-top-right-radius.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Add a rounded border to the top-left corner of a &lt;div&gt; element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-top-left-radius">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-top-left-radius property defines the shape of the border of the top-left corner.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-top-left-radius">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.borderTopLeftRadius="25px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_border-top-left-radius">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:25%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">border-top-left-radius&nbsp;</td>
...
border-top-left-radius: <i>length</i>|<i>%</i> [<i>length</i>|<i>%</i>]|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
	...
	top-left corner</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-left-radius">Play it &raquo;</a></td>
  </tr><tr><td><i>%</i></td>
    <td>Defines the shape of the 
	top-left corner in %</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-left-radius&amp;preval=10%25">Play it &raquo;</a></td>	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-left-radius&amp;preval=initial">Play it &raquo;</a></td>	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_bordertopleftradius.asp">borderTopLeftRadius property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_border-top_color.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_border-top-right-radius.asp">Next &raquo;</a></div>
