<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 text-justify property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">text-justify</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_text_text-indent.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-overflow.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Justification changes spacing between words:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-justify">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The text-justify property specifies the justification method to use when text-align is set to 
	"justify".</p>
<p>This property specifies how justified text should be aligned and spaced.</p>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">text-justify</td>
...
text-justify: auto|inter-word|inter-ideograph|inter-cluster|distribute|kashida|trim|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>The browser determines the justification algorithm</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify">Play it &raquo;</a></td>    
  </tr><tr><td>inter-word</td>
    <td>Increases/Decreases the space between words</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&amp;preval=inter-word">Play it &raquo;</a></td>
  </tr><tr><td>inter-ideograph</td>
    <td>Justifies content with ideographic text</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&amp;preval=inter-ideograph">Play it &raquo;</a></td>
  </tr><tr><td>inter-cluster</td>
    <td>Only content that does not contain any inter-word spacing (such as Asian 
	languages) is justified</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&amp;preval=inter-cluster">Play it &raquo;</a></td>	
  </tr><tr><td>distribute</td>
    <td>Spacing between letters and words are increased or decreased as 
	necessary</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&amp;preval=distribute">Play it &raquo;</a></td>
  </tr><tr><td>kashida</td>
    <td>Justifies content by elongating characters</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&amp;preval=kashida">Play it &raquo;</a></td>
  </tr><tr><td>trim</td>
    <td>&nbsp;</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&amp;preval=trim">Play it &raquo;</a></td>
  </tr><tr><td>none</td>
    <td>The justification is disabled</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&amp;preval=none">Play it &raquo;</a></td>
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
