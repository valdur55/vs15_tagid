<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 animation-iteration-count Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">animation-iteration-count </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-fill-mode.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-name.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Play the animation three times:</p>
<div class="w3-code notranslate cssHigh">
  
    div {<br>&nbsp;&nbsp;&nbsp; -webkit-animation-iteration-count: 3; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp;
  
    animation-iteration-count: 3;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-iteration-count">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The animation-iteration-count property specifies the number of times an animation should be played.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.animationIterationCount="infinite"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_animation-iteration-count">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:25%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">animation-iteration-count</td>
...
animation-iteration-count: <i>number</i>|infinite|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
	...
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-iteration-count&amp;preval=1">Play it &raquo;</a></td>			    
  </tr><tr><td>infinite</td>
    <td>Specifies that the animation should be played infinite times (for ever)</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_animation-iteration-count&amp;preval=infinite">Play it &raquo;</a></td>			        
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_animationiterationcount.asp">animationIterationCount property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_animation-fill-mode.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_animation-name.asp">Next &raquo;</a></div>
