...
<h1>CSS3 <span class="color_h1">nav-right</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_nav-left.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_nav-up.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify where to navigate when using the arrow keys:</p>
<div class="w3-code notranslate cssHigh">
	...
	nav-index: 1;<br>
	&nbsp;&nbsp;&nbsp;
	nav-right: #b2; nav-left: #b4;<br>
	&nbsp;&nbsp;&nbsp;
	nav-down: #b2; nav-up: #b4;<br>
	}<br><br>
	button#b2
	{<br>
	&nbsp;&nbsp;&nbsp;
	...
	nav-index: 2;<br>
	&nbsp;&nbsp;&nbsp;
	nav-right: #b3; nav-left: #b1;<br>
	&nbsp;&nbsp;&nbsp;
	nav-down: #b3; nav-up: #b1;<br>
	}<br><br>
	button#b3
	{<br>
	&nbsp;&nbsp;&nbsp;
	...
	nav-index: 3;<br>
	&nbsp;&nbsp;&nbsp;
	nav-right: #b4; nav-left: #b2;<br>
	&nbsp;&nbsp;&nbsp;
	nav-down: #b4; nav-up: #b2;<br>
	}<br><br>
	button#b4
	{<br>
	&nbsp;&nbsp;&nbsp;
	...
	nav-index: 4;<br>
	&nbsp;&nbsp;&nbsp;
	nav-right: #b1; nav-left: #b3;<br>
	&nbsp;&nbsp;&nbsp;
	nav-down: #b1; nav-up: #b3;<br>
	} 
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_nav">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The nav-right property specifies where to navigate when using the arrow-right navigation key.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.navRight="#div2"</td>
  </tr></table></div>
<hr><h2>Browser Support</h2>
<p>The nav-right property is only supported in Opera 12 and some earlier 
versions. This property became deprecated and obsolete in Opera 15.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">nav-right</td>
    <td><span class="deprecated">Not supported</span></td>
    <td><span class="deprecated">Not supported</span></td>
    <td><span class="deprecated">Not supported</span></td>
    <td><span class="deprecated">Not supported</span></td>
    <td>Supported in Opera 11.5-12.<br>&nbsp;<span class="deprecated">Not supported 
	in newer versions</span></td>
  </tr></table></div>
<hr><h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
nav-right: auto|<i>id</i>|<i>target-name</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. The browser determines which element to navigate to</td>
  </tr><tr><td><i>id</i></td>
    <td>Specifies the id of the element to navigate to</td>
  </tr><tr><td><i>target-name</i></td>
    <td>Specifies the target frame to navigate to</td>
  </tr><tr><td>initial</td>
