<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 column-rule-color property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">column-rule-color</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-rule.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-rule-style.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp;
	-webkit-column-rule-color: #ff0000; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-rule-color: #ff0000; /* Firefox */<br>
	&nbsp;&nbsp;&nbsp;
	column-rule-color: #ff0000;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_column-rule-color">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The column-rule-color property specifies the color of the rule between columns.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">The current color of the element</td>
  </tr><tr><th>Inherited:</th>
    <td>no</td>
  </tr><tr><th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a>
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_column-rule-color">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.columnRuleColor="#0000ff"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_column-rule-color">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">column-rule-color</td>
    <td>4.0 -webkit-</td>
    <td>10.0</td>
    <td>2.0 -moz-</td>
    <td>3.1 -webkit-</td>
...
column-rule-color: <i>color</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Specifies the color of the rule. Look at <a href="css_colors_legal.asp">CSS Color Values</a> 
	for a complete list of possible color values</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-color">Play it &raquo;</a></td>			    	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-rule-color&amp;preval=initial">Play it &raquo;</a></td>			    	
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_columnrulecolor.asp">columnRuleColor property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_column-rule.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_column-rule-style.asp">Next &raquo;</a></div>
