...
<h1>CSS3 <span class="color_h1">resize</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_gen_quotes.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_right.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Specify that a &lt;div&gt; element should be resizable by the user:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_resize">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr><h2>Definition and Usage</h2>
<p>The resize property specifies whether or not an element is resizable by the 
user.</p>
<p><b>Note:</b> The resize property applies to elements whose computed overflow 
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.resize="both"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_resize">Try it</a>
</td>
  </tr></table></div>
<hr><h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the property.</p>
<p>Numbers followed by -moz- specify the first version that worked with a prefix.</p>
<div class="w3-responsive">
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">resize&nbsp;</td>
    <td>4.0</td>
...
resize: none|both|horizontal|vertical|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
    ...
    <td>Default value. The user cannot resize the element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_resize&amp;preval=none">Play it &raquo;</a></td>   		
  </tr><tr><td> both</td>
    <td>The user can adjust both the height and the width of the element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_resize&amp;preval=both">Play it &raquo;</a></td>   		    
  </tr><tr><td> horizontal</td>
    <td>The user can adjust the width of the element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_resize&amp;preval=horizontal">Play it &raquo;</a></td>   		    
  </tr><tr><td> vertical</td>
    <td>The user can adjust the height of the element</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_resize&amp;preval=vertical">Play it &raquo;</a></td>   		    
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_resize&amp;preval=initial">Play it &raquo;</a></td>   		    
    </tr><tr><td>inherit</td>
...
<h3>Example</h3>
<p>Let the user resize only the height of a &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp; resize: vertical;<br>&nbsp;&nbsp;&nbsp; overflow: 
	auto;<br>
	}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_resize_height">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Let the user resize only the width of a &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
    div
	{<br>&nbsp;&nbsp;&nbsp; resize: horizontal;<br>&nbsp;&nbsp;&nbsp; overflow: 
	auto;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_resize_width">Try it yourself &raquo;</a>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>By default, &lt;textarea&gt; elements are resizable. Use the resize property to 
prevent textareas to be resized (disable the "grabber" in the textarea):</p>
<div class="w3-code notranslate cssHigh">
    textarea {<br>&nbsp;&nbsp;&nbsp; resize: none;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_resize_textarea">Try it yourself &raquo;</a>
</div>
<hr><h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="/css/css3_user_interface.asp">CSS3 User Interface</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_resize.asp">resize property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_gen_quotes.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_right.asp">Next &raquo;</a></div>
