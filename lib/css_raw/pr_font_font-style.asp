...
<h1>CSS <span class="color_h1">font-style</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_font-stretch.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_font_font-variant.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    ...
    p.normal {<br>&nbsp;&nbsp;&nbsp; font-style: normal;<br>}<br><br>
	p.italic {<br>&nbsp;&nbsp;&nbsp; font-style: italic;<br>}<br><br>
	p.oblique {<br>&nbsp;&nbsp;&nbsp; font-style: oblique;<br>}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_font-style" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The font-style property specifies the font style for a text.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.fontStyle="italic"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_font-style">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">font-style</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
font-style: normal|italic|oblique|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>The browser displays a normal font style. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-style">Play it &raquo;</a></td>    
  </tr><tr><td>italic</td>
    <td>The browser displays an italic font style</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-style&amp;preval=italic">Play it &raquo;</a></td>    
  </tr><tr><td>oblique</td>
    <td>The browser displays an oblique font style</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-style&amp;preval=oblique">Play it &raquo;</a></td>        
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-style&amp;preval=initial">Play it &raquo;</a></td>        
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_fontstyle.asp">fontStyle property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_font-stretch.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_font_font-variant.asp">Next &raquo;</a></div>
