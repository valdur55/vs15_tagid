...
<h1>CSS3 <span class="color_h1">perspective </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_print_pagebi.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_perspective-origin.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the perspective from where an element is viewed:</p>
<div class="w3-code notranslate cssHigh">
  
    div
	{<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-perspective: 500px; /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
	perspective: 500px;<br>
	}
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_perspective1">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The perspective property defines how many pixels a 3D element is placed from 
the view. This property allows you to change the perspective on how 3D 
elements are viewed.</p>
<p>When defining the perspective property for an element, it is the CHILD elements 
that get the perspective view, NOT the element itself.</p>
<p><b>Note:</b> The perspective property only affects 3D transformed elements!</p>
<p><b>Tip:</b> Use this property together with the 
<a href="css3_pr_perspective-origin.asp">perspective-origin</a> property, which 
allows you to change the bottom position of 3D elements.</p>
<p>To better understand the perspective property,
<a href="trycss3_perspective_inuse.htm" target="_blank">view a demo</a>.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_perspective">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.perspective="50px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_perspective">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">perspective</td>
...
perspective: <i>length</i>|none;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Property Value</th>
    ...
    <td>How far the element is placed from the view</td>
  </tr><tr><td>none</td>
    <td>Default value. Same as 0. The perspective is not set</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_perspective.asp">perspective property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_print_pagebi.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_perspective-origin.asp">Next &raquo;</a></div>
