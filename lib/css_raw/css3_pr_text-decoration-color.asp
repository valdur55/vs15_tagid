...
<h1>CSS <span class="color_h1">text-decoration-color</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_text_text-decoration.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-decoration-line.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">

<h3>Example</h3>
<p>Change the color of the line, in an underlined text:</p>
<div class="w3-code notranslate cssHigh">
p
{<br>
&nbsp;&nbsp;&nbsp;
text-decoration: underline;<br>&nbsp;&nbsp;&nbsp;
-moz-text-decoration-color: red; /* Code for Firefox */<br>
&nbsp;&nbsp;&nbsp;
text-decoration-color: red;<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_text-decoration-color" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The text-decoration-color property specifies the color of the text-decoration (underlines, overlines, linethroughs).</p>
<p><strong>Note:</strong> The text-decoration-color property will only have an effect on elements with a visible text-decoration.</p>

<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%"><em>currentColor</em></td>
  </tr><tr><th>Inherited:</th>
    <td>no</td>
  </tr><tr><th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_text-decoration-color">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.textDecorationColor="red"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_text-decoration-color">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">text-decoration-color</td>
...
text-decoration-color: <i>color</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
  ...
  </tr><tr><td><em>color</em></td>
    <td>Specifies the color of the text-decoration</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-color&amp;preval=red">Play it &raquo;</a></td>          
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-decoration-color&amp;preval=initial">Play it &raquo;</a></td>          
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_textdecorationcolor.asp">textDecorationColor property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_text_text-decoration.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-decoration-line.asp">Next &raquo;</a></div>
