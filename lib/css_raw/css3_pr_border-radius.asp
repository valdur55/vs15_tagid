...
<h1>CSS3 <span class="color_h1">border-radius</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_border-left_width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-right.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Add rounded borders to a &lt;div&gt; element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-radius">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-radius property is a shorthand property for setting the four border-*-radius properties.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-radius">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.borderRadius="25px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_border-radius">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">border-radius&nbsp;</td>
...
border-radius: <i>1-4 length</i>|<i>%</i> / <i>1-4 length</i>|<i>%</i>|initial|inherit;</div></div>
<p><b>Note:</b> The four values for each radii are given in the order top-left, top-right, 
...
is omitted it is the same as top-left.</p>
...
<table class="w3-table-all notranslate"><tr><th style="width:20%">Value</th>
	...
	corners. Default value is 0</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-radius">Play it &raquo;</a></td>
  </tr><tr><td><i>%</i></td>
    <td>Defines the shape of the 
	corners in %</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-radius&amp;preval=10%25">Play it &raquo;</a></td>	
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-radius&amp;preval=initial">Play it &raquo;</a></td>	
    </tr><tr><td>inherit</td>
...
border-radius: 2em 1em 4em / 0.5em 3em;<br><br>
is equivalent to:<br><br>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_borderradius.asp">borderRadius property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_border-left_width.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-right.asp">Next &raquo;</a></div>
