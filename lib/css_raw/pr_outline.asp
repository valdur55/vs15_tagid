...
<h1>CSS <span class="color_h1">outline</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_order.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_outline-color.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the outline around a &lt;p&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  
    p 
	{<br>
	&nbsp;&nbsp;&nbsp;
	outline: #00FF00 dotted thick;<br>
	}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p>The outline shorthand property sets all the outline properties in one declaration.</p>
<p>The properties that can be set, are (in order): outline-color, outline-style, outline-width.</p>
<p>If one of the values above are missing, e.g. "outline:solid #ff0000;", the default value for the missing property will be inserted, if any.</p>
<p><strong>Note:</strong> The outline is not a part of the element's dimensions, therefore the 
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">invert none medium</td>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_outline">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS2</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.outline="#0000FF dotted 5px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_outline">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">outline</td>
    <td>1.0</td>
    <td>8.0</td>
    <td>1.5</td>
    <td>1.2</td>
...
outline: <i>outline-color</i> <i>outline-style</i> <i>outline-width</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:25%">Value</th>
    <th>Description</th>
  </tr><tr><td><i><a href="pr_outline-color.asp">outline-color</a></i></td>
    <td>Specifies the color of the outline</td>
  </tr><tr><td><i><a href="pr_outline-style.asp">outline-style</a></i></td>
    <td>Specifies the style of the outline</td>
  </tr><tr><td><i><a href="pr_outline-width.asp">outline-width</a></i></td>
    <td>Specifies the width of outline</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_outline.asp">outline property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_order.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_outline-color.asp">Next &raquo;</a></div>
