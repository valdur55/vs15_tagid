<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 transform-origin property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">transform-origin </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transform.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transform-style.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
    ...
    div
	{<br>&nbsp;&nbsp;&nbsp;
	-ms-transform: rotate(45deg); /* IE 9 */<br>
	&nbsp;&nbsp;&nbsp;
	-ms-transform-origin: 20% 40%; /* IE 9 */<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-transform: rotate(45deg); /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-transform-origin: 20% 40%; /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transform-origin">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The transform-origin property allows you to change the position of transformed elements.</p>
<p>2D transformations can change the x- and y-axis of an element. 3D transformations 
can also change the z-axis of an element.</p>
<p>To better understand the transform-origin property,
<a target="_blank" href="trycss3_transform-origin_inuse.htm">view a demo</a>.</p>
<p><b>Note:</b> This property must be used together with the 
<a href="css3_pr_transform.asp">transform</a> 
property.</p>
<p><b>Tip:</b> To better understand this property for <strong>3D transforms</strong>,
<a target="_blank" href="trycss3_transform-origin_3d_inuse.htm">view a demo</a>.</p>
<div class="w3-responsive">
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    <td width="75%">50% 50% 0</td>
  </tr><tr><th>Inherited:</th>
    <td>no</td>
  </tr><tr><th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_transform-origin">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.transformOrigin="0 0"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_transform-origin">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">transform-origin<br>(two-value syntax)</td>
  ...
  </tr><tr><td style="text-align:left;">transform-origin<br>(three-value syntax)</td>
...
transform-origin: <i>x-axis y-axis z-axis</i>|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Property Value</th>
    <th>Description</th>
  </tr><tr><td><i>x-axis</i></td>
    <td>Defines where the view is placed at the x-axis. Possible values:<ul><li>left</li>
		<li>center</li>
		<li>right</li>
		<li><i>length</i></li>
		<li><i>%</i></li>
	</ul></td>
  </tr><tr><td><i>y-axis</i></td>
    <td>Defines where the view is placed at the y-axis. Possible values:<ul><li>top</li>
		<li>center</li>
		<li>bottom</li>
		<li><i>length</i></li>
		<li><i>%</i></li>
	</ul></td>
  </tr><tr><td><i>z-axis</i></td>
    <td>Defines where the view is placed at the z-axis (for 3D transformations). Possible values:<ul><li><i>length</i></li>
	</ul></td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_transformorigin.asp">transformOrigin property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transform.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transform-style.asp">Next &raquo;</a></div>
