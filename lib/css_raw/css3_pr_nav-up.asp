...
<h1>CSS3 <span class="color_h1">nav-up</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_nav-right.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_opacity.asp">Next &raquo;</a></div>
</div>
...
<p>The nav-up property specifies where to navigate when using the arrow-up navigation key.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.navUp="#div2"</td>
  </tr></table></div>
<hr><h2>Browser Support</h2>
<p>The nav-up property is only supported in Opera 12 and some earlier 
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">nav-up</td>
...
nav-up: auto|<i>id</i>|<i>target-name</i>|initial|inherit;</div></div>
