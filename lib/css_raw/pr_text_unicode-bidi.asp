...
<h1>CSS <span class="color_h1">unicode-bidi</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transition-timing-function.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_pos_vertical-align.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_text_unicode-bidi" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The unicode-bidi property is used together with the
<a href="pr_text_direction.asp">direction</a> property to set or return whether the text should be overridden to 
support multiple languages in the same document.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.unicodeBidi="bidi-override"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_unicode-bidi">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">unicode-bidi</td>
    <td>2.0</td>
    <td>5.5</td>
    <td>1.0</td>
    <td>1.3</td>
...
unicode-bidi: normal|embed|bidi-override|intitial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Does not use an additional level of embedding. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_unicode-bidi">Play it &raquo;</a></td>
  </tr><tr><td>embed</td>
    <td>Creates an additional level of embedding</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_unicode-bidi&amp;preval=embed">Play it &raquo;</a></td>    
  </tr><tr><td>bidi-override</td>
    <td>Creates an additional level of embedding. Reordering depends on the direction property</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_unicode-bidi&amp;preval=bidi-override">Play it &raquo;</a></td>    
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_unicode-bidi&amp;preval=initial">Play it &raquo;</a></td>    
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_unicodebidi.asp">unicodeBidi 
property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transition-timing-function.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
