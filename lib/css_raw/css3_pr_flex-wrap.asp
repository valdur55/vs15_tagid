...
<h1>CSS <span class="color_h1">flex-wrap</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-shrink.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_float.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Make the flexible items wrap if necesarry:</p>
<div class="w3-code notranslate cssHigh">
	div {<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex; /* Safari */<br>&nbsp;&nbsp;&nbsp; 
	-webkit-flex-wrap: wrap; /* Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp;
	display: flex;&nbsp;&nbsp; <br>&nbsp;&nbsp;&nbsp; flex-wrap: wrap;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_flex-wrap" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The flex-wrap property specifies whether the flexible items should wrap or not.</p>

<p><b>Note:</b> If the elements are not flexible items, the flex-wrap property has no effect.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td><i>object</i>.style.flexWrap="nowrap"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_flex-wrap">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">flex-wrap</td>
...
flex-wrap: nowrap|wrap|wrap-reverse|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:21%">Value</th>
    ...
    <td>Default value. Specifies that the flexible items will not wrap</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-wrap&amp;preval=nowrap">Play it &raquo;</a></td>              
    </tr><tr><td>wrap</td>
    <td>Specifies that the flexible items will wrap if necessary</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-wrap&amp;preval=wrap">Play it &raquo;</a></td>              
    </tr><tr><td>wrap-reverse</td>
    <td>Specifies that the flexible items will wrap, if necessary, in reverse order</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-wrap&amp;preval=wrap-reverse">Play it &raquo;</a></td>              
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_flex-wrap&amp;preval=initial">Play it &raquo;</a></td>              
    </tr><tr><td>inherit</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_flexwrap.asp">flexWrap property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_flex-shrink.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_class_float.asp">Next &raquo;</a></div>
