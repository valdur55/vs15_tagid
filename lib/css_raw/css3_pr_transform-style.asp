<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 transform-style property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">transform-style </span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transform-origin.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transition.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
	...
	{<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-transform: rotateY(60deg); /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
	-webkit-transform-style: preserve-3d; /* Chrome, Safari, Opera */<br>
	&nbsp;&nbsp;&nbsp;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transform-style">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The transform-style property specifies how nested elements are rendered in 3D 
space.</p>
<p><b>Note:</b> This property must be used together with the 
<a href="css3_pr_transform.asp">transform</a> 
property.</p>
<p>To better understand the transform-style property,
<a target="_blank" href="trycss3_transform-style_inuse.htm">view a demo</a>.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.transformStyle="preserve-3d"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_transform-style">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">transform-style</td>
...
transform-style: flat|preserve-3d|initial|inherit;</div></div>
<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:20%">Property Value</th>
    <th>Description</th>
  </tr><tr><td>flat</td>
    <td>Specifies that child elements will NOT preserve its 
	3D position. This is default</td>
  </tr><tr><td>preserve-3d</td>
    <td>Specifies that child elements will preserve its 3D position</td>
  </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_transformstyle.asp">transformStyle property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_transform-origin.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_transition.asp">Next &raquo;</a></div>
