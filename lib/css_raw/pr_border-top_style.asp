<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS border-top-style property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">border-top-style</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-top-right-radius.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-top_width.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-top-style property sets the style of an element's top border.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.borderTopStyle="dashed"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border-top-style">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">border-top-style</td>
    <td>1.0</td>
    <td>5.5</td>
    <td>1.0</td>
    <td>1.0</td>
...
border-top-style:none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:10%">Value</th>
    ...
    <th>Play it</th>            
	  ...
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=none">Play it &raquo;</a></td>		      
    </tr><tr><td>hidden</td>
      <td>The same as "none", except in border conflict
        resolution for table elements</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=hidden">Play it &raquo;</a></td>		
    </tr><tr><td>dotted</td>
      <td>Specifies a dotted border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=dotted">Play it &raquo;</a></td>		
    </tr><tr><td>dashed</td>
      <td>Specifies a dashed border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=dashed">Play it &raquo;</a></td>
    </tr><tr><td>solid</td>
      <td>Specifies a solid border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=solid">Play it &raquo;</a></td>
    </tr><tr><td>double</td>
      <td>Specifies a double border</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=double">Play it &raquo;</a></td>
    </tr><tr><td>groove</td>
      <td>Specifies a 3D grooved border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=groove">Play it &raquo;</a></td>
    </tr><tr><td>ridge</td>
      <td>Specifies a 3D ridged border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=ridge">Play it &raquo;</a></td>
    </tr><tr><td>inset</td>
      <td>Specifies a 3D inset border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=inset">Play it &raquo;</a></td>
    </tr><tr><td>outset</td>
      <td>Specifies a 3D outset border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=outset">Play it &raquo;</a></td>
    </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-style&amp;preval=initial">Play it &raquo;</a></td>
    </tr><tr><td>inherit</td>
...
<p>CSS reference: <a href="pr_border-top.asp">border-top property</a></p>
<p>HTML DOM reference: 
<a href="/jsref/prop_style_bordertopstyle.asp">borderTopStyle property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-top-right-radius.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-top_width.asp">Next &raquo;</a></div>
