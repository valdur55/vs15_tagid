...
<h1>CSS <span class="color_h1">order</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_opacity.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_outline.asp">Next &raquo;</a></div>
</div>
...
<div class="w3-code notranslate cssHigh">
	...
	/* Code for Safari 6.1 to 8.0 */<br>div#myRedDIV {-webkit-order: 2;}<br>
	div#myBlueDIV {-webkit-order: 4;}<br>div#myGreenDIV {-webkit-order: 3;}<br>
	div#myPinkDIV {-webkit-order: 1;}<br><br>/* Standard syntax */<br>
	div#myRedDIV {order: 2;}<br>div#myBlueDIV {order: 4;}<br>div#myGreenDIV 
	{order: 3;}<br>div#myPinkDIV {order: 1;}<br></div>
<a target="_blank" href="tryit.asp?filename=trycss3_order" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>

<p>The order property specifies the order of a flexible item relative to the rest of the flexible items inside the same container.</p>

<p><b>Note:</b> If the element is not a flexible item, the order property has no effect.</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_order">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS3</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.order="2"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_order">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">order</td>
...
order: <i>number</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>Default value 0. Specifies the order for the flexible item</td>
    </tr><tr><td>initial</td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_order.asp">order property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_opacity.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_outline.asp">Next &raquo;</a></div>
