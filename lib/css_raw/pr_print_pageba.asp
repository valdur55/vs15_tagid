<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS Page-break-after Property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS <span class="color_h1">page-break-after</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="pr_padding-top.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_print_pagebb.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Always insert a page break after each &lt;footer&gt; element (when printing):&nbsp;</p>
...
<p>The page-break-after property sets whether a page break should occur AFTER a 
specified
element.</p>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">page-break-after</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.2</td>
...
page-break-after: auto|always|avoid|left|right|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:15%">Value</th>
    <th>Description</th>
      ...
      <td>Always insert a page break after the element</td>
    </tr><tr><td>avoid</td>
      <td>&nbsp;Avoid page break after the element (if possible)</td>
    </tr><tr><td>left</td>
      <td>Insert page breaks after the element so that the next page is 
...
<a href="/jsref/prop_style_pagebreakafter.asp">pageBreakAfter property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="pr_padding-top.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_print_pagebb.asp">Next &raquo;</a></div>
