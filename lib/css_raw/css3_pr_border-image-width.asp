<!DOCTYPE html>
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>CSS3 border-image-width property</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="Keywords" content="HTML,CSS,JavaScript,SQL,PHP,jQuery,ASP,XML,DOM,Web development,W3C,tutorials,programming,training,learning,quiz,primer,lessons,references,examples,source code,colors,demos,tips"><meta name="Description" content="Well organized and easy to understand Web bulding tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, and XML."><link rel="icon" href="/favicon.ico" type="image/x-icon"><link rel="stylesheet" href="/lib/w3.css"><script>
...
<h1>CSS3 <span class="color_h1">border-image-width</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-image-source.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-left.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-image-width">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border-image-width property specifies the width of the border image.</p>
<p><strong>Tip:</strong> Also look at the <a href="css3_pr_border-image.asp">border-image</a> property 
(a shorthand property for setting all the border-image-* properties).</p>
...
<table class="tecspec"><tr><th style="width:25%">Default value:</th>
    ...
    <td>  <i>object</i>.style.borderImageWidth="20px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_border-image-width">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left;">border-image-width</td>
    <td>15.0</td>
    <td>11.0</td>
    <td>13.0</td>
    <td>6.0</td>
...
border-image-width: <i>number</i>|<i>%</i>|auto|initial|inherit;</div></div>
<p><b>Note:</b> The border-image-width property can take from one to four values 
...
<table class="w3-table-all notranslate"><tr><th style="width:22%">Value</th>
    ...
    <td>A length unit (px) specifying the size of the border-width</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-width">Play it &raquo;</a></td>              
  </tr><tr><td><i>number</i></td>
    <td>Default value 1. Represents multiples of the corresponding border-width</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-width2">Play it &raquo;</a></td>              
  </tr><tr><td><i>%</i></td>
    <td>Refers to the size of the border image area: the width of the area for 
	horizontal offsets, the height for vertical offsets</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-width3">Play it &raquo;</a></td>              
  </tr><tr><td>auto</td>
    <td>If specified, the width is the intrinsic width or height of the 
	corresponding image slice</td>
 	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-width&amp;preval=auto">Play it &raquo;</a></td>              
 </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-width2&amp;preval=initial">Play it &raquo;</a></td>              
    </tr><tr><td>inherit</td>
...
<p>CSS Reference: <a href="css3_pr_border-image.asp">border-image property</a></p>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_borderimagewidth.asp">borderImageWidth property</a></p>
<br><div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_border-image-source.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-left.asp">Next &raquo;</a></div>
