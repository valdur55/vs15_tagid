...
<h1>CSS <span class="color_h1">word-spacing</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_word-break.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_word-wrap.asp">Next &raquo;</a></div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_text_word-spacing" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The word-spacing property increases or decreases the white space between words.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_word-spacing">Try it</a>
</td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.wordSpacing="20px"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_word-spacing">Try it</a>
</td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">word-spacing</td>
    <td>1.0</td>
    <td>6.0</td>
    <td>1.0</td>
    <td>1.0</td>
...
word-spacing: normal|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate"><tr><th style="width:14%">Value</th>
    ...
    <td>Defines normal space between words&nbsp;. This is default</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_word-spacing">Play it &raquo;</a></td>                	
  </tr><tr><td><i>length</i></td>
    <td>Defines an extra space between words in px, pt, cm, em, 
	etc. Negative values are allowed&nbsp;</td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_word-spacing&amp;preval=10px">Play it &raquo;</a></td>                		
  </tr><tr><td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_word-spacing&amp;preval=initial">Play it &raquo;</a></td>                		
    </tr><tr><td>inherit</td>
...
<a href="/jsref/prop_style_wordspacing.asp">wordSpacing property</a></p>
