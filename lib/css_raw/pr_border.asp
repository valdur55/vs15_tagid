...
<h1>CSS <span class="color_h1">border</span> Property</h1>
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_background-size.asp">&laquo; Previous</a></div>
<div class="home" style="float:left;"><a class="chapter" href="default.asp">Complete CSS  Reference</a></div>
<div class="next"><a class="chapter" href="pr_border-bottom.asp">Next &raquo;</a></div>
</div>
<br><div class="w3-example">
<h3>Example</h3>
<p>Set the style of the four border:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_border" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr><h2>Definition and Usage</h2>
<p>The border shorthand property sets all the border properties in 
one declaration.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border">Try it</a>
    </td>
  </tr><tr><th>Version:</th>
    <td>CSS1</td>
  </tr><tr><th>JavaScript syntax:</th>
    <td>  <i>object</i>.style.border="3px solid blue"
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_border">Try it</a>
    </td>
  </tr></table></div>
...
<table class="browserref notranslate"><tr><th style="width:20%;font-size:16px;text-align:left;">Property</th>
  ...
  </tr><tr><td style="text-align:left; width: 20%;">border</td>
    <td>1.0</td>
    <td>4.0</td>
    <td>1.0</td>
    <td>1.0&nbsp;</td>
...
border: <i>border-width</i> <i>border-style</i> <i>border-color</i>|initial|inherit;</div></div>

<h2>Property Values</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate"><tr><th style="width:25%">Value</th>
    <th>Description</th>
  </tr><tr><td><i><a href="pr_border-width.asp">border-width</a></i></td>
    <td>Specifies the width of the border. Default value is "medium"</td>
  </tr><tr><td><i><a href="pr_border-style.asp">border-style</a></i></td>
    <td>Specifies the style of the border. Default value is "none"</td>
  </tr><tr><td><i><a href="pr_border-color.asp">border-color</a></i></td>
...
<p>HTML DOM reference: <a href="/jsref/prop_style_border.asp">border property</a></p>
